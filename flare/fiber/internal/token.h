...
#ifndef FLARE_FIBER_INTERNAL_TOKEN_H_
#define FLARE_FIBER_INTERNAL_TOKEN_H_
...
#define fiber_token_error(id, err)                                        \
    fiber_token_error_verbose(id, err, __FILE__ ":" FLARE_SYMBOLSTR(__LINE__))
...
#define fiber_token_lock(id, pdata)                                      \
    fiber_token_lock_verbose(id, pdata, __FILE__ ":" FLARE_SYMBOLSTR(__LINE__))
...
#define fiber_token_error2(id, ec, et)                                   \
    fiber_token_error2_verbose(id, ec, et, __FILE__ ":" FLARE_SYMBOLSTR(__LINE__))
...
#endif  // FLARE_FIBER_INTERNAL_TOKEN_H_
