...
#  include <iostream>
#  include "flare/fiber/internal/mutex.h"        // use fiber_mutex_t in the RAII way
...
// NOTE: If the thread is not created by flare server and lifetime is
...
// but noticeable in shortly-lived threads. Threads in flare server
