 ...
 *****************************************************************/
#ifndef FLARE_TIMES_INTERNAL_CHRONO_TIME_DETAIL_H_
#define FLARE_TIMES_INTERNAL_CHRONO_TIME_DETAIL_H_
...
namespace flare::times_internal {
    ...
    namespace times_detail {
        ...
        namespace impl {
            ...
            template<typename H>
            H flare_hash_value_impl(second_tag, H h, fields f) {
                return H::combine(std::move(h), f.y, f.m, f.d, f.hh, f.mm, f.ss);
            }

            template<typename H>
            H flare_hash_value_impl(minute_tag, H h, fields f) {
                return H::combine(std::move(h), f.y, f.m, f.d, f.hh, f.mm);
            }

            template<typename H>
            H flare_hash_value_impl(hour_tag, H h, fields f) {
                return H::combine(std::move(h), f.y, f.m, f.d, f.hh);
            }

            template<typename H>
            H flare_hash_value_impl(day_tag, H h, fields f) {
                return H::combine(std::move(h), f.y, f.m, f.d);
            }

            template<typename H>
            H flare_hash_value_impl(month_tag, H h, fields f) {
                return H::combine(std::move(h), f.y, f.m);
            }

            template<typename H>
            H flare_hash_value_impl(year_tag, H h, fields f) {
