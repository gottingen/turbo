...
int big_unsigned<max_words>::ReadFloatMantissa(const ParsedFloat &fp,
...
template<int max_words>
int big_unsigned<max_words>::ReadDigits(const char *begin, const char *end,
                                       int significant_digits) {
...
template<int max_words>
/* static */ big_unsigned<max_words> big_unsigned<max_words>::FiveToTheNth(
        int n) {
    big_unsigned answer(1u);
...
template<int max_words>
void big_unsigned<max_words>::MultiplyStep(int original_size,
...
template<int max_words>
std::string big_unsigned<max_words>::ToString() const {
    big_unsigned<max_words> copy = *this;
    std::string result;
