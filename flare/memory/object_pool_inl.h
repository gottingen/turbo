...
#ifndef FLARE_MEMORY_OBJECT_POOL_INL_H_
#define FLARE_MEMORY_OBJECT_POOL_INL_H_
...
// for gcc 3.4.5
    ...
    template<typename T>
    class FLARE_CACHELINE_ALIGNMENT ObjectPool {
    public:
        ...
        public:
            ...
            // we don't want.
#define FLARE_OBJECT_POOL_GET(CTOR_ARGS)                                \
        ...
        return nullptr;                                                    \
            ...
            inline T *get() {
                FLARE_OBJECT_POOL_GET();
            }

            template<typename A1>
            inline T *get(const A1 &a1) {
                FLARE_OBJECT_POOL_GET((a1));
            }

            template<typename A1, typename A2>
            inline T *get(const A1 &a1, const A2 &a2) {
                FLARE_OBJECT_POOL_GET((a1, a2));
            }

#undef FLARE_OBJECT_POOL_GET
...
#ifdef FLARE_CLEAR_OBJECT_POOL_AFTER_ALL_THREADS_QUIT
