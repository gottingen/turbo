...
#include "flare/debugging/internal/stacktrace_config.h"

#if defined(FLARE_STACKTRACE_INL_HEADER)

#include FLARE_STACKTRACE_INL_HEADER
...
namespace flare::debugging {
    ...
    namespace {
        ...
        FLARE_FORCE_INLINE int Unwind(void **result, int *sizes,
    ...
    FLARE_NO_INLINE FLARE_COMPILER_NO_TAIL_CALL int get_stack_frames(
            void **result, int *sizes, int max_depth, int skip_count) {
        return Unwind<true, false>(result, sizes, max_depth, skip_count, nullptr,
                                   nullptr);
    }

    FLARE_NO_INLINE FLARE_COMPILER_NO_TAIL_CALL int
    ...
    FLARE_NO_INLINE FLARE_COMPILER_NO_TAIL_CALL int get_stack_trace(
