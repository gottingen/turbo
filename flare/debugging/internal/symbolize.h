...
#define FLARE_DEBUGGING_INTERNAL_SYMBOLIZE_H_
...
#error FLARE_INTERNAL_HAVE_ELF_SYMBOLIZE cannot be directly set
#elif defined(__ELF__) && defined(__GLIBC__) && !defined(__native_client__) && \
    !defined(__asmjs__) && !defined(__wasm__)
#define FLARE_INTERNAL_HAVE_ELF_SYMBOLIZE 1
...
#endif  // FLARE_INTERNAL_HAVE_ELF_SYMBOLIZE
...
#endif  // FLARE_DEBUGGING_INTERNAL_SYMBOLIZE_H_
