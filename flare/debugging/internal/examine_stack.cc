...
// ucontext_t on non-POSIX systems.
        void *GetProgramCounter(void *vuc) {
            ...
            if (vuc != nullptr) {
              ...
              if (14 < FLARE_ARRAY_SIZE(context->uc_mcontext.gregs))
              ...
              if (16 < FLARE_ARRAY_SIZE(context->uc_mcontext.gregs))
...
// appropriate.
        static void DumpPCAndFrameSizeAndSymbol(void (*writerfn)(const char *, void *),
            ...
            if (flare::debugging::symbolize(symbolize_pc, tmp, sizeof(tmp))) {
                symbol = tmp;
            }
            char buf[1024];
            if (framesize <= 0) {
