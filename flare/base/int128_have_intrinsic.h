...
// representation when FLARE_HAVE_INTRINSIC_INT128 is defined. This file is
// included by int128.h and relies on FLARE_INTERNAL_WCHAR_T being defined.
...
FLARE_FORCE_INLINE int128 &int128::operator=(__int128 v) {
    v_ = v;
    return *this;
}
...
FLARE_FORCE_INLINE int128::int128(float v) {
    v_ = static_cast<__int128>(v);
}

FLARE_FORCE_INLINE int128::int128(double v) {
    v_ = static_cast<__int128>(v);
}

FLARE_FORCE_INLINE int128::int128(long double v) {
    v_ = static_cast<__int128>(v);
}
...
constexpr int128::operator FLARE_INTERNAL_WCHAR_T() const {
    return static_cast<FLARE_INTERNAL_WCHAR_T>(v_);
}
...
FLARE_FORCE_INLINE int128::operator float() const { return static_cast<float>(v_); }

FLARE_FORCE_INLINE int128::operator double() const { return static_cast<double>(v_); }
...
FLARE_FORCE_INLINE bool operator!(int128 v) {
    return !static_cast<__int128>(v);
}
