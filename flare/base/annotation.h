...
#ifndef FLARE_BASE_ANNOTATION_H_
#define FLARE_BASE_ANNOTATION_H_
...
#define FLARE_INTERNAL_ASAN_CHECK(fp) \
  FLARE_DCHECK(fp, "Your compiler is too old to use ASan with fibers.");
...
#define FLARE_INTERNAL_TSAN_CHECK(fp) \
  FLARE_DCHECK(fp, "Your compiler is too old to use TSan with fibers.");
...
#endif  // FLARE_BASE_ANNOTATION_H_
