...
#ifndef  FLARE_CONTAINER_SPARSE_SET_H_
#define FLARE_CONTAINER_SPARSE_SET_H_
 ...
 * `flare::sh::exception_safety::strong`, the drawback is that the set will be
 ...
 private:
  ...
  using ht =
      detail_sparse_hash::sparse_hash<Key, KeySelect, void, Hash, KeyEqual,
                                      ...
                                      Sparsity, flare::sh::probing::quadratic>;
...
/**
 * Same as `flare::sparse_set<Key, Hash, KeyEqual, Allocator,
...
template <class Key, class Hash = std::hash<Key>,
          ...
          class Allocator = std::allocator<Key>>
using sparse_pg_set =
    sparse_set<Key, Hash, KeyEqual, Allocator, flare::sh::prime_growth_policy>;

}  // namespace flare

#endif  // FLARE_CONTAINER_SPARSE_SET_H_
