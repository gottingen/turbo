...
#ifndef  FLARE_CONTAINER_SPARSE_GROWTH_POLICY_H_
#define  FLARE_CONTAINER_SPARSE_GROWTH_POLICY_H_
 ...
 * flare::sh::power_of_two_growth_policy in general but will probably distribute
            ...
            static const std::array<std::size_t (*)(std::size_t), 40> &mod_prime() {
                ...
                static const std::array<std::size_t (*)(std::size_t), 40> MOD_PRIME = {
                        {&mod < 0 > , &mod < 1 > , &mod < 2 > , &mod < 3 > , &mod < 4 > , &mod < 5 > , &mod < 6 > ,
                                ...
                                &mod < 13 > ,
                                &mod < 14 > , &mod < 15 > , &mod < 16 > , &mod < 17 > , &mod < 18 > , &mod < 19 > ,
                                &mod < 20 > ,
                                &mod < 21 > , &mod < 22 > , &mod < 23 > , &mod < 24 > , &mod < 25 > , &mod < 26 > ,
                                &mod < 27 > ,
                                &mod < 28 > , &mod < 29 > , &mod < 30 > , &mod < 31 > , &mod < 32 > , &mod < 33 > ,
                                &mod < 34 > ,
...
#endif  // FLARE_CONTAINER_SPARSE_GROWTH_POLICY_H_
