...
#ifndef FLARE_CONTAINER_BTREE_H_
#define FLARE_CONTAINER_BTREE_H_
...
namespace flare {
    ...
    namespace type_traits_internal {
        ...
        struct IsTriviallyMoveConstructibleObject
                : std::integral_constant<
                        bool, std::is_move_constructible<
                              ...
                              flare::is_trivially_destructible<T>::value> {
        };
        ...
        struct IsTriviallyMoveAssignableReference<T &>
                : flare::is_trivially_move_assignable<T>::type {
        };
    ...
    namespace type_traits_internal {
        ...
        class is_trivially_copyable_impl {
            ...
            static constexpr bool kIsCopyOrMoveAssignable =
                    flare::is_copy_assignable<ExtentsRemoved>::value ||
                    flare::is_move_assignable<ExtentsRemoved>::value;
    ...
    namespace swap_internal {
        ...
        // This declaration prevents global `swap` and `flare::swap` overloads from being
        ...
        template<class T>
        struct IsSwappable
                : flare::type_traits_internal::is_detected<IsSwappableImpl, T> {
        };

        template<class T>
        struct IsNothrowSwappable
                : flare::type_traits_internal::is_detected<IsNothrowSwappableImpl, T> {
        };

        template<class T, flare::enable_if_t<IsSwappable<T>::value, int> = 0>
...
#define FLARE_COMPARE_INLINE_BASECLASS_DECL(name)

#define FLARE_COMPARE_INLINE_SUBCLASS_DECL(type, name)  \
        static const type name;

#define FLARE_COMPARE_INLINE_INIT(type, name, init) \
...
#define FLARE_COMPARE_INLINE_INIT(type, name, init)             \
        ...
        struct weak_equality_base {
            FLARE_COMPARE_INLINE_BASECLASS_DECL(equivalent)
            FLARE_COMPARE_INLINE_BASECLASS_DECL(nonequivalent)
        };

        template<typename T>
        struct strong_equality_base {
            FLARE_COMPARE_INLINE_BASECLASS_DECL(equal)
            FLARE_COMPARE_INLINE_BASECLASS_DECL(nonequal)
            FLARE_COMPARE_INLINE_BASECLASS_DECL(equivalent)
            FLARE_COMPARE_INLINE_BASECLASS_DECL(nonequivalent)
        };
        ...
        struct partial_ordering_base {
            FLARE_COMPARE_INLINE_BASECLASS_DECL(less)
            FLARE_COMPARE_INLINE_BASECLASS_DECL(equivalent)
            FLARE_COMPARE_INLINE_BASECLASS_DECL(greater)
            FLARE_COMPARE_INLINE_BASECLASS_DECL(unordered)
        };
    ...
    public:
        FLARE_COMPARE_INLINE_SUBCLASS_DECL(weak_equality, equivalent)
        FLARE_COMPARE_INLINE_SUBCLASS_DECL(weak_equality, nonequivalent)
    ...
    FLARE_COMPARE_INLINE_INIT(weak_equality, equivalent,
                              compare_internal::eq::equivalent);
    FLARE_COMPARE_INLINE_INIT(weak_equality, nonequivalent,
    ...
    public:
        FLARE_COMPARE_INLINE_SUBCLASS_DECL(strong_equality, equal)
        FLARE_COMPARE_INLINE_SUBCLASS_DECL(strong_equality, nonequal)
        FLARE_COMPARE_INLINE_SUBCLASS_DECL(strong_equality, equivalent)
        FLARE_COMPARE_INLINE_SUBCLASS_DECL(strong_equality, nonequivalent)
    ...
    FLARE_COMPARE_INLINE_INIT(strong_equality, equal, compare_internal::eq::equal);
    FLARE_COMPARE_INLINE_INIT(strong_equality, nonequal,
                              compare_internal::eq::nonequal);
    FLARE_COMPARE_INLINE_INIT(strong_equality, equivalent,
                              compare_internal::eq::equivalent);
    FLARE_COMPARE_INLINE_INIT(strong_equality, nonequivalent,
                              compare_internal::eq::nonequivalent);
    ...
    public:
        FLARE_COMPARE_INLINE_SUBCLASS_DECL(partial_ordering, less)
        FLARE_COMPARE_INLINE_SUBCLASS_DECL(partial_ordering, equivalent)
        FLARE_COMPARE_INLINE_SUBCLASS_DECL(partial_ordering, greater)
        FLARE_COMPARE_INLINE_SUBCLASS_DECL(partial_ordering, unordered)
    ...
    FLARE_COMPARE_INLINE_INIT(partial_ordering, less, compare_internal::ord::less);
    FLARE_COMPARE_INLINE_INIT(partial_ordering, equivalent,
                              compare_internal::eq::equivalent);
    FLARE_COMPARE_INLINE_INIT(partial_ordering, greater,
                              compare_internal::ord::greater);
    FLARE_COMPARE_INLINE_INIT(partial_ordering, unordered,
    ...
    public:
        FLARE_COMPARE_INLINE_SUBCLASS_DECL(weak_ordering, less)
        FLARE_COMPARE_INLINE_SUBCLASS_DECL(weak_ordering, equivalent)
        FLARE_COMPARE_INLINE_SUBCLASS_DECL(weak_ordering, greater)
    ...
    FLARE_COMPARE_INLINE_INIT(weak_ordering, less, compare_internal::ord::less);
    FLARE_COMPARE_INLINE_INIT(weak_ordering, equivalent,
                              compare_internal::eq::equivalent);
    FLARE_COMPARE_INLINE_INIT(weak_ordering, greater,
                              compare_internal::ord::greater);
    ...
    public:
        FLARE_COMPARE_INLINE_SUBCLASS_DECL(strong_ordering, less)
        FLARE_COMPARE_INLINE_SUBCLASS_DECL(strong_ordering, equal)
        FLARE_COMPARE_INLINE_SUBCLASS_DECL(strong_ordering, equivalent)
        FLARE_COMPARE_INLINE_SUBCLASS_DECL(strong_ordering, greater)
    ...
    FLARE_COMPARE_INLINE_INIT(strong_ordering, less, compare_internal::ord::less);
    FLARE_COMPARE_INLINE_INIT(strong_ordering, equal, compare_internal::eq::equal);
    FLARE_COMPARE_INLINE_INIT(strong_ordering, equivalent,
                              compare_internal::eq::equivalent);
    FLARE_COMPARE_INLINE_INIT(strong_ordering, greater,
                              compare_internal::ord::greater);

#undef FLARE_COMPARE_INLINE_BASECLASS_DECL
#undef FLARE_COMPARE_INLINE_SUBCLASS_DECL
#undef FLARE_COMPARE_INLINE_INIT

    namespace compare_internal {
        // We also provide these comparator adapter functions for internal flat_hash_map use.

        // Helper functions to do a boolean comparison of two keys given a boolean
        // or three-way comparator.
        // SFINAE prevents implicit conversions to bool (such as from int).
        template<typename BoolType,
                flare::enable_if_t<std::is_same<bool, BoolType>::value, int> = 0>
        constexpr bool compare_result_as_less_than(const BoolType r) { return r; }

        constexpr bool compare_result_as_less_than(const flare::weak_ordering r) {
            return r < 0;
        }
        ...
        template<typename Int,
                flare::enable_if_t<std::is_same<int, Int>::value, int> = 0>
        constexpr flare::weak_ordering compare_result_as_ordering(const Int c) {
            return c < 0 ? flare::weak_ordering::less
                         : c == 0 ? flare::weak_ordering::equivalent
                                  : flare::weak_ordering::greater;
        }

        constexpr flare::weak_ordering compare_result_as_ordering(
                const flare::weak_ordering c) {
            return c;
        }

        template<
                typename Compare, typename K, typename LK,
                flare::enable_if_t<!std::is_same<bool, flare::invoke_result_t<
                        Compare, const K &, const LK &>>::value,
                        int> = 0>
        constexpr flare::weak_ordering do_three_way_comparison(const Compare &compare,
        ...
        template<
                typename Compare, typename K, typename LK,
                flare::enable_if_t<std::is_same<bool, flare::invoke_result_t<Compare,
                        const K &, const LK &>>::value,
                        int> = 0>
        constexpr flare::weak_ordering do_three_way_comparison(const Compare &compare,
                                                               const K &x, const LK &y) {
            return compare(x, y) ? flare::weak_ordering::less
                                 : compare(y, x) ? flare::weak_ordering::greater
                                                 : flare::weak_ordering::equivalent;
        }
...
namespace flare {
    ...
    namespace priv {
        ...
        std::is_convertible<flare::invoke_result_t<Compare, const T &, const T &>,
                flare::weak_ordering>;
        ...
        struct common_params {
            ...
            flare::conditional_t<(kNodeValueSpace / sizeof(value_type) >
        ...
        struct map_params : common_params<Key, Compare, Alloc, TargetNodeSize, Multi,
                flare::priv::map_slot_policy<Key, Data>> {
        ...
        struct set_slot_policy {
            ...
            static void construct(Alloc *alloc, slot_type *slot, Args &&... args) {
                flare::allocator_traits<Alloc>::construct(*alloc, slot,
                                                          std::forward<Args>(args)...);
            }

            template<typename Alloc>
            static void construct(Alloc *alloc, slot_type *slot, slot_type *other) {
                flare::allocator_traits<Alloc>::construct(*alloc, slot, std::move(*other));
            }

            template<typename Alloc>
            static void destroy(Alloc *alloc, slot_type *slot) {
                flare::allocator_traits<Alloc>::destroy(*alloc, slot);
            }
        ...
        struct upper_bound_adapter {
            ...
            bool operator()(const K &a, const LK &b) const {
                ...
                return !flare::compare_internal::compare_result_as_less_than(comp(b, a));
            }
        ...
        private:
            using layout_type = flare::priv::Layout<btree_node *, field_type,
        ...
        public:
            ...
            void clear_child(size_type i) {
                flare::priv::SanitizerPoisonObject(&mutable_child(i));
            }

            void set_child(size_type i, btree_node *c) {
                flare::priv::SanitizerUnpoisonObject(&mutable_child(i));
                mutable_child(i) = c;
            ...
            SearchResult<int, true> linear_search_impl(
                ...
                while (s < e) {
                    const flare::weak_ordering c = comp(key(s), k);
                    if (c == 0) {
            ...
            SearchResult<int, true> binary_search_impl(
                ...
                if (is_multi_container::value) {
                    ...
                    while (s != e) {
                        const int mid = (s + e) >> 1;
                        const flare::weak_ordering c = comp(key(mid), k);
                        if (c < 0) {
                            s = mid + 1;
                        } else {
                            e = mid;
            ...
            static btree_node *init_leaf(btree_node *n, btree_node *parent,
                ...
                flare::priv::SanitizerPoisonMemoryRegion(
        ...
        private:
            ...
            void value_init(const size_type i, allocator_type *alloc, Args &&... args) {
                flare::priv::SanitizerUnpoisonObject(slot(i));
                params_type::construct(alloc, slot(i), std::forward<Args>(args)...);
            }

            void value_destroy(const size_type i, allocator_type *alloc) {
                params_type::destroy(alloc, slot(i));
                flare::priv::SanitizerPoisonObject(slot(i));
            }
            ...
            void uninitialized_move_n(const size_type n, const size_type i,
                                      ...
                                      allocator_type *alloc) {
                flare::priv::SanitizerUnpoisonMemoryRegion(
        ...
        public:
            ...
            btree(btree &&x) noexcept
                    : root_(std::move(x.root_)),
                      rightmost_(flare::exchange(x.rightmost_, EmptyNode())),
                      size_(flare::exchange(x.size_, 0)) {
        ...
        private:
            ...
            node_type *allocate(const size_type sz) {
                return reinterpret_cast<node_type *>(
                        flare::priv::Allocate<node_type::Alignment()>(
            ...
            void deallocate(const size_type sz, node_type *node) {
                flare::priv::Deallocate<node_type::Alignment()>(
        ...
        private:
            ...
            flare::priv::CompressedTuple<key_compare, allocator_type,
                    node_type *>
                    root_;
        ...
        constexpr bool btree<P>::static_assert_validation() {
            ...
            // Verify that key_compare returns an flare::{weak,strong}_ordering or bool.
            using compare_result_type =
            flare::invoke_result_t<key_compare, key_type, key_type>;
            static_assert(
                    std::is_same<compare_result_type, bool>::value ||
                    std::is_convertible<compare_result_type, flare::weak_ordering>::value,
                    "key comparison function must return flare::{weak,strong}_ordering or "
                    "bool.");
        ...
        void btree<P>::verify() const {
            ...
            assert(empty() || size() == static_cast<size_t>(internal_verify(root(), nullptr, nullptr)));
        ...
        public:
            ...
            mapped_type &at(const key_arg<K> &key) {
                auto it = this->find(key);
                if (it == this->end())
                    base_internal::ThrowStdOutOfRange("flare::btree_map::at");
                return it->second;
            }
    ...
    // ----------------------------------------------------------------------
    //  btree_set - default values in map_fwd_decl.h
    // ----------------------------------------------------------------------
    ...
    // ----------------------------------------------------------------------
    //  btree_multimap - default values in map_fwd_decl.h
    // ----------------------------------------------------------------------
    template<typename Key, typename Value, typename Compare, typename Alloc>
...
#endif  // FLARE_CONTAINER_BTREE_H_
