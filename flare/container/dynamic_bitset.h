...
#ifndef FLARE_CONTAINER_DYNAMIC_BITSET_H_
#define FLARE_CONTAINER_DYNAMIC_BITSET_H_
...
namespace flare {
    ...
    public:
        ...
        [[nodiscard]] constexpr size_type num_bytes() const noexcept;
...
//=================================================================================================
    ...
    block_count(const block_type &block) noexcept {
        return static_cast<size_type>(flare::base::popcount(block));
    }
    ...
    block_count(const block_type &block, size_type nbits) noexcept {
        ...
        return static_cast<size_type>(flare::base::popcount(shifted_block));
    }
    ...
    count_block_trailing_zero(const block_type &block) noexcept {
        ...
        return static_cast<size_type>(flare::base::countr_zero(block));
    }
...
#endif  //  FLARE_CONTAINER_DYNAMIC_BITSET_H_
