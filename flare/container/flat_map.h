...
#ifndef FLARE_CONTAINER_FLAT_MAP_H_
#define FLARE_CONTAINER_FLAT_MAP_H_
...
#include "flare/container/bit_array.h"                       // bit_array_*
...
// Implement DefaultHasher and DefaultEqualTo
    template<typename K>
    struct DefaultHasher : public FLARE_HASH_NAMESPACE::hash<K> {
    };
...
#include "flare/container/flat_map_inl.h"

#endif  // FLARE_CONTAINER_FLAT_MAP_H_
