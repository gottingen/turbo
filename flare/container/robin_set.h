...
#ifndef  FLARE_CONTAINER_ROBIN_SET_H_
#define  FLARE_CONTAINER_ROBIN_SET_H_
 ...
 * By default the set uses `flare::rh::power_of_two_growth_policy`. This policy keeps the number of buckets
 ...
 */
    ...
    /**
     * Same as `flare::robin_set<Key, Hash, KeyEqual, Allocator, StoreHash, flare::rh::prime_growth_policy>`.
     */
    template<class Key,
            class Hash = std::hash<Key>,
            class KeyEqual = std::equal_to<Key>,
            class Allocator = std::allocator<Key>,
            bool StoreHash = false>
    using robin_pg_set = robin_set<Key, Hash, KeyEqual, Allocator, StoreHash, flare::rh::prime_growth_policy>;

} // end namespace flare

#endif  // FLARE_CONTAINER_ROBIN_SET_H_
