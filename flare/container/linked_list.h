...
#ifndef FLARE_CONTAINER_LINKED_LIST_H_
#define FLARE_CONTAINER_LINKED_LIST_H_
...
//
// Q. Should I use std::list or flare::container::linked_list?
//
// A. The main reason to use flare::container::linked_list over std::list is
//    performance. If you don't care about the performance differences
//    then use an STL container, as it makes for better code readability.
//
//    Comparing the performance of flare::container::linked_list<T> to std::list<T*>:
//
//    * Erasing an element of type T* from flare::container::linked_list<T> is
//      an O(1) operation. Whereas for std::list<T*> it is O(n).
//      That is because with std::list<T*> you must obtain an
//      iterator to the T* element before you can call erase(iterator).
//
//    * Insertion operations with flare::container::linked_list<T> never require
//      heap allocations.
//
// Q. How does flare::container::linked_list implementation differ from std::list?
//
// A. Doubly-linked lists are made up of nodes that contain "next" and
//    "previous" pointers that reference other nodes in the list.
//
//    With flare::container::linked_list<T>, the type being inserted already reserves
//    space for the "next" and "previous" pointers (flare::container::link_node<T>*).
...
namespace flare::container {
    ...
    private:
        ...
        FLARE_DISALLOW_COPY_AND_ASSIGN(link_node);
    };
    ...
    private:
        ...
        FLARE_DISALLOW_COPY_AND_ASSIGN(linked_list);
    };

}  // namespace flare::container

#endif  // FLARE_CONTAINER_LINKED_LIST_H_
