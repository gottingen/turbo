...
#ifndef  FLARE_CONTAINER_SPARSE_MAP_H_
#define  FLARE_CONTAINER_SPARSE_MAP_H_
...
#include "flare/container/sparse_hash.h"
 ...
 * `flare::sh::power_of_two_growth_policy`. This policy keeps the number of
 ...
 * your own growth policy, check `flare::sh::power_of_two_growth_policy` for the
 * interface.
 *
 ...
 * `flare::sh::exception_safety::strong`, the drawback is that the map will be
 ...
 * `flare::sh::sparsity::medium` sparsity offers a good compromise. It doesn't
 ...
 */
    template<class Key, class T, class Hash = std::hash<Key>,
            ...
            class GrowthPolicy = flare::sh::power_of_two_growth_policy<2>,
            flare::sh::exception_safety ExceptionSafety =
            flare::sh::exception_safety::basic,
            flare::sh::sparsity Sparsity = flare::sh::sparsity::medium>
    class sparse_map {
    private:
        template<typename U>
        using has_is_transparent = flare::detail_sparse_hash::has_is_transparent<U>;
        ...
        using ht = detail_sparse_hash::sparse_hash<
                ...
                GrowthPolicy, ExceptionSafety, Sparsity, flare::sh::probing::quadratic>;
    ...
    /**
     * Same as `flare::sparse_map<Key, T, Hash, KeyEqual, Allocator,
     * flare::sh::prime_growth_policy>`.
     */
    template<class Key, class T, class Hash = std::hash<Key>,
            class KeyEqual = std::equal_to<Key>,
            class Allocator = std::allocator<std::pair<Key, T>>>
    using sparse_pg_map =
    sparse_map<Key, T, Hash, KeyEqual, Allocator, flare::sh::prime_growth_policy>;

}  // namespace flare

#endif  // FLARE_CONTAINER_SPARSE_MAP_H_
