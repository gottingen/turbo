...
#ifndef FLARE_CONTAINER_PARALLEL_FLAT_HASH_SET_H_
#define FLARE_CONTAINER_PARALLEL_FLAT_HASH_SET_H_
...
namespace flare {
    ...
    class parallel_flat_hash_set
            : public flare::priv::parallel_hash_set<
                    ...
                    flare::priv::flat_hash_set_policy<T>,
                    Hash, Eq, Alloc> {
...
#endif  // FLARE_CONTAINER_PARALLEL_FLAT_HASH_SET_H_
