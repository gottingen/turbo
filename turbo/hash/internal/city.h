...
namespace turbo::hash_internal {
    ...
    TURBO_FORCE_INLINE uint64_t uint128_low64(const uint128 &x) { return x.first; }

    TURBO_FORCE_INLINE uint64_t uint128_high64(const uint128 &x) { return x.second; }
    ...
    TURBO_FORCE_INLINE uint64_t hash128_to_64(const uint128 &x) {
