...
template <typename H>
H AbslHashValue(H hash_state, turbo::string_view str) {
  return H::combine(
...
// AbslHashValue for hashing turbo::optional
template <typename H, typename T>
typename std::enable_if<is_hashable<T>::value, H>::type AbslHashValue(
...
// AbslHashValue for hashing turbo::variant
template <typename H, typename... T>
typename std::enable_if<conjunction<is_hashable<T>...>::value, H>::type
AbslHashValue(H hash_state, const turbo::variant<T...>& v) {
