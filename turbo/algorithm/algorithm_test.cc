...
TEST(EqualTest, DefaultComparisonRandomAccess) {
  ...
  EXPECT_TRUE(turbo::equal(v1.begin(), v1.end(), v2.begin(), v2.end()));
  EXPECT_FALSE(turbo::equal(v1.begin(), v1.end(), v3.begin(), v3.end()));
  EXPECT_FALSE(turbo::equal(v1.begin(), v1.end(), v4.begin(), v4.end()));
}
...
TEST(EqualTest, DefaultComparison) {
  ...
  EXPECT_TRUE(turbo::equal(lst1.begin(), lst1.end(), lst2.begin(), lst2.end()));
  EXPECT_FALSE(turbo::equal(lst1.begin(), lst1.end(), lst3.begin(), lst3.end()));
  EXPECT_FALSE(turbo::equal(lst1.begin(), lst1.end(), lst4.begin(), lst4.end()));
}
...
TEST(EqualTest, MixedIterTypes) {
  ...
  EXPECT_TRUE(turbo::equal(v1.begin(), v1.end(), lst1.begin(), lst1.end()));
  EXPECT_FALSE(turbo::equal(v1.begin(), v1.end(), lst2.begin(), lst2.end()));
  EXPECT_FALSE(turbo::equal(v1.begin(), v1.end(), lst3.begin(), lst3.end()));
}
...
TEST(EqualTest, CustomComparison) {
  ...
  EXPECT_TRUE(turbo::equal(v1.begin(), v1.end(), v2.begin(), v2.end(), eq));
  EXPECT_FALSE(turbo::equal(v1.begin(), v1.end(), v3.begin(), v3.end(), eq));
  EXPECT_FALSE(turbo::equal(v1.begin(), v1.end(), v4.begin(), v4.end(), eq));
}
...
TEST(EqualTest, MoveOnlyPredicate) {
  ...
  EXPECT_TRUE(turbo::equal(v1.begin(), v1.end(), v1.begin(), v1.end(), Eq()));
  EXPECT_FALSE(turbo::equal(v1.begin(), v1.end(), v2.begin(), v2.end(), Eq()));
}
...
TEST(RotateTest, Rotate) {
  ...
  EXPECT_EQ(*turbo::rotate(v.begin(), v.begin() + 2, v.end()), 0);
  EXPECT_THAT(v, testing::ElementsAreArray({2, 3, 4, 0, 1}));

  std::list<int> l{0, 1, 2, 3, 4};
  EXPECT_EQ(*turbo::rotate(l.begin(), std::next(l.begin(), 3), l.end()), 0);
