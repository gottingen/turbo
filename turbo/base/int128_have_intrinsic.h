...
TURBO_FORCE_INLINE int128 &int128::operator=(__int128 v) {
    v_ = v;
    return *this;
}
...
TURBO_FORCE_INLINE int128::int128(float v) {
    v_ = static_cast<__int128>(v);
}

TURBO_FORCE_INLINE int128::int128(double v) {
    v_ = static_cast<__int128>(v);
}

TURBO_FORCE_INLINE int128::int128(long double v) {
    v_ = static_cast<__int128>(v);
}
...
TURBO_FORCE_INLINE int128::operator float() const { return static_cast<float>(v_); }

TURBO_FORCE_INLINE int128::operator double() const { return static_cast<double>(v_); }

TURBO_FORCE_INLINE int128::operator long double() const {
...
TURBO_FORCE_INLINE int128::operator float() const {
...
TURBO_FORCE_INLINE int128::operator double() const {
...
TURBO_FORCE_INLINE bool operator==(int128 lhs, int128 rhs) {
...
TURBO_FORCE_INLINE int128
operator-(int128 v) {
    return -static_cast<__int128>(v);
}

TURBO_FORCE_INLINE bool operator!(int128 v) {
    return !static_cast<__int128>(v);
}

TURBO_FORCE_INLINE int128 operator~(int128 val) {
    return ~static_cast<__int128>(val);
}

// Arithmetic operators.

TURBO_FORCE_INLINE int128 operator+(int128 lhs, int128 rhs) {
    return static_cast<__int128>(lhs) + static_cast<__int128>(rhs);
}
...
TURBO_FORCE_INLINE int128 int128::operator++(int) {
    int128 tmp(*this);
    ++v_;
    return tmp;
}
...
TURBO_FORCE_INLINE int128 &int128::operator++() {
    ++v_;
    return *this;
}
...
TURBO_FORCE_INLINE int128 operator<<(int128 lhs, int amount) {
