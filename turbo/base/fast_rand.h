...
#ifndef TURBO_BASE_FAST_RAND_H_
#define TURBO_BASE_FAST_RAND_H_
...
namespace turbo::base {
    ...
    //   std::random_shuffle(myvector.begin(), myvector.end(), turbo::base::fast_rand_less_than);
