...
// turbo::any is a typedef of std::any, use the feature macro ABSL_USES_STD_ANY.
...
//
// This option controls whether turbo::string_view is implemented as an alias to
...
// binary package manager -- since in mode 2, turbo::string_view will name a
// different type, with a different mangled name and binary layout, depending on
// the compiler flags passed by the end user.  For more info, see
// https://abseil.io/about/design/dropin-types.
//
// User code should not inspect this macro.  To check in the preprocessor if
// turbo::string_view is a typedef of std::string_view, use the feature macro
...
// namespace turbo.  If this is set, ABSL_OPTION_INLINE_NAMESPACE_NAME must also
