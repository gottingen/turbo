...
//
// The proper way to write Abseil code in the `turbo` namespace is:
//
// namespace turbo {
...
// not write `namespace turbo {` in their own code for any reason.  (Abseil does
...
#if defined(_MSC_VER)
#if ABSL_OPTION_USE_INLINE_NAMESPACE == 0
#define ABSL_INTERNAL_MANGLED_NS "turbo"
#define ABSL_INTERNAL_MANGLED_BACKREFERENCE "5"
#else
#define ABSL_INTERNAL_MANGLED_NS \
  ABSL_INTERNAL_TOKEN_STR(ABSL_OPTION_INLINE_NAMESPACE_NAME) "@turbo"
