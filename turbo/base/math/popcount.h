...
#ifndef TURBO_BASE_MATH_POPCOUNT_H_
#define TURBO_BASE_MATH_POPCOUNT_H_
...
namespace turbo::base {
    ...
    static TURBO_FORCE_INLINE unsigned popcount_generic8(uint8_t x) {
        x = x - ((x >> 1) & 0x55);
        x = (x & 0x33) + ((x >> 2) & 0x33);
    ...
    /// popcount (count one bits) - generic SWAR implementation
    static TURBO_FORCE_INLINE unsigned popcount_generic16(uint16_t x) {
        x = x - ((x >> 1) & 0x5555);
    ...
    static TURBO_FORCE_INLINE unsigned popcount_generic32(uint32_t x) {
        x = x - ((x >> 1) & 0x55555555);
    ...
    /// popcount (count one bits) - generic SWAR implementation
    static TURBO_FORCE_INLINE unsigned popcount_generic64(uint64_t x) {
    ...
    /// popcount (count one bits)
    static TURBO_FORCE_INLINE unsigned popcount(unsigned i) {
        return static_cast<unsigned>(__builtin_popcount(i));
    }

    /// popcount (count one bits)
    static TURBO_FORCE_INLINE unsigned popcount(int i) {
        return popcount(static_cast<unsigned>(i));
    }

    /// popcount (count one bits)
    static TURBO_FORCE_INLINE unsigned popcount(unsigned long i) {
        return static_cast<unsigned>(__builtin_popcountl(i));
    }

    /// popcount (count one bits)
    static TURBO_FORCE_INLINE unsigned popcount(long i) {
        return popcount(static_cast<unsigned long>(i));
    }

    /// popcount (count one bits)
    static TURBO_FORCE_INLINE unsigned popcount(unsigned long long i) {
        return static_cast<unsigned>(__builtin_popcountll(i));
    }

    /// popcount (count one bits)
    static TURBO_FORCE_INLINE unsigned popcount(long long i) {
    ...
    TURBO_FORCE_INLINE unsigned popcount (Integral i) {
...
#endif  // TURBO_BASE_MATH_POPCOUNT_H_
