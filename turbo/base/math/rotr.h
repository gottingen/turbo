...
#ifndef TURBO_BASE_MATH_ROTR_H_
#define TURBO_BASE_MATH_ROTR_H_
...
namespace turbo::base {
    ...
    static TURBO_FORCE_INLINE uint32_t rotr_generic(const uint32_t &x, int i) {
    ...
    static TURBO_FORCE_INLINE uint32_t rotr(const uint32_t &x, int i) {
        uint32_t x1 = x;
    ...
    /// rotr - generic implementation
    static TURBO_FORCE_INLINE uint64_t rotr_generic(const uint64_t &x, int i) {
    ...
    /// rotr - gcc/clang assembler
    static TURBO_FORCE_INLINE uint64_t rotr(const uint64_t &x, int i) {
        uint64_t x1 = x;
