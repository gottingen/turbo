...
#ifndef TURBO_BASE_TYPE_INDEX_H_
#define TURBO_BASE_TYPE_INDEX_H_
...
namespace std {
    ...
    template <>
    struct hash<turbo::base::type_index> {
        size_t operator()(const turbo::base::type_index& type) const noexcept {
...
#endif  // TURBO_BASE_TYPE_INDEX_H_
