...
TEST_F(ParseTest, TestKeepParsedArgs) {
  ...
  EXPECT_THAT(
      out_args1,
      ElementsAreArray({turbo::string_view("testbin"), turbo::string_view("arg1"),
                        turbo::string_view("arg2"), turbo::string_view("arg3"),
  ...
  EXPECT_THAT(
      ...
      ElementsAreArray({turbo::string_view("testbin"),
                        turbo::string_view("--bool_flag"),
                        turbo::string_view("--int_flag=211"),
                        turbo::string_view("--double_flag=1.1"),
                        turbo::string_view("--string_flag"),
                        turbo::string_view("asd"), turbo::string_view("--"),
                        turbo::string_view("arg1"), turbo::string_view("arg2"),
                        turbo::string_view("arg3"), turbo::string_view("arg4")}));
}
...
TEST_F(ParseTest, TestIgnoreUndefinedFlags) {
  ...
  EXPECT_THAT(out_args1, ElementsAreArray({turbo::string_view("testbin"),
                                           turbo::string_view("arg1")}));
  ...
  EXPECT_THAT(
      out_args2,
      ElementsAreArray(
          {turbo::string_view("testbin"), turbo::string_view("--undef_flag=aa"),
           turbo::string_view("--string_flag=AA"), turbo::string_view("arg1")}));
