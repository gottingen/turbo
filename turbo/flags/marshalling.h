...
//   // on failure.
//   bool TurboParseFlag(turbo::string_piece text,
//                      OutputMode* mode,
//                      std::string* error) {
//     if (text == "plaintext") {
//       *mode = kPlainText;
...
//   };
//
//   bool TurboParseFlag(turbo::string_piece text, MyFlagType* flag,
//                      std::string* err);
//
...
//   bool TurboParseFlag(turbo::string_piece text, MyFlagType* flag,
//                      std::string* err) {
//     std::pair<turbo::string_piece, turbo::string_piece> tokens =
//         turbo::StrSplit(text, ',');
...
// implementations
template <typename T>
inline bool ParseFlag(turbo::string_piece input, T* dst, std::string* error);
template <typename T>
...
bool TurboParseFlag(turbo::string_piece, bool*, std::string*);
bool TurboParseFlag(turbo::string_piece, short*, std::string*);           // NOLINT
bool TurboParseFlag(turbo::string_piece, unsigned short*, std::string*);  // NOLINT
bool TurboParseFlag(turbo::string_piece, int*, std::string*);             // NOLINT
bool TurboParseFlag(turbo::string_piece, unsigned int*, std::string*);    // NOLINT
bool TurboParseFlag(turbo::string_piece, long*, std::string*);            // NOLINT
bool TurboParseFlag(turbo::string_piece, unsigned long*, std::string*);   // NOLINT
bool TurboParseFlag(turbo::string_piece, long long*, std::string*);       // NOLINT
bool TurboParseFlag(turbo::string_piece, unsigned long long*,             // NOLINT
                   std::string*);
bool TurboParseFlag(turbo::string_piece, float*, std::string*);
bool TurboParseFlag(turbo::string_piece, double*, std::string*);
bool TurboParseFlag(turbo::string_piece, std::string*, std::string*);
bool TurboParseFlag(turbo::string_piece, std::vector<std::string>*, std::string*);

template <typename T>
bool TurboParseFlag(turbo::string_piece text, turbo::optional<T>* f,
                   std::string* err) {
  if (text.empty()) {
    *f = turbo::nullopt;
    return true;
...
#if defined(TURBO_HAVE_STD_OPTIONAL) && !defined(TURBO_USES_STD_OPTIONAL)
template <typename T>
bool TurboParseFlag(turbo::string_piece text, std::optional<T>* f,
                   std::string* err) {
  if (text.empty()) {
    *f = std::nullopt;
    return true;
...
template <typename T>
bool InvokeParseFlag(turbo::string_piece input, T* dst, std::string* err) {
  // Comment on next line provides a good compiler error message if T
  // does not have TurboParseFlag(turbo::string_piece, T*, std::string*).
...
std::string TurboUnparseFlag(turbo::string_piece v);
...
bool TurboParseFlag(turbo::string_piece, turbo::LogSeverity*, std::string*);
