...
// and is used to construct the turbo::Flag. No additionl code is generated by
...
using FlagUseValueAndInitBitStorage = std::integral_constant<
    bool, turbo::type_traits_internal::is_trivially_copyable<T>::value &&
...
class FlagImpl final : public CommandLineFlag {
 public:
  ...
  template <typename T,
            turbo::enable_if_t<flags_internal::StorageKind<T>() ==
                                  FlagValueStorageKind::kOneWordAtomic,
                              int> = 0>
 ...
 private:
  ...
  turbo::Mutex* DataGuard() const
      ABSL_LOCK_RETURNED(reinterpret_cast<turbo::Mutex*>(data_guard_));
