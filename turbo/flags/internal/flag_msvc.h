...
// Include turbo/flags/flag.h instead.

// MSVC debug builds do not implement initialization with constexpr constructors
// correctly. To work around this we add a level of indirection, so that the
// class `turbo::Flag` contains an `internal::Flag*` (instead of being an alias
// to that class) and dynamically allocates an instance when necessary. We also
// forward all calls to internal::Flag methods via trampoline methods. In this
// setup the `turbo::Flag` class does not have constructor and virtual methods,
...
// Public methods of `turbo::Flag<T>` are NOT part of the Turbo Flags API.
