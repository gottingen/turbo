...
#ifndef TURBO_STRING_STR_FORMAT_H_
#define TURBO_STRING_STR_FORMAT_H_
...
namespace turbo {
    ...
    using string_output_stream = ::turbo::strings_internal::string_output_stream;
...
#endif  // TURBO_STRING_STR_FORMAT_H_
