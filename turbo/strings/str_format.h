...
//     is generally unsafe due to buffer overflows. Use `turbo::StrFormat` which
...
class FormatCountCapture {
 public:
  explicit FormatCountCapture(turbo::Nonnull<int*> p) : p_(p) {}
...
//   turbo::StrFormat(format_string, "TheVillage", 6);
//
//   // Verified at runtime.
...
template <typename... Args>
std::string& StrAppendFormat(turbo::Nonnull<std::string*> dst,
