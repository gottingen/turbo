...
TURBO_MUST_USE_RESULT bool SimpleAtoi(turbo::string_view str,
...
TURBO_MUST_USE_RESULT bool SimpleAtof(turbo::string_view str,
...
// always use the "C" locale. If any errors are encountered, this function
// returns `false`, leaving `out` in an unspecified state.
TURBO_MUST_USE_RESULT bool SimpleAtod(turbo::string_view str,
...
// unspecified state.
TURBO_MUST_USE_RESULT bool SimpleAtob(turbo::string_view str,
...
template <typename int_type>
TURBO_MUST_USE_RESULT bool SimpleHexAtoi(turbo::string_view str,
                                        turbo::Nonnull<int_type*> out);

// Overloads of SimpleHexAtoi() for 128 bit integers.
TURBO_MUST_USE_RESULT inline bool SimpleHexAtoi(
