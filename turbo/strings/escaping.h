...
//   if (!turbo::unescape(s, &unescaped_s) {
//     ...
//   }
...
TURBO_FORCE_INLINE bool unescape(std::string_view source, std::string *dest) {
...
//   std::string escaped_s = turbo::escape(s);
...
//
//   std::string s = "foo\rbar\tbaz\010\011\012\013\014\x0d\n";
//   std::string escaped_s = turbo::hex_escape(s);
