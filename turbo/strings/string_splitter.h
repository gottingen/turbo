...
#ifndef TURBO_STRINGS_STRING_SPLITTER_H_
#define TURBO_STRINGS_STRING_SPLITTER_H_
...
// Split a string with one of the separators
    ...
    public:
        ...
        inline std::string_view key() {
            return turbo::safe_substr(key_and_value(), 0, _delim_pos);
        }

        inline std::string_view value() {
            return turbo::safe_substr(key_and_value(), _delim_pos + 1);
        }
...
#include "turbo/strings/string_splitter_inl.h"

#endif  // TURBO_STRINGS_STRING_SPLITTER_H_
