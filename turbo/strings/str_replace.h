...
// -----------------------------------------------------------------------------
//
// This file defines `turbo::string_replace_all()`, a general-purpose string
...
// Example:
//
// std::string html_escaped = turbo::string_replace_all(user_input, {
//                                                {"&", "&amp;"},
//                                                {"<", "&lt;"},
//                                                {">", "&gt;"},
//                                                {"\"", "&quot;"},
...
// Example:
//
//   std::string s = turbo::string_replace_all(
//       "$who bought $count #Noun. Thanks $who!",
//       {{"$count", turbo::string_cat(5)},
//        {"$who", "Bob"},
//        {"#Noun", "Apples"}});
//   EXPECT_EQ("Bob bought 5 Apples. Thanks Bob!", s);
TURBO_MUST_USE_RESULT std::string string_replace_all(
        std::string_view s,
...
//   replacements.push_back({"<", "&lt;"});
//   replacements.push_back({">", "&gt;"});
//   std::string s = turbo::string_replace_all("if (ptr < &foo)",
//                                  replacements);
...
//   int count = turbo::string_replace_all({{"&", "&amp;"},
//                                    {"<", "&lt;"},
//                                    {">", "&gt;"}}, &s);
//  EXPECT_EQ(count, 2);
//  EXPECT_EQ("if (ptr &lt; &amp;foo)", s);
