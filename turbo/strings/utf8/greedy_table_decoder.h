...
TURBO_FORCE_INLINE void GreedyTableDecoder::SkipByGreedy_2(const char8_t*& pSrc) noexcept {
  if ((pSrc[0] & 0xC0) == 0x80) {
    pSrc += 1;
  }
}

TURBO_FORCE_INLINE void GreedyTableDecoder::AdvanceByGreedy_2(const char8_t*& pSrc,
...
TURBO_FORCE_INLINE void GreedyTableDecoder::SkipByGreedy_3(const char8_t*& pSrc) noexcept {
  if (((pSrc[0] & 0xC0) == 0x80) && ((pSrc[1] & 0xC0) == 0x80)) {
    pSrc += 2;
  }
}

TURBO_FORCE_INLINE void GreedyTableDecoder::AdvanceByGreedy_3(const char8_t*& pSrc,
                                                                    char32_t& cdpt) noexcept {
  char32_t unit2;  //- The second UTF-8 code unit
...
TURBO_FORCE_INLINE void GreedyTableDecoder::SkipByGreedy_4(const char8_t*& pSrc) noexcept {
  if (((pSrc[0] & 0xC0) == 0x80) && ((pSrc[1] & 0xC0) == 0x80) && ((pSrc[2] & 0xC0) == 0x80)) {
    pSrc += 3;
  }
}

TURBO_FORCE_INLINE void GreedyTableDecoder::AdvanceByGreedy_4(const char8_t*& pSrc,
                                                                    char32_t& cdpt) noexcept {
  char32_t unit2;  //- The second UTF-8 code unit
  char32_t unit3;  //- The third UTF-8 code unit
