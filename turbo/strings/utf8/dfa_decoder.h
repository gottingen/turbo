...
#ifndef TURBO_STRINGS_UTF8_DFA_DECODE_H_
#define TURBO_STRINGS_UTF8_DFA_DECODE_H_
...
//
template <int32_t size>
TURBO_FORCE_INLINE void DFADecoder::AdvanceWithTable(char8_t const*& pSrc,
                                                           int32_t curr,
                                                           char32_t& cdpt) noexcept {
...
TURBO_FORCE_INLINE void DFADecoder::AdvanceWithTable_2(const char8_t*& pSrc,
                                                             int32_t curr,
                                                             char32_t& cdpt) noexcept {
...
TURBO_FORCE_INLINE void DFADecoder::AdvanceWithTable_3(const char8_t*& pSrc,
                                                             int32_t curr,
                                                             char32_t& cdpt) noexcept {
  char32_t unit2;  //- The second UTF-8 code unit
...
TURBO_FORCE_INLINE void DFADecoder::AdvanceWithTable_4(const char8_t*& pSrc,
                                                             int32_t curr,
                                                             char32_t& cdpt) noexcept {
  char32_t unit2;  //- The second UTF-8 code unit
  char32_t unit3;  //- The third UTF-8 code unit
...
//--------------------------------------------------------------------------------------------------
//
TURBO_FORCE_INLINE DFADecoder::State DFADecoder::AdvanceWithTrace(char8_t const*& pSrc,
                                                                        char8_t const* pSrcEnd,
                                                                        char32_t& cdpt) noexcept {
  char32_t unit;   //- The current UTF-8 code unit
