...
#ifndef TURBO_STRINGS_UTF8_DFA_DECODER_H_
#define TURBO_STRINGS_UTF8_DFA_DECODER_H_
...
namespace turbo::utf8_detail {
    ...
    public:
        ...
        //
        static ptrdiff_t convert_with_trace(char8_t const *pSrc,
    ...
    private:
        ...
        struct first_unit_info {
            char8_t mFirstOctet;
            dfa_state mNextState;
            std::uint8_t size;
        };

        struct alignas(128) lookup_tables {
            first_unit_info maFirstUnitTable[128];
            char_class maOctetCategory[256];
            dfa_state maTransitions[108];
    ...
    private:
        ...
        static void advance_with_table(char8_t const *&pSrc, int32_t curr, char32_t &cdpt) noexcept;

        static void advance_with_table_2(char8_t const *&pSrc, int32_t curr, char32_t &cdpt) noexcept;

        static void advance_with_table_3(char8_t const *&pSrc, int32_t curr, char32_t &cdpt) noexcept;

        static void advance_with_table_4(char8_t const *&pSrc, int32_t curr, char32_t &cdpt) noexcept;

        static dfa_state advance_with_trace(char8_t const *&pSrc,
                                      char8_t const *pSrcEnd,
                                      char32_t &cdpt) noexcept;

        static void print_state_data(dfa_state curr, char_class type, uint32_t unit, dfa_state next);
    };
    ...
    //
    template<int32_t size>
    TURBO_FORCE_INLINE void dfa_decoder::advance_with_table(char8_t const *&pSrc,
                                                         int32_t curr,
                                                         char32_t &cdpt) noexcept {
...
#pragma unroll(size)
    ...
    TURBO_FORCE_INLINE void dfa_decoder::advance_with_table_2(const char8_t *&pSrc,
                                                           int32_t curr,
                                                           char32_t &cdpt) noexcept {
    ...
    TURBO_FORCE_INLINE void dfa_decoder::advance_with_table_3(const char8_t *&pSrc,
                                                           int32_t curr,
                                                           char32_t &cdpt) noexcept {
        char32_t unit2;  //- The second UTF-8 code unit
    ...
    TURBO_FORCE_INLINE void dfa_decoder::advance_with_table_4(const char8_t *&pSrc,
                                                           int32_t curr,
                                                           char32_t &cdpt) noexcept {
        char32_t unit2;  //- The second UTF-8 code unit
        char32_t unit3;  //- The third UTF-8 code unit
    ...
    //--------------------------------------------------------------------------------------------------
    //
    TURBO_FORCE_INLINE dfa_decoder::dfa_state

    dfa_decoder::advance_with_trace(char8_t const *&pSrc,
                                 char8_t const *pSrcEnd,
                                 char32_t &cdpt) noexcept {
        char32_t unit;   //- The current UTF-8 code unit
        char_class type;  //- The UTF-8 "sequence class"
        dfa_state next;      //- The next DFA state
        dfa_state curr;      //- The current DFA state
        ...
        print_state_data(curr, type, (char8_t) unit, next);
...
#endif  // TURBO_STRINGS_UTF8_DFA_DECODER_H_
