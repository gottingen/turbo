...
TEST(MemUtilTest, AllTests) {
  ...
  int len = turbo::strings_internal::memspn("hello there",
...

  {
    ...
    EXPECT_EQ(turbo::strings_internal::memmem(kHaystack, 0, "", 0), kHaystack);
    EXPECT_EQ(turbo::strings_internal::memmem(kHaystack, 10, "012", 3),
              kHaystack);
    EXPECT_EQ(turbo::strings_internal::memmem(kHaystack, 10, "0xx", 1),
              kHaystack);
    EXPECT_EQ(turbo::strings_internal::memmem(kHaystack, 10, "789", 3),
              kHaystack + 7);
    EXPECT_EQ(turbo::strings_internal::memmem(kHaystack, 10, "9xx", 1),
              kHaystack + 9);
    EXPECT_TRUE(turbo::strings_internal::memmem(kHaystack, 10, "9xx", 3) ==
                nullptr);
    EXPECT_TRUE(turbo::strings_internal::memmem(kHaystack, 10, "xxx", 1) ==
                nullptr);
  }
  {
    const char kHaystack[] = "aBcDeFgHiJ";
    EXPECT_EQ(turbo::strings_internal::memcasemem(kHaystack, 0, "", 0),
              kHaystack);
    EXPECT_EQ(turbo::strings_internal::memcasemem(kHaystack, 10, "Abc", 3),
              kHaystack);
    EXPECT_EQ(turbo::strings_internal::memcasemem(kHaystack, 10, "Axx", 1),
              kHaystack);
    EXPECT_EQ(turbo::strings_internal::memcasemem(kHaystack, 10, "hIj", 3),
              kHaystack + 7);
    EXPECT_EQ(turbo::strings_internal::memcasemem(kHaystack, 10, "jxx", 1),
              kHaystack + 9);
    EXPECT_TRUE(turbo::strings_internal::memcasemem(kHaystack, 10, "jxx", 3) ==
                nullptr);
    EXPECT_TRUE(turbo::strings_internal::memcasemem(kHaystack, 10, "xxx", 1) ==
                nullptr);
  }
  {
    const char kHaystack[] = "0123456789";
    EXPECT_EQ(turbo::strings_internal::memmatch(kHaystack, 0, "", 0), kHaystack);
    EXPECT_EQ(turbo::strings_internal::memmatch(kHaystack, 10, "012", 3),
              kHaystack);
    EXPECT_EQ(turbo::strings_internal::memmatch(kHaystack, 10, "0xx", 1),
              kHaystack);
    EXPECT_EQ(turbo::strings_internal::memmatch(kHaystack, 10, "789", 3),
              kHaystack + 7);
    EXPECT_EQ(turbo::strings_internal::memmatch(kHaystack, 10, "9xx", 1),
              kHaystack + 9);
    EXPECT_TRUE(turbo::strings_internal::memmatch(kHaystack, 10, "9xx", 3) ==
                nullptr);
    EXPECT_TRUE(turbo::strings_internal::memmatch(kHaystack, 10, "xxx", 1) ==
                nullptr);
  }
}
