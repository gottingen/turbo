...
TEST(StrFormatChecker, ValidFormat) {
  ...
  constexpr Case trues[] = {
      ...
      ValidFormat<string_piece, const char*, double, void*>(
          "string_piece=%s const char*=%s double=%f void*=%p)"),
      ValidFormat<int>("%v"),  //
      ...
      ValidFormat<void*, string_piece, const char*, double>(
          "string_piece=%2$s const char*=%3$s double=%4$f void*=%1$p "
          "repeat=%3$s)"),
