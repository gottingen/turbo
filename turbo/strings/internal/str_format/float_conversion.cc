...
// cases. This way we use less stack in the common cases.
            class StackArray {
                ...
                TURBO_ATTRIBUTE_NOINLINE static void RunWithCapacityImpl(Func f) {
...
// Requires: `0 <= carry <= 9`
            ...
            inline char MultiplyBy10WithCarry(Int *v, char carry) {
                using BiggerInt = turbo::conditional_t<sizeof(Int) == 4, uint64_t, uint128>;
                BiggerInt tmp =
...
// Otherwise, return false.
            ...
            struct Decomposed {
                using MantissaType =
                        turbo::conditional_t<std::is_same<long double, Float>::value, uint128,
                                uint64_t>;
