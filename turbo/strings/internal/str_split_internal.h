...
namespace turbo::strings_internal {
    ...
    struct splitter_is_convertible_to
            : splitter_is_convertible_to_impl<C,
                    ...
                    turbo::has_value_type<C>::value && turbo::has_const_iterator<C>::value,
                    turbo::has_mapped_type<C>::value> {
    };

    // This class implements the range that is returned by turbo:: string_split(). This
