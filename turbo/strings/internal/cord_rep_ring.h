...
class CordRepRing : public CordRep {
 public:
  ...
  static CordRepRing* Append(CordRepRing* rep, string_piece data,
                             size_t extra = 0);
  ...
  static CordRepRing* Prepend(CordRepRing* rep, string_piece data,
                              size_t extra = 0);
  ...
  bool IsFlat(size_t offset, size_t len, turbo::string_piece* fragment) const;
  ...
  turbo::string_piece entry_data(index_type index) const;
...
inline turbo::string_piece CordRepRing::entry_data(index_type index) const {
...
inline bool CordRepRing::IsFlat(turbo::string_piece* fragment) const {
  if (entries() == 1) {
...
inline bool CordRepRing::IsFlat(size_t offset, size_t len,
  ...
  const turbo::string_piece data = entry_data(pos.index);
