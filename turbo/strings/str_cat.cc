...
alpha_num::alpha_num(hex h) {
    ...
    auto real_width =
            turbo::numbers_internal::fast_hex_to_buffer_zero_pad16(h.value, end - 16);
...
std::string string_cat(const alpha_num &a, const alpha_num &b) {
    std::string result;
    turbo::base::string_resize_uninitialized(&result,
                                      a.size() + b.size());
...
std::string string_cat(const alpha_num &a, const alpha_num &b, const alpha_num &c) {
    std::string result;
    turbo::base::string_resize_uninitialized(
...
std::string CatPieces(std::initializer_list<std::string_view> pieces) {
    ...
    turbo::base::string_resize_uninitialized(&result, total_size);
...
void append_pieces(std::string *dest,
    ...
    turbo::base::string_resize_uninitialized(dest, total_size);
