...
namespace turbo {
    ...
    //   std::vector<std::string> v1 = turbo:: string_split("a,b,c", ',');
    //   using turbo::by_char;
    //   std::vector<std::string> v2 = turbo:: string_split("a,b,c", by_char(','));
    //   // v[0] == "a", v[1] == "b", v[2] == "c"
    //
    ...
    //
    //   using turbo::by_char;
    //   std::vector<std::string> v = turbo:: string_split("a-b", by_char('-'));
    //
    class by_char {
    public:
    ...
    //   std::vector<std::string> v = turbo:: string_split("123456789",  by_length(3));
    ...
    //
    //   using turbo:: by_length;
    //   std::vector<std::string> v = turbo:: string_split("12345",  by_length(2));
    //
    //   // v[0] == "12", v[1] == "34", v[2] == "5"
    class by_length {
    public:
    ...
    namespace strings_internal {
        ...
        // This allows functions like turbo:: string_split() and turbo:: max_splits() to accept
    ...
    //   std::vector<std::string> v = turbo:: string_split("a,b,c",  max_splits(',', 1));
    //
    //   // v[0] == "a", v[1] == "b,c"
    template<typename Delimiter>
    TURBO_FORCE_INLINE strings_internal::max_splits_impl<
    ...
    // Example:
    //
    //  std::vector<std::string> v = turbo:: string_split(" a , ,,b,", ',',  allow_empty());
    //
    ...
    // Example:
    //
    //   std::vector<std::string> v = turbo:: string_split(",a,,b,", ',',  skip_empty());
    //
    //   // v[0] == "a", v[1] == "b"
    //
    ...
    //   std::map<std::string, std::string> m = turbo:: string_split("a,b,c", ',');
    ...
    //
    //   turbo:: string_split(std::string_view(""), '-');  // {""}
    //   turbo:: string_split(std::string_view(), '-');    // {}, but should be {""}
    //
