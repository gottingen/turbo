...
//
// NOTE: Use of `alpha_num` outside of the //turbo/strings package is unsupported
...
struct hex {
    ...
    explicit hex(
            Int v, pad_spec spec = turbo::kNoPad,
    ...
    explicit hex(Pointee *v, pad_spec spec = turbo::kNoPad)
...
struct dec {
    ...
    template<typename Int>
    explicit dec(Int v, pad_spec spec = turbo::kNoPad,
...
TURBO_MUST_USE_RESULT TURBO_FORCE_INLINE std::string string_cat() { return std::string(); }

TURBO_MUST_USE_RESULT TURBO_FORCE_INLINE std::string string_cat(const alpha_num &a) {
    return std::string(a.data(), a.size());
}

TURBO_MUST_USE_RESULT std::string string_cat(const alpha_num &a, const alpha_num &b);
...
TURBO_MUST_USE_RESULT TURBO_FORCE_INLINE std::string string_cat(
...
TURBO_FORCE_INLINE void string_append(std::string *) {}
...
// Support 5 or more arguments
template<typename... AV>
TURBO_FORCE_INLINE void string_append(std::string *dest, const alpha_num &a, const alpha_num &b,
...
// This is fast.
TURBO_FORCE_INLINE strings_internal::alpha_num_buffer<
