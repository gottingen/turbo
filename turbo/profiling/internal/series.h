...
#ifndef TURBO_PROFILING_INTERNAL_SERIES_H_
#define TURBO_PROFILING_INTERNAL_SERIES_H_
...
namespace turbo::profiling_internal {
    ...
    void Series<Batch<T, N>, Op>::describe(std::ostream &os,
        ...
        std::vector<std::string_view> names = turbo::str_split(vector_names ? vector_names->c_str() : "", ',');
        auto it = names.begin();
        os << '[';
...
#endif  // TURBO_PROFILING_INTERNAL_SERIES_H_
