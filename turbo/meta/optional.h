...
class optional : private optional_internal::optional_data<T>,
 ...
 public:
  ...
  constexpr explicit optional(InPlaceT, Args&&... args)
      : data_base(in_place_t(), turbo::forward<Args>(args)...) {}
  ...
  constexpr explicit optional(in_place_t, std::initializer_list<U> il,
                              Args&&... args)
      : data_base(in_place_t(), il, turbo::forward<Args>(args)...) {
  }
  ...
  template <
      ...
      typename std::enable_if<
          ...
          bool>::type = false>
  constexpr optional(U&& v) : data_base(in_place_t(), turbo::forward<U>(v)) {}
  ...
  explicit constexpr optional(U&& v)
      : data_base(in_place_t(), turbo::forward<U>(v)) {}
...
#pragma warning(pop)
  ...
  constexpr T value_or(U&& v) const& {
    ...
    return static_cast<bool>(*this)
               ? **this
               : static_cast<T>(turbo::forward<U>(v));
  }
  template <typename U>
...
constexpr optional<typename std::decay<T>::type> make_optional(T&& v) {
  return optional<typename std::decay<T>::type>(turbo::forward<T>(v));
}

template <typename T, typename... Args>
constexpr optional<T> make_optional(Args&&... args) {
  return optional<T>(in_place_t(), turbo::forward<Args>(args)...);
}
