...
#pragma GCC diagnostic pop
  ...
  constexpr explicit optional_data_dtor_base(in_place_t, Args&&... args)
      : engaged_(true), data_(turbo::forward<Args>(args)...) {}
...
class optional_data_base : public optional_data_dtor_base<T> {
 protected:
  ...
  constexpr explicit optional_data_base(in_place_t t, Args&&... args)
      : base(t, turbo::forward<Args>(args)...) {}
#endif
...
// TODO(turbo-team): Add another class using
...
template <typename T,
          bool unused = turbo::is_trivially_copy_constructible<T>::value&&
              turbo::is_trivially_copy_assignable<typename std::remove_cv<
...
class optional_data<T, true> : public optional_data_base<T> {
 protected:
  ...
  constexpr explicit optional_data(in_place_t t, Args&&... args)
      : optional_data_base<T>(t, turbo::forward<Args>(args)...) {}
#endif
};
...
struct assign_copy_traits {
  static constexpr copy_traits traits =
      turbo::is_copy_assignable<T>::value && std::is_copy_constructible<T>::value
          ? copy_traits::copyable
          : turbo::is_move_assignable<T>::value &&
