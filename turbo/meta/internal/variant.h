...
//
// Implementation details of turbo/types/variant.h, pulled into a
// separate file to avoid cluttering the top of the API header with
// implementation details.

#ifndef TURBO_TYPES_INTERNAL_VARIANT_H_
#define TURBO_TYPES_INTERNAL_VARIANT_H_
...
TURBO_INTERNAL_INLINE_CONSTEXPR(size_t, variant_npos, static_cast<size_t>(-1));
...
struct VariantAccessResultImpl<I, Variantemplate<T...>&> {
  using type = typename turbo::variant_alternative<I, variant<T...>>::type&;
};

template <std::size_t I, template <class...> class Variantemplate, class... T>
struct VariantAccessResultImpl<I, const Variantemplate<T...>&> {
  using type =
      const typename turbo::variant_alternative<I, variant<T...>>::type&;
};
...
struct VisitIndicesResultImpl {
  using type = turbo::result_of_t<Op(AlwaysZero<Vs>...)>;
};
...
constexpr ReturnType call_with_indices(FunctionObject&& function) {
  ...
  return turbo::forward<FunctionObject>(function)(SizeT<Indices>()...);
}
...
struct MakeVisitationMatrix<ReturnType, FunctionObject,
    ...
    : MakeVisitationMatrixImpl<ReturnType, FunctionObject,
                               ...
                               turbo::make_index_sequence<HeadEndIndex>,
                               index_sequence<BoundIndices...>> {};
...
struct UnreachableSwitchCase {
  ...
  [[noreturn]] static VisitIndicesResultT<Op, std::size_t> Run(
      Op&& /*ignored*/) {
#if TURBO_HAVE_BUILTIN(__builtin_unreachable) || \
    ...
    return Run(turbo::forward<Op>(op));
...
struct ReachableSwitchCase {
  static VisitIndicesResultT<Op, std::size_t> Run(Op&& op) {
    return turbo::base_internal::invoke(turbo::forward<Op>(op), SizeT<I>());
  }
};
...
TURBO_INTERNAL_INLINE_CONSTEXPR(std::size_t, MaxUnrolledVisitCases, 33);
...
[[noreturn]] ReturnType TypedThrowBadVariantAccess() {
  turbo::variant_internal::ThrowBadVariantAccess();
}
...
struct VisitIndicesSwitch {
  ...
  static VisitIndicesResultT<Op, std::size_t> Run(Op&& op, std::size_t i) {
    switch (i) {
      case 0:
        return PickCase<Op, 0, EndIndex>::Run(turbo::forward<Op>(op));
      case 1:
        return PickCase<Op, 1, EndIndex>::Run(turbo::forward<Op>(op));
      case 2:
        return PickCase<Op, 2, EndIndex>::Run(turbo::forward<Op>(op));
      case 3:
        return PickCase<Op, 3, EndIndex>::Run(turbo::forward<Op>(op));
      case 4:
        return PickCase<Op, 4, EndIndex>::Run(turbo::forward<Op>(op));
      case 5:
        return PickCase<Op, 5, EndIndex>::Run(turbo::forward<Op>(op));
      case 6:
        return PickCase<Op, 6, EndIndex>::Run(turbo::forward<Op>(op));
      case 7:
        return PickCase<Op, 7, EndIndex>::Run(turbo::forward<Op>(op));
      case 8:
        return PickCase<Op, 8, EndIndex>::Run(turbo::forward<Op>(op));
      case 9:
        return PickCase<Op, 9, EndIndex>::Run(turbo::forward<Op>(op));
      case 10:
        return PickCase<Op, 10, EndIndex>::Run(turbo::forward<Op>(op));
      case 11:
        return PickCase<Op, 11, EndIndex>::Run(turbo::forward<Op>(op));
      case 12:
        return PickCase<Op, 12, EndIndex>::Run(turbo::forward<Op>(op));
      case 13:
        return PickCase<Op, 13, EndIndex>::Run(turbo::forward<Op>(op));
      case 14:
        return PickCase<Op, 14, EndIndex>::Run(turbo::forward<Op>(op));
      case 15:
        return PickCase<Op, 15, EndIndex>::Run(turbo::forward<Op>(op));
      case 16:
        return PickCase<Op, 16, EndIndex>::Run(turbo::forward<Op>(op));
      case 17:
        return PickCase<Op, 17, EndIndex>::Run(turbo::forward<Op>(op));
      case 18:
        return PickCase<Op, 18, EndIndex>::Run(turbo::forward<Op>(op));
      case 19:
        return PickCase<Op, 19, EndIndex>::Run(turbo::forward<Op>(op));
      case 20:
        return PickCase<Op, 20, EndIndex>::Run(turbo::forward<Op>(op));
      case 21:
        return PickCase<Op, 21, EndIndex>::Run(turbo::forward<Op>(op));
      case 22:
        return PickCase<Op, 22, EndIndex>::Run(turbo::forward<Op>(op));
      case 23:
        return PickCase<Op, 23, EndIndex>::Run(turbo::forward<Op>(op));
      case 24:
        return PickCase<Op, 24, EndIndex>::Run(turbo::forward<Op>(op));
      case 25:
        return PickCase<Op, 25, EndIndex>::Run(turbo::forward<Op>(op));
      case 26:
        return PickCase<Op, 26, EndIndex>::Run(turbo::forward<Op>(op));
      case 27:
        return PickCase<Op, 27, EndIndex>::Run(turbo::forward<Op>(op));
      case 28:
        return PickCase<Op, 28, EndIndex>::Run(turbo::forward<Op>(op));
      case 29:
        return PickCase<Op, 29, EndIndex>::Run(turbo::forward<Op>(op));
      case 30:
        return PickCase<Op, 30, EndIndex>::Run(turbo::forward<Op>(op));
      case 31:
        return PickCase<Op, 31, EndIndex>::Run(turbo::forward<Op>(op));
      case 32:
        return PickCase<Op, 32, EndIndex>::Run(turbo::forward<Op>(op));
      default:
        TURBO_ASSERT(i == variant_npos);
        return turbo::base_internal::invoke(turbo::forward<Op>(op), NPos());
    }
  }
};
...
struct VisitIndicesVariadicImpl<turbo::index_sequence<N...>, EndIndices...> {
  ...
  static VisitIndicesResultT<Op, decltype(EndIndices)...> Run(Op&& op,
    ...
    return VisitIndicesSwitch<NumCasesOfSwitch<EndIndices...>::value>::Run(
        FlattenedOp<Op>{turbo::forward<Op>(op)},
...
struct VisitIndicesVariadic
    : VisitIndicesVariadicImpl<turbo::make_index_sequence<sizeof...(EndIndices)>,
                               EndIndices...> {};
...
template <std::size_t... EndIndices>
struct VisitIndices
    : turbo::conditional_t<(NumCasesOfSwitch<EndIndices...>::value <=
...
struct VisitIndices<EndIndex>
    : turbo::conditional_t<(EndIndex <= MaxUnrolledVisitCases),
...
struct VariantCoreAccess {
  ...
  static void Destroy(VariantType& self) {  // NOLINT
    ...
    self.index_ = turbo::variant_npos;
  }
  ...
  static void InitFrom(Variant& self, Variant&& other) {  // NOLINT
    VisitIndices<turbo::variant_size<Variant>::value>::Run(
  ...
  static VariantAccessResult<I, Variant> CheckedAccess(Variant&& self) {
    ...
    return Access<I>(turbo::forward<Variant>(self));
  }
  ...
  struct MoveAssignVisitor {
    ...
    void operator()(SizeT<turbo::variant_npos> /*new_i*/) const {
      Destroy(*left);
    }
  ...
  struct CopyAssignVisitor {
    ...
    void operator()(SizeT<NewIndex> /*new_i*/) const {
      using New =
          typename turbo::variant_alternative<NewIndex, DerivedType>::type;
  ...
  struct ConversionAssignVisitor {
    ...
    void operator()(SizeT<NewIndex::value> /*old_i*/
      ...
      Access<NewIndex::value>(*left) = turbo::forward<QualifiedNew>(other);
    }
    ...
    void operator()(SizeT<OldIndex> /*old_i*/
      ...
      using New =
          typename turbo::variant_alternative<NewIndex::value, Left>::type;
      if (std::is_nothrow_constructible<New, QualifiedNew>::value ||
          !std::is_nothrow_move_constructible<New>::value) {
        left->template emplace<NewIndex::value>(
            turbo::forward<QualifiedNew>(other));
      } else {
        ...
        left->template emplace<NewIndex::value>(
            New(turbo::forward<QualifiedNew>(other)));
      }
    }
  ...
  MakeConversionAssignVisitor(Left* left, QualifiedNew&& qual) {
    return {left, turbo::forward<QualifiedNew>(qual)};
  }
  ...
  static typename turbo::variant_alternative<NewIndex, Self>::type& Replace(
      Self* self, Args&&... args) {
    Destroy(*self);
    using New = typename turbo::variant_alternative<NewIndex, Self>::type;
    New* const result = ::new (static_cast<void*>(&self->state_))
        New(turbo::forward<Args>(args)...);
...
struct ContainsVariantNPos
    : turbo::negation<std::is_same<  // NOLINT
          turbo::integer_sequence<bool, 0 <= Is...>,
          turbo::integer_sequence<bool, Is != turbo::variant_npos...>>> {};

template <class Op, class... QualifiedVariants>
using RawVisitResult =
    turbo::result_of_t<Op(VariantAccessResult<0, QualifiedVariants>...)>;
...
struct PerformVisitation {
  ...
  constexpr ReturnType operator()(SizeT<Is>... indices) const {
    return Run(typename ContainsVariantNPos<Is...>::type{},
               turbo::index_sequence_for<QualifiedVariants...>(), indices...);
  }
  ...
  constexpr ReturnType Run(std::false_type /*has_valueless*/,
    ...
    static_assert(
        std::is_same<ReturnType,
                     turbo::result_of_t<Op(VariantAccessResult<
                                          Is, QualifiedVariants>...)>>::value,
        "All visitation overloads must have the same return type.");
    return turbo::base_internal::invoke(
        turbo::forward<Op>(op),
        VariantCoreAccess::Access<Is>(
            turbo::forward<QualifiedVariants>(std::get<TupIs>(variant_tup)))...);
  }
...
union Union<Head, Tail...> {
  ...
  explicit constexpr Union(EmplaceTag<0>, P&&... args)
      : head(turbo::forward<P>(args)...) {}

  template <std::size_t I, class... P>
  explicit constexpr Union(EmplaceTag<I>, P&&... args)
      : tail(EmplaceTag<I - 1>{}, turbo::forward<P>(args)...) {}
...
using DestructibleUnion =
    turbo::conditional_t<std::is_destructible<Union<T...>>::value, Union<T...>,
...
class VariantStateBase {
 protected:
  ...
  template <class LazyH = H,
            class ConstructibleH = turbo::enable_if_t<
  ...
  explicit constexpr VariantStateBase(EmplaceTag<I> tag, P&&... args)
      : state_(tag, turbo::forward<P>(args)...), index_(I) {}
...
template <class... T>
using RequireAllHaveEqualT = turbo::enable_if_t<
    turbo::conjunction<is_detected_convertible<bool, EqualResult, T>...>::value,
    bool>;

template <class... T>
using RequireAllHaveNotEqualT =
    turbo::enable_if_t<turbo::conjunction<is_detected_convertible<
...
struct VariantHelper<variant<Ts...>> {
  ...
  struct CanConvertFrom<variant<Us...>>
      : public turbo::conjunction<CanAccept<Us>...> {};
};
...
using VariantStateBaseDestructor =
    turbo::conditional_t<std::is_destructible<Union<T...>>::value,
                        VariantStateBase<T...>,
...
// work around the bug.
template <class... T>
using VariantMoveBase = turbo::conditional_t<
    turbo::disjunction<
        turbo::negation<turbo::conjunction<std::is_move_constructible<T>...>>,
        turbo::conjunction<IsTriviallyMoveConstructible<T>...>>::value,
...
template <class... T>
using VariantCopyBase = turbo::conditional_t<
    turbo::disjunction<
        turbo::negation<turbo::conjunction<std::is_copy_constructible<T>...>>,
        std::is_copy_constructible<Union<T...>>>::value,
    VariantMoveBase<T...>, VariantCopyBaseNontrivial<T...>>;

// Base that is dependent on whether or not the move-assign can be trivial.
template <class... T>
using VariantMoveAssignBase = turbo::conditional_t<
    turbo::disjunction<
        turbo::conjunction<turbo::is_move_assignable<Union<T...>>,
                          std::is_move_constructible<Union<T...>>,
                          std::is_destructible<Union<T...>>>,
        turbo::negation<turbo::conjunction<std::is_move_constructible<T>...,
                                         // Note: We're not qualifying this with
                                         // turbo:: because it doesn't compile
                                         // under MSVC.
...
template <class... T>
using VariantCopyAssignBase = turbo::conditional_t<
    turbo::disjunction<
        turbo::conjunction<turbo::is_copy_assignable<Union<T...>>,
 ...
 protected:
  ...
  struct Destroyer {
    ...
    void operator()(SizeT<I> i) const {
      using Alternative =
          typename turbo::variant_alternative<I, variant<T...>>::type;
      variant_internal::AccessUnion(self->state_, i).~Alternative();
    }

    void operator()(SizeT<turbo::variant_npos> /*i*/) const {
      // This space intentionally left blank
    }
...
class VariantMoveBaseNontrivial : protected VariantStateBaseDestructor<T...> {
 ...
 protected:
  ...
  struct Construct {
    ...
    void operator()(SizeT<I> i) const {
      ...
      ::new (static_cast<void*>(&self->state_)) Alternative(
          variant_internal::AccessUnion(turbo::move(other->state_), i));
    }
  ...
  VariantMoveBaseNontrivial(VariantMoveBaseNontrivial&& other) noexcept(
      turbo::conjunction<std::is_nothrow_move_constructible<T>...>::value)
...
class VariantMoveAssignBaseNontrivial : protected VariantCopyBase<T...> {
 ...
 protected:
  ...
  operator=(VariantMoveAssignBaseNontrivial&& other) noexcept(
      turbo::conjunction<std::is_nothrow_move_constructible<T>...,
...
struct EqualsOp {
  ...
  constexpr bool operator()(SizeT<turbo::variant_npos> /*v_i*/) const {
    return true;
  }
...
struct Swap {
  ...
  void operator()(SizeT<turbo::variant_npos> /*w_i*/) const {
...
#endif  // TURBO_TYPES_INTERNAL_VARIANT_H_
