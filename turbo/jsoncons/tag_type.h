...
namespace turbo {
    ...
    std::basic_ostream<CharT> &operator<<(std::basic_ostream<CharT> &os, semantic_tag tag) {
        ...
        static constexpr const CharT *multi_dim_row_major_name = JSONCONS_CSTRING_CONSTANT(CharT,
                                                                                           "multi-dim-row-major");
        static constexpr const CharT *multi_dim_column_major_name = JSONCONS_CSTRING_CONSTANT(CharT,
