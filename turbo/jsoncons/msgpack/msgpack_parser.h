...
private:
    ...
    void read_item(item_event_visitor& visitor, std::error_code& ec)
    {
        ...
        else
        {
            switch (type)
            {
                case turbo::msgpack::msgpack_type::nil_type:
                {
                    more_ = visitor.null_value(semantic_tag::none, *this, ec);
                    break;
                }
                case turbo::msgpack::msgpack_type::true_type:
                {
                    more_ = visitor.bool_value(true, semantic_tag::none, *this, ec);
                    break;
                }
                case turbo::msgpack::msgpack_type::false_type:
                {
                    more_ = visitor.bool_value(false, semantic_tag::none, *this, ec);
                    break;
                }
                case turbo::msgpack::msgpack_type::float32_type:
                {
                ...
                case turbo::msgpack::msgpack_type::float64_type:
                {
                ...
                case turbo::msgpack::msgpack_type::uint8_type:
                {
                    uint8_t b;
                ...
                case turbo::msgpack::msgpack_type::uint16_type:
                {
                ...
                case turbo::msgpack::msgpack_type::uint32_type:
                {
                ...
                case turbo::msgpack::msgpack_type::uint64_type:
                {
                ...
                case turbo::msgpack::msgpack_type::int8_type:
                {
                ...
                case turbo::msgpack::msgpack_type::int16_type:
                {
                ...
                case turbo::msgpack::msgpack_type::int32_type:
                {
                ...
                case turbo::msgpack::msgpack_type::int64_type:
                {
                ...
                case turbo::msgpack::msgpack_type::str8_type:
                case turbo::msgpack::msgpack_type::str16_type:
                case turbo::msgpack::msgpack_type::str32_type:
                {
                ...
                case turbo::msgpack::msgpack_type::bin8_type:
                case turbo::msgpack::msgpack_type::bin16_type:
                case turbo::msgpack::msgpack_type::bin32_type:
                {
                    std::size_t len = get_size(type,ec);
                    if (!more_)
                    {
                ...
                case turbo::msgpack::msgpack_type::fixext1_type:
                case turbo::msgpack::msgpack_type::fixext2_type:
                case turbo::msgpack::msgpack_type::fixext4_type:
                case turbo::msgpack::msgpack_type::fixext8_type:
                case turbo::msgpack::msgpack_type::fixext16_type:
                case turbo::msgpack::msgpack_type::ext8_type:
                case turbo::msgpack::msgpack_type::ext16_type:
                case turbo::msgpack::msgpack_type::ext32_type:
                {
                    std::size_t len = get_size(type,ec);
                    if (!more_)
                    {
                ...
                case turbo::msgpack::msgpack_type::array16_type:
                case turbo::msgpack::msgpack_type::array32_type:
                {
                    begin_array(visitor,type,ec);
                    break;
                }

                case turbo::msgpack::msgpack_type::map16_type :
                case turbo::msgpack::msgpack_type::map32_type :
                {
