...
namespace msgpack {
    ...
    private:
        ...
        {
            // true and false
            sink_.push_back(static_cast<uint8_t>(val ? turbo::msgpack::msgpack_type::true_type : turbo::msgpack::msgpack_type::false_type));
    ...
    template<class Sink=turbo::binary_stream_sink>
