...
#ifndef TURBO_JSONCONS_CBOR_CBOR_ERROR_H_
#define TURBO_JSONCONS_CBOR_CBOR_ERROR_H_
...
namespace std {
    template<>
    struct is_error_code_enum<turbo::cbor::cbor_errc> : public true_type {
    };
}

#endif  // TURBO_JSONCONS_CBOR_CBOR_ERROR_H_
