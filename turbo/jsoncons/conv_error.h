...
#ifndef TURBO_JSONCONS_CONV_ERROR_H_
#define TURBO_JSONCONS_CONV_ERROR_H_
...
namespace std {
    template<>
    struct is_error_code_enum<turbo::conv_errc> : public true_type {
    };
}
            ...
            std::string message(int ev) const override {
                switch (static_cast<conv_errc>(ev)) {
                    ...
                    case conv_errc::not_jsoncons_null_type:
                        return "Cannot convert to turbo::null_type";
...
#endif  // TURBO_JSONCONS_CONV_ERROR_H_
