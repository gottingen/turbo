...
#ifndef TURBO_JSONCONS_BASIC_JSON_H_
#define TURBO_JSONCONS_BASIC_JSON_H_
...
#include "turbo/jsoncons/json_fwd.h"
#include "turbo/jsoncons/json_type.h"
#include "turbo/jsoncons/config/version.h"
#include "turbo/jsoncons/json_type.h"
#include "turbo/jsoncons/json_exception.h"
#include "turbo/jsoncons/pretty_print.h"
#include "turbo/jsoncons/json_object.h"
#include "turbo/jsoncons/json_array.h"
...
namespace turbo {
    ...
    namespace traits_extension {
        ...
        struct is_basic_json<T,
                typename std::enable_if<traits_extension::is_detected<detail::basic_json_t, typename std::decay<T>::type>::value>::type
        > : std::true_type {
        };
        ...
        public:
            ...
            template<class Iter,
                    class=typename std::enable_if<
                            !std::is_same<Iter, Iterator>::value && std::is_convertible<Iter, Iterator>::value>::type>
    ...
    struct object_iterator_typedefs<ImplementationPolicy, KeyT, Json, typename std::enable_if<
        ...
        using object_iterator_type = turbo::detail::random_access_iterator_wrapper<typename ImplementationPolicy::template object<KeyT, Json>::iterator>;
        using const_object_iterator_type = turbo::detail::random_access_iterator_wrapper<typename ImplementationPolicy::template object<KeyT, Json>::const_iterator>;
    };
    ...
    struct object_iterator_typedefs<ImplementationPolicy, KeyT, Json, typename std::enable_if<
            traits_extension::is_detected<traits_extension::container_object_iterator_type_t, ImplementationPolicy>::value &&
            traits_extension::is_detected<traits_extension::container_const_object_iterator_type_t, ImplementationPolicy>::value>::type> {
        using object_iterator_type = turbo::detail::random_access_iterator_wrapper<typename ImplementationPolicy::template object_iterator<KeyT, Json>>;
        using const_object_iterator_type = turbo::detail::random_access_iterator_wrapper<typename ImplementationPolicy::template const_object_iterator<KeyT, Json>>;
    };
    ...
    private:
        ...
        public:
            ...
            empty_object_storage(semantic_tag tag)
                    : storage_kind_(static_cast<uint8_t>(json_storage_kind::empty_object_value)), length_(0),
                      tag_(tag) {
            }
        };
        ...
        public:
            ...
            short_string_storage(semantic_tag tag, const char_type *p, uint8_t length)
                    : storage_kind_(static_cast<uint8_t>(json_storage_kind::short_string_value)), length_(length),
                      tag_(tag) {
                TURBO_ASSERT(length <= max_length);
        ...
        public:
            ...
            semantic_tag tag_;
        private:
            turbo::detail::string_wrapper<char_type, Allocator> s_;
        public:
        ...
        public:
            ...
            semantic_tag tag_;
        private:
            turbo::detail::tagged_string_wrapper<uint8_t, Allocator> s_;
        public:

            byte_string_storage(semantic_tag tag, const uint8_t *data, std::size_t length, uint64_t ext_tag,
        ...
        private:
            ...
            void create(array_allocator alloc, Args &&... args) {
                ...
                JSONCONS_TRY {
                    std::allocator_traits<array_allocator>::construct(alloc, traits_extension::to_plain_pointer(ptr_),
            ...
            void destroy() noexcept {
                ...
                std::allocator_traits<array_allocator>::destroy(alloc, traits_extension::to_plain_pointer(ptr_));
                std::allocator_traits<array_allocator>::deallocate(alloc, ptr_, 1);
            }
        ...
        private:
            ...
            void create(object_allocator alloc, Args &&... args) {
                ...
                JSONCONS_TRY {
                    std::allocator_traits<object_allocator>::construct(alloc, traits_extension::to_plain_pointer(ptr_),
                                                                       std::forward<Args>(args)...);
                }
                JSONCONS_CATCH(...) {
        ...
        private:
            ...
            void destroy() noexcept {
                ...
                std::allocator_traits<object_allocator>::destroy(alloc, traits_extension::to_plain_pointer(ptr_));
                std::allocator_traits<object_allocator>::deallocate(alloc, ptr_, 1);
            }
        };
        ...
        public:
            json_const_pointer_storage(const basic_json *p)
                    : storage_kind_(static_cast<uint8_t>(json_storage_kind::json_const_pointer)), length_(0),
                      tag_(p->tag()),
                      p_(p) {
            }
            ...
            basic_json &evaluate_with_default() {
                ...
                if (it == val.object_range().end()) {
                    auto r = val.try_emplace(key_, json_object_arg, semantic_tag::none,
                                             val.object_value().get_allocator());
        ...
        public:
            ...
            JSONCONS_DEPRECATED_MSG(
                    "Instead, use dump(std::basic_ostream<char_type>&, const basic_json_encode_options<char_type>&)")
            ...
            JSONCONS_DEPRECATED_MSG(
                    "Instead, use dump_pretty(std::basic_ostream<char_type>&, const basic_json_encode_options<char_type>&)")
            void write(std::basic_ostream<char_type> &os, const basic_json_encode_options<char_type> &options,
                       bool pprint) const {
                if (pprint) {
            ...
            JSONCONS_DEPRECATED_MSG(
                    "Instead, use dump(std::basic_ostream<char_type>&, const basic_json_encode_options<char_type>&)")
            void
            to_stream(std::basic_ostream<char_type> &os, const basic_json_encode_options<char_type> &options) const {
                evaluate().dump(os, options);
            }

            JSONCONS_DEPRECATED_MSG(
                    "Instead, use dump_pretty(std::basic_ostream<char_type>&, const basic_json_encode_options<char_type>&)")
            void to_stream(std::basic_ostream<char_type> &os, const basic_json_encode_options<char_type> &options,
                           bool pprint) const {
                if (pprint) {
                    evaluate().dump_pretty(os, options);
                } else {
        ...
        void swap_a(basic_json &other) {
            switch (other.storage_kind()) {
                case json_storage_kind::null_value         :
                    swap_a_b<TypeA, null_storage>(other);
                    break;
                case json_storage_kind::empty_object_value :
                    swap_a_b<TypeA, empty_object_storage>(other);
                    break;
                case json_storage_kind::bool_value         :
                    swap_a_b<TypeA, bool_storage>(other);
                    break;
                case json_storage_kind::int64_value      :
                    swap_a_b<TypeA, int64_storage>(other);
                    break;
                case json_storage_kind::uint64_value     :
                    swap_a_b<TypeA, uint64_storage>(other);
                    break;
                case json_storage_kind::half_value       :
                    swap_a_b<TypeA, half_storage>(other);
                    break;
                case json_storage_kind::double_value       :
                    swap_a_b<TypeA, double_storage>(other);
                    break;
                case json_storage_kind::short_string_value :
                    swap_a_b<TypeA, short_string_storage>(other);
                    break;
                case json_storage_kind::long_string_value       :
                    swap_a_b<TypeA, long_string_storage>(other);
                    break;
                case json_storage_kind::byte_string_value  :
                    swap_a_b<TypeA, byte_string_storage>(other);
                    break;
                case json_storage_kind::array_value        :
                    swap_a_b<TypeA, array_storage>(other);
                    break;
                case json_storage_kind::object_value       :
                    swap_a_b<TypeA, object_storage>(other);
                    break;
                case json_storage_kind::json_const_pointer :
                    swap_a_b<TypeA, json_const_pointer_storage>(other);
                    break;
                default:
                    TURBO_UNREACHABLE();
                    break;
    ...
    public:
        ...
        basic_byte_string<BAllocator> as_byte_string() const {
            ...
            switch (storage_kind()) {
                case json_storage_kind::short_string_value:
                case json_storage_kind::long_string_value: {
                    value_converter<turbo::string_view, byte_string_type> converter;
                ...
                case json_storage_kind::byte_string_value:
                    return basic_byte_string<BAllocator>(cast<byte_string_storage>().data(),
            ...
            switch (storage_kind()) {
                case json_storage_kind::json_const_pointer:
                    switch (rhs.storage_kind()) {
                        case json_storage_kind::json_const_pointer:
                            return (cast<json_const_pointer_storage>().value())->compare(
                                    *(rhs.cast<json_const_pointer_storage>().value()));
                        default:
                        ...
                        case json_storage_kind::uint64_value:
                            if (cast<int64_storage>().value() < 0)
                                ...
                                return static_cast<uint64_t>(cast<int64_storage>().value()) <
                                       rhs.cast<uint64_storage>().value() ? -1 : 1;
                        case json_storage_kind::double_value: {
                        ...
                        case json_storage_kind::int64_value:
                            if (rhs.cast<int64_storage>().value() < 0)
                                ...
                                return cast<uint64_storage>().value() <
                                       static_cast<uint64_t>(rhs.cast<int64_storage>().value()) ? -1 : 1;
                        case json_storage_kind::uint64_value:
        ...
        void swap(basic_json &other) noexcept {
            ...
            switch (storage_kind()) {
                case json_storage_kind::null_value:
                    swap_a<null_storage>(other);
                    break;
                case json_storage_kind::empty_object_value :
                    swap_a<empty_object_storage>(other);
                    break;
                case json_storage_kind::bool_value:
                    swap_a<bool_storage>(other);
                    break;
                case json_storage_kind::int64_value:
                    swap_a<int64_storage>(other);
                    break;
                case json_storage_kind::uint64_value:
                    swap_a<uint64_storage>(other);
                    break;
                case json_storage_kind::half_value:
                    swap_a<half_storage>(other);
                    break;
                case json_storage_kind::double_value:
                    swap_a<double_storage>(other);
                    break;
                case json_storage_kind::short_string_value:
                    swap_a<short_string_storage>(other);
                    break;
                case json_storage_kind::long_string_value:
                    swap_a<long_string_storage>(other);
                    break;
                case json_storage_kind::byte_string_value:
                    swap_a<byte_string_storage>(other);
                    break;
                case json_storage_kind::array_value:
                    swap_a<array_storage>(other);
                    break;
                case json_storage_kind::object_value:
                    swap_a<object_storage>(other);
                    break;
                case json_storage_kind::json_const_pointer:
                    swap_a<json_const_pointer_storage>(other);
                    break;
                default:
                    TURBO_UNREACHABLE();
                    break;
        ...
        static
        typename std::enable_if<traits_extension::is_sequence_of<Source, char_type>::value, basic_json>::type
        ...
        static basic_json parse(const char_type *s,
                                ...
                                std::function<bool(json_errc,
                                                   const ser_context &)> err_handler = default_json_parsing()) {
            return parse(turbo::basic_string_view<char_type>(s), options, err_handler);
        }

        static basic_json parse(const char_type *s,
                                std::function<bool(json_errc, const ser_context &)> err_handler) {
            return parse(turbo::basic_string_view<char_type>(s), basic_json_decode_options<char_type>(), err_handler);
        }
        ...
        static basic_json
        parse(std::basic_istream<char_type> &is, std::function<bool(json_errc, const ser_context &)> err_handler) {
        ...
        static basic_json parse(InputIt first, InputIt last,
            ...
            basic_json_reader<char_type, iterator_source<InputIt>> reader(
                    iterator_source<InputIt>(std::forward<InputIt>(first), std::forward<InputIt>(last)), visitor,
                    options, err_handler);
            reader.read_next();
            reader.check_done();
            if (!visitor.is_valid()) {
        ...
        static typename std::enable_if<dim == 1, basic_json>::type
        make_array(std::size_t n, const T &val, const Allocator &alloc = Allocator()) {
        ...
        template<class T,
                class = typename std::enable_if<
                        !is_proxy_of<T, basic_json>::value && !traits_extension::is_basic_json<T>::value>::type>
        ...
        basic_json(IntegerType val, semantic_tag tag,
                   typename std::enable_if<traits_extension::is_unsigned_integer<IntegerType>::value &&
                                           sizeof(IntegerType) <= sizeof(uint64_t), int>::type = 0) {
        ...
        basic_json(IntegerType val, semantic_tag, Allocator alloc = Allocator(),
                   typename std::enable_if<traits_extension::is_unsigned_integer<IntegerType>::value &&
                                           sizeof(uint64_t) < sizeof(IntegerType), int>::type = 0) {
        ...
        template<class IntegerType>
        basic_json(IntegerType val, semantic_tag tag,
                   typename std::enable_if<traits_extension::is_signed_integer<IntegerType>::value &&
                                           sizeof(IntegerType) <= sizeof(int64_t), int>::type = 0) {
        ...
        basic_json(IntegerType val, semantic_tag, Allocator alloc = Allocator(),
                   typename std::enable_if<traits_extension::is_signed_integer<IntegerType>::value &&
                                           sizeof(int64_t) < sizeof(IntegerType), int>::type = 0) {
            std::basic_string<CharT> s;
            turbo::detail::from_integer(val, s);
            if (s.length() <= short_string_storage::max_length) {
                construct<short_string_storage>(semantic_tag::bigint, s.data(), static_cast<uint8_t>(s.length()));
        ...
        basic_json(byte_string_arg_t, const Source &source,
            ...
            auto bytes = turbo::span<const uint8_t>(reinterpret_cast<const uint8_t *>(source.data()), source.size());
        ...
        template<class Container>
        typename std::enable_if<traits_extension::is_back_insertable_char_container<Container>::value>::type
        dump(Container &s,
        ...
        dump(Container &s,
             std::error_code &ec) const {
            basic_compact_json_encoder<char_type, turbo::string_sink<Container>> encoder(s);
            dump(encoder, ec);
        }
        ...
        bool is_bignum() const {
            switch (storage_kind()) {
                case json_storage_kind::short_string_value:
                case json_storage_kind::long_string_value:
                    return turbo::detail::is_base10(as_string_view().data(), as_string_view().length());
                case json_storage_kind::int64_value:
                case json_storage_kind::uint64_value:
                    return true;
                case json_storage_kind::json_const_pointer:
        ...
        void create_object_implicitly() {
            create_object_implicitly(traits_extension::is_stateless<U>());
        }
        ...
        typename std::enable_if<(!traits_extension::is_string<T>::value &&
                                ...
                                traits_extension::is_basic_byte_string<T>::value, T>::type
        as(byte_string_arg_t, semantic_tag hint) const {
            std::error_code ec;
            switch (storage_kind()) {
                case json_storage_kind::short_string_value:
                case json_storage_kind::long_string_value: {
                    switch (tag()) {
                        ...
                        case semantic_tag::base64url: {
                            value_converter<turbo::basic_string_view<char_type>, T> converter;
        ...
        IntegerType as_integer() const {
            switch (storage_kind()) {
                ...
                case json_storage_kind::long_string_value: {
                    IntegerType val;
                    auto result = turbo::detail::to_integer(as_string_view().data(), as_string_view().length(), val);
                    if (!result) {
        ...
        template<class IntegerType>
        typename std::enable_if<traits_extension::is_signed_integer<IntegerType>::value &&
                                sizeof(IntegerType) <= sizeof(int64_t), bool>::type
        is_integer() const noexcept {
            switch (storage_kind()) {
                case json_storage_kind::int64_value:
                    return (as_integer<int64_t>() >= (traits_extension::integer_limits<IntegerType>::lowest)()) &&
                           (as_integer<int64_t>() <= (traits_extension::integer_limits<IntegerType>::max)());
                case json_storage_kind::uint64_value:
                    return as_integer<uint64_t>() <=
                           static_cast<uint64_t>((traits_extension::integer_limits<IntegerType>::max)());
                case json_storage_kind::json_const_pointer:
        ...
        template<class IntegerType>
        typename std::enable_if<traits_extension::is_signed_integer<IntegerType>::value &&
                                sizeof(int64_t) < sizeof(IntegerType), bool>::type
        is_integer() const noexcept {
            switch (storage_kind()) {
                case json_storage_kind::short_string_value:
                case json_storage_kind::long_string_value: {
        ...
        is_integer() const noexcept {
            switch (storage_kind()) {
                case json_storage_kind::int64_value:
                    return as_integer<int64_t>() >= 0 && static_cast<uint64_t>(as_integer<int64_t>()) <=
                                                         (traits_extension::integer_limits<IntegerType>::max)();
                case json_storage_kind::uint64_value:
                    return as_integer<uint64_t>() <= (traits_extension::integer_limits<IntegerType>::max)();
                case json_storage_kind::json_const_pointer:
                    return cast<json_const_pointer_storage>().value()->template is_integer<IntegerType>();
                default:
                    return false;
        ...
        double as_double() const {
            switch (storage_kind()) {
                case json_storage_kind::short_string_value:
                case json_storage_kind::long_string_value: {
                    turbo::detail::chars_to to_double;
        ...
        std::basic_string<char_type, char_traits_type, SAllocator> as_string(const SAllocator &alloc) const {
            ...
            switch (storage_kind()) {
                ...
                case json_storage_kind::array_value: {
                    ...
                    {
                        basic_compact_json_encoder<char_type, turbo::string_sink<string_type2>> encoder(s);
                        dump(encoder);
                    }
                    return s;
                }
        ...
        T get_value_or(const string_view_type &key, U &&default_value) const {
            ...
            switch (storage_kind()) {
                ...
                case json_storage_kind::json_const_pointer:
                    return cast<json_const_pointer_storage>().value()->template get_value_or<T, U>(key, std::forward<U>(
                            default_value));
                default: {
                    JSONCONS_THROW(not_an_object(key.data(), key.length()));
                }
        ...
        void merge(const basic_json &source) {
            switch (storage_kind()) {
                ...
                default: {
                    JSONCONS_THROW(
                            json_runtime_error<std::domain_error>("Attempting to merge a value that is not an object"));
                }
            }
        }
        ...
        JSONCONS_DEPRECATED_MSG(
                "Instead, use basic_json(byte_string_arg_t, const Source&, semantic_tag=semantic_tag::none,const Allocator& = Allocator())")
        ...
        static basic_json
        parse(const char_type *s, std::size_t length, std::function<bool(json_errc, const ser_context &)> err_handler) {
        ...
        JSONCONS_DEPRECATED_MSG(
                "Instead, use parse(std::basic_istream<char_type>&, std::function<bool(json_errc,const ser_context&)>)")
        static basic_json parse_file(const std::basic_string<char_type, char_traits_type> &filename,
                                     std::function<bool(json_errc, const ser_context &)> err_handler) {
        ...
        JSONCONS_DEPRECATED_MSG(
                "Instead, use parse(parse(const string_view_type&, std::function<bool(json_errc,const ser_context&)>)")
        static const basic_json
        parse_string(const string_view_type &s, std::function<bool(json_errc, const ser_context &)> err_handler) {
        ...
        JSONCONS_DEPRECATED_MSG(
                "Instead, use dump(std::basic_ostream<char_type>&, const basic_json_encode_options<char_type>&, indenting)")
        void dump(std::basic_ostream<char_type> &os, const basic_json_encode_options<char_type> &options,
                  bool pprint) const {
            if (pprint) {
                basic_json_encoder<char_type> encoder(os, options);
                dump(encoder);
            ...
            switch (storage_kind()) {
                ...
                case json_storage_kind::object_value:
                    return range<const_object_iterator, const_object_iterator>(
                            const_object_iterator(object_value().begin()),
        ...
        range<const_array_iterator, const_array_iterator> array_range() const {
            switch (storage_kind()) {
                case json_storage_kind::array_value:
                    return range<const_array_iterator, const_array_iterator>(array_value().begin(),
                                                                             array_value().end());
                case json_storage_kind::json_const_pointer:
    ...
    template<class Json>
    typename std::enable_if<traits_extension::is_basic_json<Json>::value, bool>::type
    ...
    typename std::enable_if<
            traits_extension::is_basic_json<Json>::value && std::is_convertible<T, Json>::value, bool>::type
    ...
    template<class Json, class T>
    typename std::enable_if<
            is_proxy<Json>::value && std::is_convertible<T, typename Json::proxied_type>::value, bool>::type
    operator==(const Json &lhs, const T &rhs) {
        return lhs.evaluate().compare(rhs) == 0;
    }

    template<class Json, class T>
    typename std::enable_if<traits_extension::is_basic_json<Json>::value && !is_proxy<T>::value &&
                            !traits_extension::is_basic_json<T>::value &&
                            std::is_convertible<T, Json>::value, bool>::type
    ...
    template<class Json, class T>
    typename std::enable_if<
            is_proxy<Json>::value && !is_proxy<T>::value && !traits_extension::is_basic_json<T>::value &&
            std::is_convertible<T, typename Json::proxied_type>::value, bool>::type
    operator==(const T &lhs, const Json &rhs) {
...
#if !defined(JSONCONS_NO_DEPRECATED)
    JSONCONS_DEPRECATED_MSG(
            "Instead, use wojson") typedef basic_json<wchar_t, order_preserving_policy, std::allocator<wchar_t>> owjson;
    ...
    inline namespace literals {
        ...
        inline
        turbo::json operator "" _json(const char *s, std::size_t n) {
            return turbo::json::parse(turbo::json::string_view_type(s, n));
        }

        inline
        turbo::wjson operator "" _json(const wchar_t *s, std::size_t n) {
            return turbo::wjson::parse(turbo::wjson::string_view_type(s, n));
        }

        inline
        turbo::ojson operator "" _ojson(const char *s, std::size_t n) {
            return turbo::ojson::parse(turbo::ojson::string_view_type(s, n));
        }

        inline
        turbo::wojson operator "" _ojson(const wchar_t *s, std::size_t n) {
            return turbo::wojson::parse(turbo::wojson::string_view_type(s, n));
        }
...
#endif  // TURBO_JSONCONS_BASIC_JSON_H_
