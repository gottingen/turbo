...
#include "turbo/jsoncons/ubjson/ubjson_encoder.h"
...
namespace ubjson {
                  ...
                  const ubjson_encode_options& options = ubjson_encode_options())
    {
        ...
        basic_ubjson_encoder<turbo::bytes_sink<Container>> encoder(v, options);
    ...
    {
        using char_type = typename T::char_type;
        basic_ubjson_encoder<turbo::bytes_sink<Container>,TempAllocator> encoder(v, options, temp_alloc);
        auto adaptor = make_json_visitor_adaptor<basic_json_visitor<char_type>>(encoder);
        j.dump(adaptor);
    }
    ...
    {
        using char_type = typename T::char_type;
        basic_ubjson_encoder<turbo::binary_stream_sink,TempAllocator> encoder(os, options, temp_alloc);
        auto adaptor = make_json_visitor_adaptor<basic_json_visitor<char_type>>(encoder);
        j.dump(adaptor);
    }
