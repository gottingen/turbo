...
#include "turbo/jsoncons/byte_string.h" // turbo::byte_traits
...
namespace turbo {
    ...
    public:
        using value_type = CharT;
        using string_view_type = turbo::basic_string_view<value_type>;
    private:
    ...
    public:
        ...
        char_result<value_type> peek() {
            return current_ != end_ ? char_result<value_type>{static_cast<value_type>(*current_), false}
    ...
    struct source_reader {
        ...
        typename std::enable_if<std::is_convertible<value_type, typename Container::value_type>::value &&
                                ...
                                traits_extension::has_data_exact<value_type *, Container>::value, std::size_t>::type
