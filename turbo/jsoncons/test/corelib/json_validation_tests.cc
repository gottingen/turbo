...
TEST_CASE("json validator tests")
{
    ...
    {
        turbo::json_string_cursor cursor(input);

        auto view = turbo::staj_array<ns::employee_AMN>(cursor);
    ...
    SECTION("employee_NMN test")
    {
        ...
        auto view = turbo::staj_array<ns::employee_NMN>(cursor);
    ...
    SECTION("employee_ACGN test")
    {
        ...
        auto view = turbo::staj_array<ns::employee_ACGN>(cursor);
    ...
    SECTION("employee_NCGN test")
    {
        ...
        auto view = turbo::staj_array<ns::employee_NCGN>(cursor);
    ...
    SECTION("employee_AGSN test")
    {
        ...
        auto view = turbo::staj_array<ns::employee_AGSN>(cursor);
    ...
    SECTION("employee_NGSN test")
    {
        ...
        auto view = turbo::staj_array<ns::employee_NGSN>(cursor);
