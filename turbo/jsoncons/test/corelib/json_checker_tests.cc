...
TEST_CASE("test_fail2")
{
    ...
    CHECK(err == turbo::json_errc::unexpected_eof);
}
...
TEST_CASE("test_fail3")
{
    ...
    CHECK(err == turbo::json_errc::expected_key);
}
...
TEST_CASE("test_fail4")
{
    ...
    CHECK(err == turbo::json_errc::extra_comma);
}
...
TEST_CASE("test_fail5")
{
    ...
    CHECK(err == turbo::json_errc::expected_value);
}
...
TEST_CASE("test_fail7")
{
    ...
    CHECK(err == turbo::json_errc::extra_character);
}
...
TEST_CASE("test_fail11")
{
    ...
    CHECK(err == turbo::json_errc::expected_comma_or_rbrace);
}
...
TEST_CASE("test_fail13")
{
    ...
    CHECK(err == turbo::json_errc::leading_zero);
}
...
TEST_CASE("test_fail14")
{
    ...
    CHECK(err == turbo::json_errc::invalid_number);
}
...
TEST_CASE("test_fail15")
{
    ...
    CHECK(err == turbo::json_errc::illegal_escaped_character);
}
...
TEST_CASE("test_fail18")
{
    ...
    CHECK(err == turbo::json_errc::max_nesting_depth_exceeded);
}
...
TEST_CASE("test_fail19")
{
    ...
    CHECK(err == turbo::json_errc::expected_colon);
}
...
TEST_CASE("test_fail22")
{
    ...
    CHECK(err == turbo::json_errc::expected_comma_or_rbracket);
}
...
TEST_CASE("test_fail23")
{
    ...
    CHECK(err == turbo::json_errc::invalid_value);
}
...
TEST_CASE("test_fail24")
{
    ...
    // Single quote
    CHECK(err == turbo::json_errc::single_quote);
}
...
TEST_CASE("test_fail25")
{
    ...
    CHECK(err == turbo::json_errc::illegal_character_in_string);
}
