...
TEST_CASE("test_is")
{
    ...
    CHECK(obj["field1"].storage_kind() == turbo::json_storage_kind::int64_value);
    CHECK(obj["field2"].storage_kind() == turbo::json_storage_kind::int64_value);
    CHECK(obj["field3"].storage_kind() == turbo::json_storage_kind::uint64_value);
...
TEST_CASE("test_is2")
{
    ...
    CHECK(obj["field1"].storage_kind() == turbo::json_storage_kind::uint64_value);
