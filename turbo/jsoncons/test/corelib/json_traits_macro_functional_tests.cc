...
namespace {
    namespace ns {
        ...
        class Person_NCGN {
            ...
            std::optional<std::string> birthDate_;
        public:
            Person_NCGN(const std::string &name, const std::optional<std::string> &socialSecurityNumber,
                        const std::optional<std::string> &birthDate = std::optional<std::string>())
            ...
            std::optional<std::string> getSocialSecurityNumber() const {
                return socialSecurityNumber_;
            }

            std::optional<std::string> getBirthDate() const {
                return birthDate_;
            }
        };
        ...
        class Person_ACGN {
            ...
            std::optional<std::string> socialSecurityNumber_;
        public:
            Person_ACGN(const std::string &name, const std::optional<std::string> &socialSecurityNumber)
        ...
        public:
            ...
            const std::optional<double> &getRating() const {
                return rating_;
            }

            void setRating(const std::optional<double> &rating) {
                rating_ = rating;
            }
        };
        ...
        public:
            Company_NCGN(const std::string &name, const std::vector<uint64_t> &employeeIds,
                         const std::optional<double> &rating = std::optional<double>())
        ...
        std::vector<uint64_t> fromEmployeesToIds(const std::vector<Employee> &employees) {
            static std::map<Employee, uint64_t> employee_id_map = {{Employee("John", "Smith"), 1},
                                                                   {Employee("Jane", "Doe"),   2}};
        ...
        std::vector<Employee> toEmployeesFromIds(const std::vector<uint64_t> &ids) {
            static std::map<uint64_t, Employee> id_employee_map = {{1, Employee("John", "Smith")},
                                                                   {2, Employee("Jane", "Doe")}};
...
JSONCONS_ALL_CTOR_GETTER_NAME_TRAITS(ns::Triangle_ACGN,
                                     (type, "type", JSONCONS_RDONLY, [](const std::string &type) noexcept {
...
JSONCONS_ALL_GETTER_SETTER_NAME_TRAITS(ns::Triangle_AGSN,
                                       (getType,, "type", JSONCONS_RDONLY, [](const std::string &type) noexcept {
                                           return type == "triangle";
                                       }),
                                       (getHeight, setHeight, "height"),
                                       (getWidth, setWidth, "width")
...
JSONCONS_N_GETTER_SETTER_NAME_TRAITS(ns::Circle_NGSN, 2,
                                     (getType,, "type", JSONCONS_RDONLY, [](const std::string &type) {
                                         return type == "circle";
                                     }),
                                     (getRadius, setRadius, "radius")
)
...
JSONCONS_ALL_MEMBER_NAME_TRAITS(ns::Triangle_AMN,
                                (type_, "type", JSONCONS_RDONLY, [](const std::string &type) noexcept {
                                    return type == "triangle";
                                }),
                                (height_, "height"),
                                (width_, "width")
...
JSONCONS_N_MEMBER_NAME_TRAITS(ns::Company_NMN, 2,
                              (name_, "company"),
                              (employeeIds_, "resources", JSONCONS_RDWR, turbo::always_true(),
...
JSONCONS_N_GETTER_SETTER_NAME_TRAITS(ns::Company_NGSN, 2,
                                     ...
                                     (getIds, setIds, "resources", JSONCONS_RDWR, turbo::always_true(),
...
JSONCONS_N_CTOR_GETTER_NAME_TRAITS(ns::Company_NCGN, 2,
                                   (getName, "company"),
                                   (getIds, "resources", JSONCONS_RDWR, turbo::always_true(),
...
JSONCONS_N_CTOR_GETTER_NAME_TRAITS(ns::Person_NCGN, 2,
                                   ...
                                   (getSocialSecurityNumber, "social_security_number",
                                           JSONCONS_RDWR, turbo::always_true{},
                                           turbo::identity(),
                                           [](const std::optional<std::string> &unvalidated) {
                                               ...
                                               return std::optional<std::string>(unvalidated);
                                           }
                                   ),
...
TEST_CASE("JSONCONS_N_CTOR_GETTER_NAME_TRAITS transform tests")
{
    SECTION("test 1")
    {
        std::vector<ns::Employee_NCGN> employees = {ns::Employee_NCGN("John", "Smith"),
                                                    ns::Employee_NCGN("Jane", "Doe")};
...
TEST_CASE("JSONCONS_N_CTOR_GETTER_NAME_TRAITS validation tests")
{
    SECTION("test 1")
    {
        std::vector<ns::Person_NCGN> persons = {ns::Person_NCGN("John Smith", "123456789"),
                                                ns::Person_NCGN("Jane Doe", "234567890")};
...
TEST_CASE("JSONCONS_ALL_CTOR_GETTER_NAME_TRAITS validation tests")
{
    SECTION("success")
    {
        std::vector<ns::Person_ACGN> persons = {ns::Person_ACGN("John Smith", "123456789"),
                                                ns::Person_ACGN("Jane Doe", "123456789")};
    ...
    {
        std::vector<ns::Person_ACGN> persons1 = {ns::Person_ACGN("John Smith", "123456789"),
                                                 ns::Person_ACGN("Jane Doe", "12345678")};
