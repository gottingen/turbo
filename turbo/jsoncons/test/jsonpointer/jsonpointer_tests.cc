...
TEST_CASE("to_uri_fragment test")
{
    SECTION("empty")
    {
        std::error_code ec;
        ...
        REQUIRE_FALSE(ec);
        std::string fragment = pointer.to_uri_fragment();
        CHECK(fragment == "#");
        pointer = jsonpointer::json_pointer::parse(fragment, ec);
        REQUIRE_FALSE(ec);
    ...
    {
        std::error_code ec;
        std::string location = "/foo/0";
        jsonpointer::json_pointer pointer = jsonpointer::json_pointer::parse(location, ec);
        REQUIRE_FALSE(ec);
        std::string fragment = pointer.to_uri_fragment();
        CHECK(fragment == "#/foo/0");
        pointer = jsonpointer::json_pointer::parse(fragment, ec);
        REQUIRE_FALSE(ec);
        CHECK(pointer.to_string() == location);
    }
    ...
    {
        std::error_code ec;
        std::string location = "/c%d";
        jsonpointer::json_pointer pointer = jsonpointer::json_pointer::parse(location, ec);
        REQUIRE_FALSE(ec);
        std::string fragment = pointer.to_uri_fragment();
        CHECK(fragment == "#/c%25d");
        pointer = jsonpointer::json_pointer::parse(fragment, ec);
        REQUIRE_FALSE(ec);
        CHECK(pointer.to_string() == location);
    }
    ...
    {
        std::error_code ec;
        std::string location = "/e^f";
        jsonpointer::json_pointer pointer = jsonpointer::json_pointer::parse(location, ec);
        REQUIRE_FALSE(ec);
        std::string fragment = pointer.to_uri_fragment();
        CHECK(fragment == "#/e%5Ef");
        pointer = jsonpointer::json_pointer::parse(fragment, ec);
        REQUIRE_FALSE(ec);
        CHECK(pointer.to_string() == location);
    }
    ...
    {
        std::error_code ec;
        std::string location = "/g|h";
        jsonpointer::json_pointer pointer = jsonpointer::json_pointer::parse(location, ec);
        REQUIRE_FALSE(ec);
        std::string fragment = pointer.to_uri_fragment();
        CHECK(fragment == "#/g%7Ch");
        pointer = jsonpointer::json_pointer::parse(fragment, ec);
        REQUIRE_FALSE(ec);
        CHECK(pointer.to_string() == location);
    }
    ...
    {
        std::error_code ec;
        std::string location = "/i\\j";
        jsonpointer::json_pointer pointer = jsonpointer::json_pointer::parse(location, ec);
        REQUIRE_FALSE(ec);
        std::string fragment = pointer.to_uri_fragment();
        CHECK(fragment == "#/i%5Cj");
        pointer = jsonpointer::json_pointer::parse(fragment, ec);
        REQUIRE_FALSE(ec);
        CHECK(pointer.to_string() == location);
    }
    ...
    {
        std::error_code ec;
        std::string location = "/k\"l";
        jsonpointer::json_pointer pointer = jsonpointer::json_pointer::parse(location, ec);
        REQUIRE_FALSE(ec);
        std::string fragment = pointer.to_uri_fragment();
        CHECK(fragment == "#/k%22l");
        pointer = jsonpointer::json_pointer::parse(fragment, ec);
        REQUIRE_FALSE(ec);
        CHECK(pointer.to_string() == location);
    }
