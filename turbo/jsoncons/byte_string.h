...
#ifndef TURBO_JSONCONS_BYTE_STRING_H_
#define TURBO_JSONCONS_BYTE_STRING_H_
...
namespace detail {
    ...
    decode_base64url(InputIt first, InputIt last, Container& result)
    {
        ...
        auto retval = turbo::detail::decode_base64_generic(first, last, reverse_alphabet,
...
#endif  // TURBO_JSONCONS_BYTE_STRING_H_
