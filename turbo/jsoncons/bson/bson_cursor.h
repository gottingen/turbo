...
#ifndef TURBO_JSONCONS_BSON_BSON_CURSOR_H_
#define TURBO_JSONCONS_BSON_BSON_CURSOR_H_
...
namespace turbo::bson {
    ...
    using bson_stream_cursor = basic_bson_cursor<turbo::binary_stream_source>;
    using bson_bytes_cursor = basic_bson_cursor<turbo::bytes_source>;

} // namespace turbo::bson

#endif  // TURBO_JSONCONS_BSON_BSON_CURSOR_H_
