...
namespace csv {
    ...
    encode_csv(const T& j, Container& s, const basic_csv_encode_options<typename Container::value_type>& options = basic_csv_encode_options<typename Container::value_type>())
    {
        ...
        basic_csv_encoder<char_type,turbo::string_sink<std::basic_string<char_type>>> encoder(s,options);
        j.dump(encoder);
    }
    ...
    encode_csv(const T& j, std::basic_ostream<CharT>& os, const basic_csv_encode_options<CharT>& options = basic_csv_encode_options<CharT>())
    {
        ...
        basic_csv_encoder<char_type,turbo::stream_sink<char_type>> encoder(os,options);
        j.dump(encoder);
    }
    ...
    {
        using char_type = typename Container::value_type;
        basic_csv_encoder<char_type,turbo::string_sink<std::basic_string<char_type>>,TempAllocator> encoder(s, options, temp_alloc);
        j.dump(encoder);
    }
    ...
    {
        using char_type = CharT;
        basic_csv_encoder<char_type,turbo::stream_sink<char_type>,TempAllocator> encoder(os, options, temp_alloc);
        j.dump(encoder);
    }
