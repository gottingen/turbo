...
#ifndef TURBO_JSONCONS_CSV_CSV_CURSOR_H_
#define TURBO_JSONCONS_CSV_CSV_CURSOR_H_
...
namespace turbo::csv {
    ...
    using csv_stream_cursor = basic_csv_cursor<char, turbo::stream_source<char>>;
    using csv_string_cursor = basic_csv_cursor<char, turbo::string_source<char>>;
    using wcsv_stream_cursor = basic_csv_cursor<wchar_t, turbo::stream_source<wchar_t>>;
    using wcsv_string_cursor = basic_csv_cursor<wchar_t, turbo::string_source<wchar_t>>;
...
#endif  // TURBO_JSONCONS_CSV_CSV_CURSOR_H_
