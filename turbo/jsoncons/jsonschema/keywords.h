...
#include <regex>
#endif
#include "turbo/jsoncons/jsonschema/compilation_context.h"
...
namespace jsonschema {
    ...
    public:
        ...
        static std::unique_ptr<content_encoding_validator> compile(const Json& schema, const compilation_context& context)
        {
            ...
            return std::make_unique<content_encoding_validator<Json>>(schema_path, value);
        }
    ...
    private:
                         ...
                         Json&) const override
        {
            ...
            {
                auto s = instance.template as<turbo::string_view>();
                std::string content;
                auto retval = turbo::decode_base64(s.begin(), s.end(), content);
                if (retval.ec != turbo::conv_errc::success)
                {
    ...
    public:
        ...
        static std::unique_ptr<content_media_type_validator> compile(const Json& schema, const compilation_context& context)
        {
            ...
            auto value = schema.template as<std::string>();
            return std::make_unique<content_media_type_validator<Json>>(schema_path, value);
        }
    ...
    public:
        ...
        static std::unique_ptr<format_validator> compile(const Json& schema, const compilation_context& context)
        {
            ...
            return std::make_unique<format_validator<Json>>(schema_path,
                format_check);
        }
    ...
    public:
        ...
        static std::unique_ptr<pattern_validator> compile(const Json& schema, const compilation_context& context)
        {
            ...
            return std::make_unique<pattern_validator<Json>>(schema_path,
    ...
    public:
        ...
        static std::unique_ptr<max_length_validator> compile(const Json& schema, const compilation_context& context)
        {
            ...
            return std::make_unique<max_length_validator<Json>>(schema_path, value);
        }
    ...
    public:
        ...
        static std::unique_ptr<max_items_validator> compile(const Json& schema, const compilation_context& context)
        {
            ...
            auto value = schema.template as<std::size_t>();
            return std::make_unique<max_items_validator<Json>>(schema_path, value);
        }
    ...
    public:
        ...
        static std::unique_ptr<min_items_validator> compile(const Json& schema, const compilation_context& context)
        {
            ...
            auto value = schema.template as<std::size_t>();
            return std::make_unique<min_items_validator<Json>>(schema_path, value);
        }
    ...
    public:
            ...
            subschema_validator_factory<Json>* builder)
        {
            ...
            return std::make_unique<items_array_validator<Json>>(schema_path,
    ...
    public:
            ...
            subschema_validator_factory<Json>* builder)
        {
            ...
            return std::make_unique<contains_validator<Json>>(schema_path,
    ...
    public:
            ...
            subschema_validator_factory<Json>* builder)
        {
            ...
            return std::make_unique<items_object_validator<Json>>(schema_path,
    ...
    public:
        ...
        static std::unique_ptr<unique_items_validator> compile(const Json& schema, const compilation_context& context)
        {
            ...
            return std::make_unique<unique_items_validator<Json>>(schema_path, are_unique);
        }
    ...
    public:
        ...
        static std::unique_ptr<min_length_validator> compile(const Json& schema, const compilation_context& context)
        {
            ...
            auto value = schema.template as<std::size_t>();
            return std::make_unique<min_length_validator<Json>>(schema_path, value);
        }
    ...
    public:
            ...
            const compilation_context& context)
        {
            ...
            return std::make_unique<string_validator<Json>>(schema_path, std::move(validators));
        }
    ...
    public:
            ...
            const Json& schema, const compilation_context& context)
        {
            ...
            return std::make_unique<not_validator<Json>>(schema_path,
    ...
    public:
        ...
        static std::unique_ptr<maximum_validator> compile(const Json& schema, const compilation_context& context)
        {
            ...
            return std::make_unique<maximum_validator<Json,T>>(schema_path, value);
        }
    ...
    public:
        ...
        static std::unique_ptr<exclusive_maximum_validator> compile(const Json& schema, const compilation_context& context)
        {
            ...
            auto value = schema.template as<T>();
            return std::make_unique<exclusive_maximum_validator<Json,T>>(schema_path, value);
        }
    ...
    public:
        ...
        static std::unique_ptr<minimum_validator> compile(const Json& schema, const compilation_context& context)
        {
            ...
            auto value = schema.template as<T>();
            return std::make_unique<minimum_validator<Json,T>>(schema_path, value);
        }
    ...
    public:
        ...
        static std::unique_ptr<exclusive_minimum_validator> compile(const Json& schema, const compilation_context& context)
        {
            ...
            auto value = schema.template as<T>();
            return std::make_unique<exclusive_minimum_validator<Json,T>>(schema_path, value);
        }
    ...
    public:
        ...
        static std::unique_ptr<multiple_of_validator> compile(const Json& schema, const compilation_context& context)
        {
            ...
            auto value = schema.template as<T>();
            return std::make_unique<multiple_of_validator<Json,T>>(schema_path, value);
        }
    ...
    public:
            ...
            const compilation_context& context, std::set<std::string>& keywords)
        {
            ...
            return std::make_unique<integer_validator<Json>>(schema_path, std::move(validators));
        }
    ...
    public:
            ...
            const compilation_context& context, std::set<std::string>& keywords)
        {
            ...
            return std::make_unique<number_validator<Json>>(schema_path, std::move(validators));
        }
    ...
    public:
        ...
        static std::unique_ptr<null_validator> compile(const compilation_context& context)
        {
            ...
            return std::make_unique<null_validator<Json>>(schema_path);
        }
    private:
        void do_validate(const Json& instance, 
                         const jsonpointer::json_pointer& instance_location, 
    ...
    public:
        ...
        static std::unique_ptr<boolean_validator> compile(const compilation_context& context)
        {
            ...
            return std::make_unique<boolean_validator<Json>>(schema_path);
        }
    private:
        void do_validate(const Json&, 
                         const jsonpointer::json_pointer&, 
    ...
    public:
        ...
        static std::unique_ptr<true_validator> compile(const compilation_context& context)
        {
            ...
            return std::make_unique<true_validator<Json>>(schema_path);
        }
    private:
        void do_validate(const Json&, 
                         const jsonpointer::json_pointer&, 
    ...
    public:
        ...
        static std::unique_ptr<false_validator> compile(const compilation_context& context)
        {
            ...
            return std::make_unique<false_validator<Json>>(schema_path);
        }
    private:
        void do_validate(const Json&, 
                         const jsonpointer::json_pointer& instance_location, 
    ...
    public:
            ...
            const std::vector<std::string>& items)
        {
            ...
            return std::make_unique<required_validator<Json>>(schema_path, items);
        }
    ...
    class object_validator : public keyword_validator<Json>
    {
        ...
        std::optional<std::size_t> max_properties_;
        std::string absolute_max_properties_location_;
        std::optional<std::size_t> min_properties_;
        std::string absolute_min_properties_location_;
        std::optional<required_validator<Json>> required_;
    ...
    public:
            ...
            const compilation_context& context, subschema_validator_factory<Json>* builder)
        {
            ...
            return std::make_unique<array_validator<Json>>(schema_path, std::move(validators));
        }
    ...
    class type_validator : public keyword_validator<Json>
    {
        ...
        std::optional<enum_validator<Json>> enum_validator_;
        std::optional<const_keyword<Json>> const_validator_;
        std::vector<validator_type> combined_validators_;
        std::optional<conditional_validator<Json>> conditional_validator_;
    ...
    public:
        ...
        type_validator(subschema_validator_factory<Json>* builder,
                     const Json& schema,
                     const compilation_context& context)
            : keyword_validator<Json>(context.get_schema_path()), default_value_(turbo::null_type()),
              ...
              enum_validator_(), const_validator_()
        {
            ...
            if (it != schema.object_range().end()) 
            {
                combined_validators_.emplace_back(std::make_unique<combining_validator<Json,all_of_criterion<Json>>>(builder, it->value(), context));
            }

            it = schema.find("anyOf");
            if (it != schema.object_range().end()) 
            {
                combined_validators_.emplace_back(std::make_unique<combining_validator<Json,any_of_criterion<Json>>>(builder, it->value(), context));
            }

            it = schema.find("oneOf");
            if (it != schema.object_range().end()) 
            {
                combined_validators_.emplace_back(std::make_unique<combining_validator<Json,one_of_criterion<Json>>>(builder, it->value(), context));
            }
    ...
    private:
        ...
        std::optional<Json> get_default_value(const jsonpointer::json_pointer&,
                                                   const Json&,
                                     ...
                                     std::set<std::string>& keywords)
        {
            ...
            {
                type_mapping_[(uint8_t)json_type::object_value] = std::make_unique<object_validator<Json>>(builder, schema, context);
            }
            else if (type == "array")
            {
