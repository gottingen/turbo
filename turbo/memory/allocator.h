...
#ifndef TURBO_MEMORY_ALLOCATOR_H_
#define TURBO_MEMORY_ALLOCATOR_H_
...
///////////////////////////////////////////////////////////////////////////////
    ...
    void tracked_allocator::free(const allocation &allocation) {
        {
            ...
            TURBO_CHECK(usageStats.count > 0)<<"tracked_allocator detected abnormal free()";
            TURBO_CHECK(usageStats.bytes >= allocation.request.size)<<"tracked_allocator detected abnormal free()";
            --usageStats.count;
    ...
    // stl_allocator exposes an STL-compatible allocator wrapping a turbo::allocator.
    template<typename T>
    struct stl_allocator {
        using value_type = T;
        using pointer = T *;
...
#endif  // TURBO_MEMORY_ALLOCATOR_H_
