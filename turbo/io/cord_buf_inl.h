...
#ifndef TURBO_IO_IOBUF_INL_H_
#define TURBO_IO_IOBUF_INL_H_
...
/////////////// cord_buf_appender /////////////////
    ...
    inline cord_buf_bytes_iterator::cord_buf_bytes_iterator(const turbo::cord_buf &buf)
    ...
    inline cord_buf_bytes_iterator::cord_buf_bytes_iterator(
        ...
        //TURBO_CHECK_LE(_bytes_left, it._bytes_left);
