...
#ifndef TURBO_IO_RAW_PACK_H_
#define TURBO_IO_RAW_PACK_H_
...
namespace turbo {
    ...
    //   turbo::raw_packer(buf).pack32(a).pack64(b).pack32(c);  // buf holds packed data
    //
    //   ... network ...
    //
    //   // positional correspondence with pack..()
    //   turbo::raw_unpacker(buf2).unpack32(a).unpack64(b).unpack32(c);
    class raw_packer {
    public:
        ...
        raw_packer &pack32(uint32_t host_value) {
            *(uint32_t *) _stream = turbo::base::turbo_hton32(host_value);
            _stream += 4;
            return *this;
        }
        ...
        raw_packer &pack64(uint64_t host_value) {
            ...
            p[0] = turbo::base::turbo_hton32(host_value >> 32);
            p[1] = turbo::base::turbo_hton32(host_value & 0xFFFFFFFF);
            _stream += 8;
            return *this;
        }
    ...
    public:
        ...
        raw_unpacker &unpack32(uint32_t &host_value) {
            host_value = turbo::base::turbo_ntoh32(*(const uint32_t *) _stream);
            _stream += 4;
            return *this;
        }
        ...
        raw_unpacker &unpack64(uint64_t &host_value) {
            ...
            host_value = (((uint64_t) turbo::base::turbo_ntoh32(p[0])) << 32) | turbo::base::turbo_ntoh32(p[1]);
            _stream += 8;
            return *this;
        }
