...
static TURBO_FORCE_INLINE const char *RemainingInput(State *state) {
...
static TURBO_FORCE_INLINE bool ParseRefQualifier(State *state) {
...
//                   ::= <decltype>
//                   ::= <substitution>
static TURBO_FORCE_INLINE bool ParseUnresolvedType(State *state) {
...
static TURBO_FORCE_INLINE bool ParseSimpleId(State *state) {
    // No ComplexityGuard because we don't copy the state in this stack frame.
