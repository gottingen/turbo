...
namespace turbo::debugging {
    ...
    // stored. (Note that the frame generated for the `turbo::debugging::get_stack_frames()`
    ...
    //        void* result[10];
    //        int sizes[10];
    //        int depth = turbo::debugging::get_stack_frames(result, sizes, 10, 1);
    //      }
    //
    ...
    // that the frame generated for the `turbo::debugging::get_stack_frames_with_context()` routine
    ...
    // stored. Note that this function is similar to `turbo::debugging::get_stack_frames()`
    ...
    //      bar() {
    //        void* result[10];
    //        int depth = turbo::debugging::get_stack_trace(result, 10, 1);
    //      }
    //
    // This produces:
    //
    ...
    // the `turbo::debugging::get_stack_frames_with_context()` routine itself is also skipped.)
    //
    // The `uc` parameter, if non-null, should be a pointer to a `ucontext_t` value
    // passed to a signal handler registered via the `sa_sigaction` field of a
    // `sigaction` struct. (See
    ...
    // arguments passed to `turbo::debugging::get_stack_frames_with_context()` except that sizes
    ...
    // *****************************************************************************
    //
    // turbo::debugging::set_stack_unwinder is not suitable for general purpose use.  It is
    // provided for custom runtimes.
    // Some things to watch out for when calling `turbo::debugging::set_stack_unwinder()`:
    //
    ...
    // case where `turbo::debugging::set_stack_unwinder()` was never called. Equivalents are:
    //
