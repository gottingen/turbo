...
// correctly when turbo::debugging::get_stack_trace() is called with max_depth == 0.
...
namespace turbo::debugging {
    ...
    TURBO_NO_INLINE TURBO_COMPILER_NO_TAIL_CALL int get_stack_frames(
            void **result, int *sizes, int max_depth, int skip_count) {
        return Unwind<true, false>(result, sizes, max_depth, skip_count, nullptr,
                                   nullptr);
    }

    TURBO_NO_INLINE TURBO_COMPILER_NO_TAIL_CALL int
    ...
    TURBO_NO_INLINE TURBO_COMPILER_NO_TAIL_CALL int get_stack_trace(
