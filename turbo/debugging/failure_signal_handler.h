...
//
// To use the failure signal handler, call `turbo::debugging::install_failure_signal_handler()`
...
namespace turbo::debugging {
    ...
    //
    // Struct for holding `turbo::debugging::install_failure_signal_handler()` configuration
    // options.
