...
#include <functional>
#include "turbo/fiber/internal/waitable_event.h"           // butex_construct/destruct
#include "turbo/base/static_atomic.h"          // std::atomic
#include "turbo/fiber/internal/types.h"           // fiber_attribute
#include "turbo/fiber/internal/stack.h"           // fiber_contextual_stack
