...
#include "turbo/fiber/internal/errno.h"                  // ESTOP
...
#include "turbo/fiber/internal/offset_inl.list"
    };
    ...
    void fiber_worker::run_main_task() {
        turbo::status_gauge<double> cumulated_cputime(
                get_cumulated_cputime_from_this, this);
        std::unique_ptr<turbo::per_second<turbo::status_gauge<double> > > usage_variable;
...
#endif
                usage_variable.reset(new turbo::per_second<turbo::status_gauge<double> >
    ...
    void fiber_worker::task_runner(intptr_t skip_remained) {
        ...
        do {
            ...
            if (FLAGS_show_fiber_creation_in_vars) {
                ...
                // considerable time because a single turbo::LatencyRecorder
