...
#ifndef TURBO_FIBER_EXECUTION_QUEUE_H_
#define TURBO_FIBER_EXECUTION_QUEUE_H_
...
namespace turbo {
    ...
    class TaskIteratorBase {
        TURBO_NON_COPYABLE(TaskIteratorBase);
    ...
    /**
     * @ingroup turbo_fiber
     * @brief TaskIterator is a iterator for tasks.
     *        Example:
     *        @code
    ...
    // been executed
    template<typename T>
    turbo::Status execution_queue_join(ExecutionQueueId<T> id);
    ...
    // fiber::execution_queue_execute(queue, task, &turbo::fiber_internal::TASK_OPTIONS_URGENT)
...
#include "turbo/fiber/execution_queue_inl.h"

#endif  // TURBO_FIBER_EXECUTION_QUEUE_H_
