...
namespace turbo {
    ...
    public:
        ...
        void wait(std::unique_lock<turbo::fiber_mutex> &lock) {
        ...
        int wait_for(std::unique_lock<turbo::fiber_mutex> &lock,
                     long timeout_us) {
        ...
        int wait_until(std::unique_lock<turbo::fiber_mutex> &lock,
                       timespec duetime) {
