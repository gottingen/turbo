...
// * turbo::file_path::u8string() returns std::string instead of std::u8string
...
// std::string as backend and for turbo::file_path::native() and char for turbo::file_path::c_str(). This
...
#if defined(__cpp_lib_char8_t) && !defined(GHC_FILESYSTEM_ENFORCE_CPP17_API)
        [[deprecated("use turbo::file_path::file_path() with std::u8string instead")]]
#endif
...
// [fs.class.directory_entry] Class directory_entry
        ...
        public:
            ...
            const turbo::file_path &file_path() const noexcept;

            operator const turbo::file_path &() const noexcept;
...
// directory_entry::directory_entry(directory_entry&&) noexcept = default;
        ...
        GHC_INLINE directory_entry::directory_entry(const turbo::file_path &p)
        ...
        GHC_INLINE directory_entry::directory_entry(const turbo::file_path &p, std::error_code &ec)
                : _path(p), _file_size(static_cast<uintmax_t>(-1))
#ifndef GHC_OS_WINDOWS
                , _hard_link_count(static_cast<uintmax_t>(-1))
#endif
...
// [fs.dir.entry.mods] directory_entry modifiers
        ...
        GHC_INLINE void directory_entry::assign(const turbo::file_path &p) {
            _path = p;
            refresh();
        }
        ...
        GHC_INLINE void directory_entry::assign(const turbo::file_path &p, std::error_code &ec) {
            _path = p;
            refresh(ec);
        }
        ...
        GHC_INLINE void directory_entry::replace_filename(const turbo::file_path &p) {
        ...
        GHC_INLINE void directory_entry::replace_filename(const turbo::file_path &p, std::error_code &ec) {
            _path.replace_filename(p);
            refresh(ec);
        }
...
// [fs.dir.entry.obs] directory_entry observers
        GHC_INLINE const turbo::file_path &directory_entry::file_path() const noexcept {
            return _path;
        }

        GHC_INLINE directory_entry::operator const turbo::file_path &() const noexcept {
            return _path;
        }
        ...
        GHC_INLINE file_type directory_entry::status_file_type() const {
            return _status.type() != file_type::none ? _status.type() : turbo::status(file_path()).type();
        }
        ...
        GHC_INLINE file_type directory_entry::status_file_type(std::error_code &ec) const noexcept {
            ...
            return turbo::status(file_path(), ec).type();
        }
        ...
        GHC_INLINE bool directory_entry::is_symlink() const {
            return _symlink_status.type() != file_type::none ? _symlink_status.type() == file_type::symlink
                                                             : turbo::is_symlink(symlink_status());
        }
        ...
        GHC_INLINE uintmax_t directory_entry::file_size() const {
            ...
            return turbo::file_size(file_path());
        }
...
#endif
            return turbo::hard_link_count(file_path());
        }
...
#endif
            return turbo::hard_link_count(file_path(), ec);
        }
        ...
        GHC_INLINE file_time_type directory_entry::last_write_time() const {
            ...
            return turbo::last_write_time(file_path());
        }
        ...
        GHC_INLINE file_time_type directory_entry::last_write_time(std::error_code &ec) const noexcept {
            ...
            return turbo::last_write_time(file_path(), ec);
        }
        ...
        GHC_INLINE file_status directory_entry::status(std::error_code &ec) const noexcept {
            ...
            return turbo::status(file_path(), ec);
        }
        ...
        GHC_INLINE file_status directory_entry::symlink_status() const {
            ...
            return turbo::symlink_status(file_path());
        }
        ...
        GHC_INLINE file_status directory_entry::symlink_status(std::error_code &ec) const noexcept {
            ...
            return turbo::symlink_status(file_path(), ec);
        }
