...
class TURBO_LOCKABLE Mutex {
 public:
  ...
  bool TryLock() TURBO_EXCLUSIVE_TRYLOCK_FUNCTION(true);
  ...
  bool ReaderTryLock() TURBO_SHARED_TRYLOCK_FUNCTION(true);
  ...
  bool WriterTryLock() TURBO_EXCLUSIVE_TRYLOCK_FUNCTION(true) {
    return this->TryLock();
  }
...
class Condition {
 public:
  ...
  // `object->Method()`.
  //
  // Implementation Note: `turbo::internal::identity` is used to allow methods to
  // come from base classes. A simpler signature like
  // `Condition(T*, bool (T::*)())` does not suffice.
  template<typename T>
  Condition(T *object, bool (turbo::internal::identity<T>::type::* method)());

  // Same as above, for const members
  template<typename T>
  Condition(const T *object,
            bool (turbo::internal::identity<T>::type::* method)() const);
...
inline Condition::Condition(T *object,
                            bool (turbo::internal::identity<T>::type::*method)())
