...
#ifndef TURBO_VARIABLE_COLLECTOR_H_
#define TURBO_VARIABLE_COLLECTOR_H_
...
#define VARIABLE_COLLECTOR_SPEED_LIMIT_INITIALIZER                          \
    { ::turbo::COLLECTOR_SAMPLING_BASE, false, TURBO_STATIC_ATOMIC_INIT(0), 0 }
...
// For processing samples in batch before dumping.
    ...
    public:
        ...
        // submit() is implemented as writing a value to turbo::variable_reducer which does
    ...
    private:
        turbo::status_gauge<double> _var;
    };

}  // namespace turbo

#endif  // TURBO_VARIABLE_COLLECTOR_H_
