...
namespace turbo {
    ...
    namespace metrics_detail {
        ...
        void write_tail(cord_buf_builder *out, const cache_metrics &metrics, const turbo::time_point *tp) {
            if (tp) {
        ...
        void serialize_counter(cord_buf_builder *out, const cache_metrics &metric, const turbo::time_point *tp) {
