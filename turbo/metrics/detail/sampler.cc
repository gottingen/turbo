...
namespace turbo {
    namespace metrics_detail {
        ...
        class sampler_collector : public turbo::variable_reducer<variable_sampler *, CombineSampler> {
        public:
            sampler_collector()
        ...
        static turbo::per_second<turbo::status_gauge<double> >* s_sampling_thread_usage_variable = nullptr;
#endif
        ...
        void sampler_collector::run() {
            ...
            if (s_sampling_thread_usage_variable == nullptr) {
                s_sampling_thread_usage_variable =
                    new turbo::per_second<turbo::status_gauge<double> >(
