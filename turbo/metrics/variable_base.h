...
#ifndef  TURBO_VARIABLE_VARIABLE_BASE_H_
#define  TURBO_VARIABLE_VARIABLE_BASE_H_
...
namespace std {
    ...
    inline ostream &operator<<(ostream &os, const ::turbo::variable_base &var) {
...
#endif  // TURBO_VARIABLE_VARIABLE_BASE_H_
