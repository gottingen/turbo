...
#define CHECK(condition) TURBO_CHECK_IMPL((condition), #condition)
...
// input.
#define QCHECK(condition) TURBO_QCHECK_IMPL((condition), #condition)
...
#define PCHECK(condition) TURBO_PCHECK_IMPL((condition), #condition)
...
#define DCHECK(condition) TURBO_DCHECK_IMPL((condition), #condition)
...
#define CHECK_EQ(val1, val2) TURBO_CHECK_EQ_IMPL((val1), #val1, (val2), #val2)
#define CHECK_NE(val1, val2) TURBO_CHECK_NE_IMPL((val1), #val1, (val2), #val2)
#define CHECK_LE(val1, val2) TURBO_CHECK_LE_IMPL((val1), #val1, (val2), #val2)
#define CHECK_LT(val1, val2) TURBO_CHECK_LT_IMPL((val1), #val1, (val2), #val2)
#define CHECK_GE(val1, val2) TURBO_CHECK_GE_IMPL((val1), #val1, (val2), #val2)
#define CHECK_GT(val1, val2) TURBO_CHECK_GT_IMPL((val1), #val1, (val2), #val2)
#define QCHECK_EQ(val1, val2) TURBO_QCHECK_EQ_IMPL((val1), #val1, (val2), #val2)
#define QCHECK_NE(val1, val2) TURBO_QCHECK_NE_IMPL((val1), #val1, (val2), #val2)
#define QCHECK_LE(val1, val2) TURBO_QCHECK_LE_IMPL((val1), #val1, (val2), #val2)
#define QCHECK_LT(val1, val2) TURBO_QCHECK_LT_IMPL((val1), #val1, (val2), #val2)
#define QCHECK_GE(val1, val2) TURBO_QCHECK_GE_IMPL((val1), #val1, (val2), #val2)
#define QCHECK_GT(val1, val2) TURBO_QCHECK_GT_IMPL((val1), #val1, (val2), #val2)
#define DCHECK_EQ(val1, val2) TURBO_DCHECK_EQ_IMPL((val1), #val1, (val2), #val2)
#define DCHECK_NE(val1, val2) TURBO_DCHECK_NE_IMPL((val1), #val1, (val2), #val2)
#define DCHECK_LE(val1, val2) TURBO_DCHECK_LE_IMPL((val1), #val1, (val2), #val2)
#define DCHECK_LT(val1, val2) TURBO_DCHECK_LT_IMPL((val1), #val1, (val2), #val2)
#define DCHECK_GE(val1, val2) TURBO_DCHECK_GE_IMPL((val1), #val1, (val2), #val2)
#define DCHECK_GT(val1, val2) TURBO_DCHECK_GT_IMPL((val1), #val1, (val2), #val2)

// `CHECK_OK` and friends validate that the provided `turbo::Status` or
// `turbo::ResultStatus<T>` is OK.  If it isn't, they print a failure message that
...
#define CHECK_OK(status) TURBO_CHECK_OK_IMPL((status), #status)
#define QCHECK_OK(status) TURBO_QCHECK_OK_IMPL((status), #status)
#define DCHECK_OK(status) TURBO_DCHECK_OK_IMPL((status), #status)
...
#define CHECK_STREQ(s1, s2) TURBO_CHECK_STREQ_IMPL((s1), #s1, (s2), #s2)
#define CHECK_STRNE(s1, s2) TURBO_CHECK_STRNE_IMPL((s1), #s1, (s2), #s2)
#define CHECK_STRCASEEQ(s1, s2) TURBO_CHECK_STRCASEEQ_IMPL((s1), #s1, (s2), #s2)
#define CHECK_STRCASENE(s1, s2) TURBO_CHECK_STRCASENE_IMPL((s1), #s1, (s2), #s2)
#define QCHECK_STREQ(s1, s2) TURBO_QCHECK_STREQ_IMPL((s1), #s1, (s2), #s2)
#define QCHECK_STRNE(s1, s2) TURBO_QCHECK_STRNE_IMPL((s1), #s1, (s2), #s2)
...
#define DCHECK_STREQ(s1, s2) TURBO_DCHECK_STREQ_IMPL((s1), #s1, (s2), #s2)
#define DCHECK_STRNE(s1, s2) TURBO_DCHECK_STRNE_IMPL((s1), #s1, (s2), #s2)
