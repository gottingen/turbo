...
#define CHECK(condition) TURBO_LOG_INTERNAL_CHECK_IMPL((condition), #condition)
...
// input.
#define QCHECK(condition) TURBO_LOG_INTERNAL_QCHECK_IMPL((condition), #condition)
...
#define PCHECK(condition) TURBO_LOG_INTERNAL_PCHECK_IMPL((condition), #condition)
...
#define DCHECK(condition) TURBO_LOG_INTERNAL_DCHECK_IMPL((condition), #condition)
...
#define CHECK_OK(status) TURBO_LOG_INTERNAL_CHECK_OK_IMPL((status), #status)
#define QCHECK_OK(status) TURBO_LOG_INTERNAL_QCHECK_OK_IMPL((status), #status)
#define DCHECK_OK(status) TURBO_LOG_INTERNAL_DCHECK_OK_IMPL((status), #status)
