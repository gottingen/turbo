...
// TODO(hamaji): Use signal instead of sigaction?
        ...
        void DumpSignalInfo(int signal_number, siginfo_t *siginfo) {
            ...
            for (size_t i = 0; i < TURBO_ARRAY_SIZE(kFailureSignals); ++i) {
...
// Dumps information about the stack frame to STDERR.
        void DumpStackFrameInfo(const char *prefix, void *pc) {
            ...
            // next function.
            if (turbo::debugging::symbolize(reinterpret_cast<char *>(pc) - 1,
...
// Invoke the default signal handler.
        ...
        void FailureSignalHandler(int signal_number,
            ...
            const int depth = turbo::debugging::get_stack_trace(stack, TURBO_ARRAY_SIZE(stack), 1);
# ifdef HAVE_SIGACTION
...
# endif
            ...
            // (See WARNING above.)
            //
            // AFTER this point, we do unsafe things, like using TURBO_LOG()!
    ...
    void InstallFailureSignalHandler() {
        ...
        for (size_t i = 0; i < TURBO_ARRAY_SIZE(kFailureSignals); ++i) {
            TURBO_CHECK_ERR(sigaction(kFailureSignals[i].number, &sig_action, nullptr));
        }
