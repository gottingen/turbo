...
#define ABSL_LOGGING_INTERNAL_LOG_INFO ::turbo::log_internal::NullStream()
#define ABSL_LOGGING_INTERNAL_LOG_WARNING ::turbo::log_internal::NullStream()
#define ABSL_LOGGING_INTERNAL_LOG_ERROR ::turbo::log_internal::NullStream()
#define ABSL_LOGGING_INTERNAL_LOG_FATAL ::turbo::log_internal::NullStreamFatal()
#define ABSL_LOGGING_INTERNAL_LOG_QFATAL ::turbo::log_internal::NullStreamFatal()
