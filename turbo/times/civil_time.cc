...
namespace turbo {
    ...
    namespace {
        ...
        // Since a civil time has a larger year range than turbo::time_point (64-bit years vs
        ...
        // turbo::time_point can handle.
        TURBO_FORCE_INLINE chrono_year_t
        ...
        std::string FormatYearAnd(std::string_view fmt, chrono_second cs) {
            ...
            // TODO(turbo-team): Avoid conversion of fmt std::string.
        ...
        bool ParseYearAnd(std::string_view fmt, std::string_view s, CivilT *c) {
            // Civil times support a larger year range than turbo::time_point, so we need to
