...
namespace turbo::times_internal {
    namespace {
        ...
        std::unique_ptr<turbo::times_internal::zone_info_source> default_factory(
...
#pragma comment( \
    linker,      \
    "/alternatename:?zone_info_source_factory@times_internal@turbo@@3P6A?AV?$unique_ptr@VZoneInfoSource@times_internal@turbo@@U?$default_delete@VZoneInfoSource@times_internal@turbo@@@std@@@std@@ABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@5@ABV?$function@$$A6A?AV?$unique_ptr@VZoneInfoSource@times_internal@turbo@@U?$default_delete@VZoneInfoSource@times_internal@turbo@@@std@@@std@@ABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@@Z@5@@ZA=?default_factory@times_internal@turbo@@3P6A?AV?$unique_ptr@VZoneInfoSource@times_internal@turbo@@U?$default_delete@VZoneInfoSource@times_internal@turbo@@@std@@@std@@ABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@5@ABV?$function@$$A6A?AV?$unique_ptr@VZoneInfoSource@times_internal@turbo@@U?$default_delete@VZoneInfoSource@times_internal@turbo@@@std@@@std@@ABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@@Z@5@@ZA")
#elif defined(_M_IA_64) || defined(_M_AMD64) || defined(_M_ARM64)
#pragma comment( \
    linker,      \
    "/alternatename:?zone_info_source_factory@times_internal@turbo@@3P6A?AV?$unique_ptr@VZoneInfoSource@times_internal@turbo@@U?$default_delete@VZoneInfoSource@times_internal@turbo@@@std@@@std@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@5@AEBV?$function@$$A6A?AV?$unique_ptr@VZoneInfoSource@times_internal@turbo@@U?$default_delete@VZoneInfoSource@times_internal@turbo@@@std@@@std@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@@Z@5@@ZEA=?default_factory@times_internal@turbo@@3P6A?AV?$unique_ptr@VZoneInfoSource@times_internal@turbo@@U?$default_delete@VZoneInfoSource@times_internal@turbo@@@std@@@std@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@5@AEBV?$function@$$A6A?AV?$unique_ptr@VZoneInfoSource@times_internal@turbo@@U?$default_delete@VZoneInfoSource@times_internal@turbo@@@std@@@std@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@@Z@5@@ZEA")
#else
