...
#ifndef TURBO_TIMES_INTERNAL_TIME_ZONE_INFO_H_
#define TURBO_TIMES_INTERNAL_TIME_ZONE_INFO_H_
...
#include "turbo/times/internal/time_zone_if.h"
#include "turbo/times/internal/tzfile.h"
...
// A transition to a new UTC offset.
    struct transition {
        ...
        struct by_unix_time {
            TURBO_FORCE_INLINE bool operator()(const transition &lhs, const transition &rhs) const {
...
#endif  // TURBO_TIMES_INTERNAL_TIME_ZONE_INFO_H_
