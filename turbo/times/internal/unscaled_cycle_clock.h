...
#ifndef TURBO_TIME_UNSCALEDCYCLECLOCK_H_
#define TURBO_TIME_UNSCALEDCYCLECLOCK_H_
...
namespace turbo {
    ...
    namespace times_internal {
        ...
        private:
            ...
            friend class turbo::unscaled_cycle_clock_wrapper_for_get_current_time;

            friend class turbo::unscaled_cycle_clock_wrapper_for_initialize_frequency;
        };
...
#endif  // TURBO_TIME_UNSCALEDCYCLECLOCK_H_
