 ...
 *****************************************************************/
#ifndef TURBO_TIMES_INTERNAL_TIME_ZONE_H_
#define TURBO_TIMES_INTERNAL_TIME_ZONE_H_
...
namespace turbo::times_internal {
    ...
    using sys_seconds = seconds;  // Deprecated.  Use turbo::times_internal::seconds instead.

    namespace times_detail {
        template<typename D>
        TURBO_FORCE_INLINE std::pair<time_point<seconds>, D>
        ...
        TURBO_FORCE_INLINE std::pair<time_point<seconds>, seconds>
...
// turbo::times_internal::time_zone is an opaque, small, value-type class representing a
...
//
// Example:
//   turbo::times_internal::time_zone utc = turbo::times_internal::utc_time_zone();
//   turbo::times_internal::time_zone pst = turbo::times_internal::fixed_time_zone(std::chrono::hours(-8));
//   turbo::times_internal::time_zone loc = turbo::times_internal::local_time_zone();
//   turbo::times_internal::time_zone lax;
//   if (!turbo::times_internal::load_time_zone("America/Los_Angeles", &lax)) { ... }
//
// See also:
...
// - https://en.wikipedia.org/wiki/Zoneinfo
    ...
    public:
        ...
        // An absolute_lookup represents the civil time (turbo::times_internal::civil_second) within
        ...
        //   const turbo::times_internal::time_zone::absolute_lookup al = tz.lookup(tp);
        struct absolute_lookup {
            ...
            // indirectly by way of turbo::times_internal::format().
        ...
        // correspond to the given civil time (turbo::times_internal::civil_second) within this
        ...
        //
        //   // A unique civil time.
        //   auto jan01 = lax.lookup(turbo::times_internal::civil_second(2011, 1, 1, 0, 0, 0));
        //   // jan01.kind == turbo::times_internal::time_zone::civil_lookup::UNIQUE
        //   // jan01.pre    is 2011/01/01 00:00:00 -0800
        //   // jan01.trans  is 2011/01/01 00:00:00 -0800
        //   // jan01.post   is 2011/01/01 00:00:00 -0800
        //
        //   // A Spring DST transition, when there is a gap in civil time.
        //   auto mar13 = lax.lookup(turbo::times_internal::civil_second(2011, 3, 13, 2, 15, 0));
        //   // mar13.kind == turbo::times_internal::time_zone::civil_lookup::SKIPPED
        //   // mar13.pre   is 2011/03/13 03:15:00 -0700
        //   // mar13.trans is 2011/03/13 03:00:00 -0700
        //   // mar13.post  is 2011/03/13 01:15:00 -0800
        //
        //   // A Fall DST transition, when civil times are repeated.
        //   auto nov06 = lax.lookup(turbo::times_internal::civil_second(2011, 11, 6, 1, 15, 0));
        //   // nov06.kind == turbo::times_internal::time_zone::civil_lookup::REPEATED
        ...
        //
        // Example:
        //   turbo::times_internal::time_zone nyc;
        //   if (!turbo::times_internal::load_time_zone("America/New_York", &nyc)) { ... }
        //   const auto now = std::chrono::system_clock::now();
        //   auto tp = turbo::times_internal::time_point<turbo::times_internal::seconds>::min();
        //   turbo::times_internal::time_zone::civil_transition trans;
    ...
    // Returns the civil time (turbo::times_internal::civil_second) within the given time zone at
    // the given absolute time (time_point). Since the additional fields provided
    // by the time_zone::absolute_lookup struct should rarely be needed in modern
    // code, this convert() function is simpler and should be preferred.
    template<typename D>
    TURBO_FORCE_INLINE civil_second
    ...
    TURBO_FORCE_INLINE time_point<seconds>
    ...
    // Formats the given time_point in the given turbo::times_internal::time_zone according to
    ...
    //   turbo::times_internal::time_zone lax;
    //   if (!turbo::times_internal::load_time_zone("America/Los_Angeles", &lax)) { ... }
    //   auto tp = turbo::times_internal::convert(turbo::times_internal::civil_second(2013, 1, 2, 3, 4, 5), lax);
    //   std::string f = turbo::times_internal::format("%H:%M:%S", tp, lax);  // "03:04:05"
    //   f = turbo::times_internal::format("%H:%M:%E3S", tp, lax);            // "03:04:05.000"
    template<typename D>
    TURBO_FORCE_INLINE std::string format(const std::string &fmt, const time_point<D> &tp,
           const time_zone &tz) {
    ...
    // options, with the same extensions as turbo::times_internal::format(), but with the
    ...
    // than normalizing them like turbo::times_internal::civil_second() would do. For example, it
    ...
    //   if (turbo::times_internal::parse("%Y-%m-%d", "2015-10-09", tz, &tp)) {
    //     ...
    //   }
    template<typename D>
    TURBO_FORCE_INLINE bool parse(const std::string &fmt, const std::string &input,
...
#endif  // TURBO_TIMES_INTERNAL_TIME_ZONE_H_
