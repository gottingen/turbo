 ...
 *****************************************************************/
#ifndef TURBO_TIMES_INTERNAL_TIME_ZONE_IF_H_
#define TURBO_TIMES_INTERNAL_TIME_ZONE_IF_H_
...
// Unix clock are second aligned, but not that they share an epoch.
    TURBO_FORCE_INLINE std::int_fast64_t to_unix_seconds(const time_point<seconds> &tp) {
        return (tp - std::chrono::time_point_cast<seconds>(
                std::chrono::system_clock::from_time_t(0)))
                .count();
    }

    TURBO_FORCE_INLINE time_point<seconds> from_unix_seconds(std::int_fast64_t t) {
...
#endif  // TURBO_TIMES_INTERNAL_TIME_ZONE_IF_H_
