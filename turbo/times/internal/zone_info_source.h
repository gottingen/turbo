...
#ifndef TURBO_TIMES_INTERNAL_ZONE_INFO_SOURCE_H_
#define TURBO_TIMES_INTERNAL_ZONE_INFO_SOURCE_H_
...
namespace turbo::times_internal {
    ...
    std::unique_ptr<turbo::times_internal::zone_info_source> (*)(
            const std::string &,
            const std::function<std::unique_ptr<
                    turbo::times_internal::zone_info_source>(const std::string &)> &);
    ...
    // turbo::times_internal::load_time_zone() with:
    //
    //   namespace {
    //   std::unique_ptr<turbo::times_internal::ZoneInfoSource> CustomFactory(
    //       const std::string& name,
    //       const std::function<std::unique_ptr<turbo::times_internal::ZoneInfoSource>(
    ...
    //   (1) from the same thread as the turbo::times_internal::load_time_zone() call,
...
#endif  // TURBO_TIMES_INTERNAL_ZONE_INFO_SOURCE_H_
