...
def normalize_paths(paths):
  ...
  # e.g. ["//turbo/strings:dir/header.h"] -> ["turbo/strings/dir/header.h"]
...
def get_spec_name(label):
  ...
  assert label.startswith("//turbo/"), "{} doesn't start with //turbo/".format(
      label)
  # e.g. //turbo/apple/banana -> abseil/apple/banana
...
def generate(args):
  """Generates a podspec file from all BUILD files under turbo directory."""
  rules = filter(relevant_rule, collect_rules("turbo"))
