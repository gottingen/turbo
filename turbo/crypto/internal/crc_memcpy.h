...
namespace turbo::crc_internal {
    ...
    public:
        ...
        virtual CRC32C Compute(void *__restrict dst, const void *__restrict src,
    ...
    class CrcMemcpy {
    public:
        static CRC32C CrcAndCopy(void *__restrict dst, const void *__restrict src,
                                   std::size_t length,
    ...
    inline CRC32C Crc32CAndCopy(void *__restrict dst, const void *__restrict src,
                                  std::size_t length,
                                CRC32C initial_crc = CRC32C{0},
                                  bool non_temporal = false) {
