...
#ifndef TURBO_THREAD_LATCH_H_
#define TURBO_THREAD_LATCH_H_
...
namespace turbo {
    ...
    public:
        ...
        bool wait_for(const turbo::duration &d) {
        ...
        bool wait_until(const turbo::time_point &deadline) {
