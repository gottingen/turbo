...
#ifndef TURBO_THREAD_AFFINITY_H_
#define TURBO_THREAD_AFFINITY_H_
...
namespace turbo {
    ...
    struct core_affinity {
        // supported is true if turbo supports controlling thread affinity for this
        // platform.
...
#endif  // TURBO_THREAD_AFFINITY_H_
