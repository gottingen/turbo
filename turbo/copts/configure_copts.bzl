...
change Abseil copts, edit turbo/copts/copts.py
"""
...
ABSL_DEFAULT_COPTS = select({
    "//turbo:msvc_compiler": ABSL_MSVC_FLAGS,
    "//turbo:clang-cl_compiler": ABSL_CLANG_CL_FLAGS,
    "//turbo:clang_compiler": ABSL_LLVM_FLAGS,
    "//turbo:gcc_compiler": ABSL_GCC_FLAGS,
    "//conditions:default": ABSL_GCC_FLAGS,
})

ABSL_TEST_COPTS = select({
    "//turbo:msvc_compiler": ABSL_MSVC_TEST_FLAGS,
    "//turbo:clang-cl_compiler": ABSL_CLANG_CL_TEST_FLAGS,
    "//turbo:clang_compiler": ABSL_LLVM_TEST_FLAGS,
    "//turbo:gcc_compiler": ABSL_GCC_TEST_FLAGS,
    "//conditions:default": ABSL_GCC_TEST_FLAGS,
})

ABSL_DEFAULT_LINKOPTS = select({
    "//turbo:msvc_compiler": ABSL_MSVC_LINKOPTS,
    "//conditions:default": [],
})
