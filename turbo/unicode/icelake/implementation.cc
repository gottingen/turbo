...
namespace {
#ifndef TURBO_UNICODE_UTF_ICELAKE_H_
#error "icelake.h must be included"
#endif
#include "icelake/icelake_utf8_common.inl.cc"
#include "icelake/icelake_macros.inl.cc"
#include "icelake/icelake_from_valid_utf8.inl.cc"
#include "icelake/icelake_utf8_validation.inl.cc"
#include "icelake/icelake_from_utf8.inl.cc"
#include "icelake/icelake_convert_utf16_to_utf32.inl.cc"
#include "icelake/icelake_convert_utf32_to_utf8.inl.cc"
#include "icelake/icelake_convert_utf32_to_utf16.inl.cc"
#include "icelake/icelake_ascii_validation.inl.cc"
#include "icelake/icelake_utf32_validation.inl.cc"
#include "icelake/icelake_convert_utf16_to_utf8.inl.cc"
      ...
      if (surrogates) {
        ...
        if ((surrogates & 0xaaaaaaaa) != 0) {
          ...
          if (!is_utf16) {
            ...
            return turbo::encoding_type::UTF16_LE;
          }
          ...
          if (length % 4 == 0) {
            ...
            if (validate_utf32(input32, end32 - input32)) {
              return turbo::encoding_type::UTF32_LE;
            }
          }
          return turbo::encoding_type::unspecified;
        }
...
TURBO_MUST_USE_RESULT size_t implementation::convert_utf8_to_utf32(const char* buf, size_t len, char32_t* utf32_out) const noexcept {
...
TURBO_MUST_USE_RESULT result implementation::convert_utf8_to_utf32_with_errors(const char* buf, size_t len, char32_t* utf32) const noexcept {
...
TURBO_MUST_USE_RESULT size_t implementation::convert_valid_utf8_to_utf32(const char* buf, size_t len, char32_t* utf32_out) const noexcept {
  uint32_t * utf32_output = reinterpret_cast<uint32_t *>(utf32_out);
