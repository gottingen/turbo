...
//
// You do not want to restrict it like so: TURBO_PROCESSOR_X86_64 && __AVX2__
...
#else
#define SIMDUTF_IMPLEMENTATION_HASWELL (TURBO_PROCESSOR_X86_64)
#endif

#endif
// To see why  (__BMI__) && (__PCLMUL__) && (__LZCNT__) are not part of this next line, see
// https://github.com/simdutf/simdutf/issues/1247
#define SIMDUTF_CAN_ALWAYS_RUN_HASWELL ((SIMDUTF_IMPLEMENTATION_HASWELL) && defined(TURBO_PROCESSOR_X86_64) && (__AVX2__))
