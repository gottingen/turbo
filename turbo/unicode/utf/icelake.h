...
#define TURBO_UNICODE_UTF_ICELAKE_H_

#include "turbo/unicode/utf/common_defs.h"

#if TURBO_HAVE_INCLUDE(<avx512vbmi2intrin.h>)
...
#define TURBO_UNICODE_IMPLEMENTATION_ICELAKE (defined(TURBO_PROCESSOR_X86_64) && (TURBO_UNICODE_COMPILER_SUPPORTS_VBMI2))
#endif

// To see why  (__BMI__) && (__PCLMUL__) && (__LZCNT__) are not part of this next line, see
// https://github.com/simdutf/simdutf/issues/1247
#define TURBO_UNICODE_CAN_ALWAYS_RUN_ICELAKE ((TURBO_UNICODE_IMPLEMENTATION_ICELAKE) && defined(TURBO_PROCESSOR_X86_64) && (__AVX2__) && (TURBO_HAVE_AVX512F && \
                                         TURBO_HAVE_AVX512DQ && \
                                         TURBO_HAVE_AVX512VL && \
...
#else
#define TURBO_UNICODE_TARGET_ICELAKE SIMDUTF_TARGET_REGION("avx512f,avx512dq,avx512cd,avx512bw,avx512vbmi,avx512vbmi2,avx512vl,avx2,bmi,bmi2,pclmul,lzcnt")
#endif
...
#endif  // TURBO_UNICODE_UTF_ICELAKE_H_
