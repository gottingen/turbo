...
struct base16: base<simd16<T>> {
  ...
  TURBO_FORCE_INLINE base16(const __m256i _value) : base<simd16<T>>(_value) {}
  template <typename Pointer>
  TURBO_FORCE_INLINE base16(const Pointer* ptr) : base16(_mm256_loadu_si256(reinterpret_cast<const __m256i*>(ptr))) {}

  TURBO_FORCE_INLINE Mask operator==(const simd16<T> other) const { return _mm256_cmpeq_epi16(*this, other); }
...
struct simd16<bool>: base16<bool> {
  static TURBO_FORCE_INLINE simd16<bool> splat(bool _value) { return _mm256_set1_epi16(uint16_t(-(!!_value))); }

  TURBO_FORCE_INLINE simd16<bool>() : base16() {}
  TURBO_FORCE_INLINE simd16<bool>(const __m256i _value) : base16<bool>(_value) {}
  // Splat constructor
...
struct base16_numeric: base16<T> {
  static TURBO_FORCE_INLINE simd16<T> splat(T _value) { return _mm256_set1_epi16(_value); }
  static TURBO_FORCE_INLINE simd16<T> zero() { return _mm256_setzero_si256(); }
  static TURBO_FORCE_INLINE simd16<T> load(const T values[8]) {
    return _mm256_loadu_si256(reinterpret_cast<const __m256i *>(values));
  }

  TURBO_FORCE_INLINE base16_numeric() : base16<T>() {}
  TURBO_FORCE_INLINE base16_numeric(const __m256i _value) : base16<T>(_value) {}

  // Store to array
  TURBO_FORCE_INLINE void store(T dst[8]) const { return _mm256_storeu_si256(reinterpret_cast<__m256i *>(dst), *this); }

  // Override to distinguish from bool version
  TURBO_FORCE_INLINE simd16<T> operator~() const { return *this ^ 0xFFFFu; }

  // Addition/subtraction are the same for signed and unsigned
  TURBO_FORCE_INLINE simd16<T> operator+(const simd16<T> other) const { return _mm256_add_epi16(*this, other); }
  TURBO_FORCE_INLINE simd16<T> operator-(const simd16<T> other) const { return _mm256_sub_epi16(*this, other); }
...
struct simd16<int16_t> : base16_numeric<int16_t> {
  ...
  TURBO_FORCE_INLINE simd16(const __m256i _value) : base16_numeric<int16_t>(_value) {}
  // Splat constructor
  ...
  TURBO_FORCE_INLINE simd16<int16_t> max_val(const simd16<int16_t> other) const { return _mm256_max_epi16(*this, other); }
  TURBO_FORCE_INLINE simd16<int16_t> min_val(const simd16<int16_t> other) const { return _mm256_min_epi16(*this, other); }
  TURBO_FORCE_INLINE simd16<bool> operator>(const simd16<int16_t> other) const { return _mm256_cmpgt_epi16(*this, other); }
  TURBO_FORCE_INLINE simd16<bool> operator<(const simd16<int16_t> other) const { return _mm256_cmpgt_epi16(other, *this); }
};
...
struct simd16<uint16_t>: base16_numeric<uint16_t>  {
  ...
  TURBO_FORCE_INLINE simd16(const __m256i _value) : base16_numeric<uint16_t>(_value) {}
  ...
  // Saturated math
  TURBO_FORCE_INLINE simd16<uint16_t> saturating_add(const simd16<uint16_t> other) const { return _mm256_adds_epu16(*this, other); }
  TURBO_FORCE_INLINE simd16<uint16_t> saturating_sub(const simd16<uint16_t> other) const { return _mm256_subs_epu16(*this, other); }

  // Order-specific operations
  TURBO_FORCE_INLINE simd16<uint16_t> max_val(const simd16<uint16_t> other) const { return _mm256_max_epu16(*this, other); }
  TURBO_FORCE_INLINE simd16<uint16_t> min_val(const simd16<uint16_t> other) const { return _mm256_min_epu16(*this, other); }
  ...
  TURBO_FORCE_INLINE bool bits_not_set_anywhere(simd16<uint16_t> bits) const { return _mm256_testz_si256(*this, bits); }
  TURBO_FORCE_INLINE bool any_bits_set_anywhere(simd16<uint16_t> bits) const { return !bits_not_set_anywhere(bits); }
  template<int N>
  TURBO_FORCE_INLINE simd16<uint16_t> shr() const { return simd16<uint16_t>(_mm256_srli_epi16(*this, N)); }
  template<int N>
  TURBO_FORCE_INLINE simd16<uint16_t> shl() const { return simd16<uint16_t>(_mm256_slli_epi16(*this, N)); }
  ...
  struct simd16x32 {
    ...
    TURBO_FORCE_INLINE simd16x32(const simd16<T> chunk0, const simd16<T> chunk1) : chunks{chunk0, chunk1} {}
    TURBO_FORCE_INLINE simd16x32(const T* ptr) : chunks{simd16<T>::load(ptr), simd16<T>::load(ptr+sizeof(simd16<T>)/sizeof(T))} {}
    ...
    TURBO_FORCE_INLINE simd16x32<T> bit_or(const T m) const {
