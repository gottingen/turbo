...
#include "turbo/unicode/tests/reference/encode_utf8.h"
#include <turbo/unicode/tests/reference/encode_utf16.h>
#include <turbo/unicode/tests/reference/encode_utf32.h>
#include <turbo/unicode/tests/reference/decode_utf16.h>
#include <turbo/unicode/tests/reference/decode_utf32.h>
#include <turbo/unicode/tests/reference/validate_utf8.h>
#include <turbo/unicode/tests/reference/validate_utf16.h>
#include <turbo/unicode/tests/reference/validate_utf32.h>
...
namespace turbo { namespace tests { namespace helpers {
  ...
  transcode_utf16_to_utf8_test_base::transcode_utf16_to_utf8_test_base(const std::vector<char16_t>& input_utf16)
    ...
    auto error_handler = [](const char16_t*, const char16_t*,  turbo::tests::reference::utf16::Error) -> bool {
  ...
  transcode_utf32_to_utf8_test_base::transcode_utf32_to_utf8_test_base(const std::vector<char32_t>& input_utf32)
    ...
    auto error_handler = [](const char32_t*, const char32_t*,  turbo::tests::reference::utf32::Error) -> bool {
