...
namespace simd {
  ...
  struct base {
    ...
    // Bit operations
    TURBO_FORCE_INLINE Child operator|(const Child other) const { return _mm_or_si128(*this, other); }
    TURBO_FORCE_INLINE Child operator&(const Child other) const { return _mm_and_si128(*this, other); }
    TURBO_FORCE_INLINE Child operator^(const Child other) const { return _mm_xor_si128(*this, other); }
    TURBO_FORCE_INLINE Child bit_andnot(const Child other) const { return _mm_andnot_si128(other, *this); }
  ...
  struct base8: base<simd8<T>> {
    ...
    TURBO_FORCE_INLINE T first() const { return _mm_extract_epi8(*this,0); }
    TURBO_FORCE_INLINE T last() const { return _mm_extract_epi8(*this,15); }
    TURBO_FORCE_INLINE base8() : base<simd8<T>>() {}
    TURBO_FORCE_INLINE base8(const __m128i _value) : base<simd8<T>>(_value) {}

    TURBO_FORCE_INLINE Mask operator==(const simd8<T> other) const { return _mm_cmpeq_epi8(*this, other); }
  ...
  struct simd8<bool>: base8<bool> {
    static TURBO_FORCE_INLINE simd8<bool> splat(bool _value) { return _mm_set1_epi8(uint8_t(-(!!_value))); }

    TURBO_FORCE_INLINE simd8<bool>() : base8() {}
    TURBO_FORCE_INLINE simd8<bool>(const __m128i _value) : base8<bool>(_value) {}
    // Splat constructor
    ...
    TURBO_FORCE_INLINE bool none() const { return _mm_testz_si128(*this, *this); }
    TURBO_FORCE_INLINE bool all() const { return _mm_movemask_epi8(*this) == 0xFFFF; }
    TURBO_FORCE_INLINE simd8<bool> operator~() const { return *this ^ true; }
  };

  template<typename T>
  struct base8_numeric: base8<T> {
    static TURBO_FORCE_INLINE simd8<T> splat(T _value) { return _mm_set1_epi8(_value); }
    static TURBO_FORCE_INLINE simd8<T> zero() { return _mm_setzero_si128(); }
    ...
    TURBO_FORCE_INLINE base8_numeric(const __m128i _value) : base8<T>(_value) {}

    // Store to array
    TURBO_FORCE_INLINE void store(T dst[16]) const { return _mm_storeu_si128(reinterpret_cast<__m128i *>(dst), *this); }

    // Override to distinguish from bool version
    TURBO_FORCE_INLINE simd8<T> operator~() const { return *this ^ 0xFFu; }

    // Addition/subtraction are the same for signed and unsigned
    TURBO_FORCE_INLINE simd8<T> operator+(const simd8<T> other) const { return _mm_add_epi8(*this, other); }
    TURBO_FORCE_INLINE simd8<T> operator-(const simd8<T> other) const { return _mm_sub_epi8(*this, other); }
  ...
  struct simd8<int8_t> : base8_numeric<int8_t> {
    ...
    TURBO_FORCE_INLINE simd8(const __m128i _value) : base8_numeric<int8_t>(_value) {}
    // Splat constructor
    ...
    TURBO_FORCE_INLINE bool is_ascii() const { return _mm_movemask_epi8(*this) == 0; }

    // Order-sensitive comparisons
    TURBO_FORCE_INLINE simd8<int8_t> max_val(const simd8<int8_t> other) const { return _mm_max_epi8(*this, other); }
    TURBO_FORCE_INLINE simd8<int8_t> min_val(const simd8<int8_t> other) const { return _mm_min_epi8(*this, other); }
    TURBO_FORCE_INLINE simd8<bool> operator>(const simd8<int8_t> other) const { return _mm_cmpgt_epi8(*this, other); }
    TURBO_FORCE_INLINE simd8<bool> operator<(const simd8<int8_t> other) const { return _mm_cmpgt_epi8(other, *this); }
  };
  ...
  struct simd8<uint8_t>: base8_numeric<uint8_t>  {
    ...
    TURBO_FORCE_INLINE simd8(const __m128i _value) : base8_numeric<uint8_t>(_value) {}
    ...
    // Saturated math
    TURBO_FORCE_INLINE simd8<uint8_t> saturating_add(const simd8<uint8_t> other) const { return _mm_adds_epu8(*this, other); }
    TURBO_FORCE_INLINE simd8<uint8_t> saturating_sub(const simd8<uint8_t> other) const { return _mm_subs_epu8(*this, other); }

    // Order-specific operations
    TURBO_FORCE_INLINE simd8<uint8_t> max_val(const simd8<uint8_t> other) const { return _mm_max_epu8(*this, other); }
    TURBO_FORCE_INLINE simd8<uint8_t> min_val(const simd8<uint8_t> other) const { return _mm_min_epu8(*this, other); }
    ...
    TURBO_FORCE_INLINE bool bits_not_set_anywhere(simd8<uint8_t> bits) const { return _mm_testz_si128(*this, bits); }
    TURBO_FORCE_INLINE bool any_bits_set_anywhere(simd8<uint8_t> bits) const { return !bits_not_set_anywhere(bits); }
    template<int N>
    TURBO_FORCE_INLINE simd8<uint8_t> shr() const { return simd8<uint8_t>(_mm_srli_epi16(*this, N)) & uint8_t(0xFFu >> N); }
    template<int N>
    TURBO_FORCE_INLINE simd8<uint8_t> shl() const { return simd8<uint8_t>(_mm_slli_epi16(*this, N)) & uint8_t(0xFFu << N); }
  ...
  struct simd8<uint16_t>: base<uint16_t> {
    static TURBO_FORCE_INLINE simd8<uint16_t> splat(uint16_t _value) { return _mm_set1_epi16(_value); }
    static TURBO_FORCE_INLINE simd8<uint16_t> load(const uint16_t values[8]) {
      return _mm_loadu_si128(reinterpret_cast<const __m128i *>(values));
    }

    TURBO_FORCE_INLINE simd8() : base<uint16_t>() {}
    TURBO_FORCE_INLINE simd8(const __m128i _value) : base<uint16_t>(_value) {}
    // Splat constructor
    TURBO_FORCE_INLINE simd8(uint16_t _value) : simd8(splat(_value)) {}
    // Array constructor
    TURBO_FORCE_INLINE simd8(const uint16_t* values) : simd8(load(values)) {}
    // Member-by-member initialization
    TURBO_FORCE_INLINE simd8(
    ...
    // Saturated math
    TURBO_FORCE_INLINE simd8<uint16_t> saturating_add(const simd8<uint16_t> other) const { return _mm_adds_epu16(*this, other); }
    TURBO_FORCE_INLINE simd8<uint16_t> saturating_sub(const simd8<uint16_t> other) const { return _mm_subs_epu16(*this, other); }

    // Order-specific operations
    TURBO_FORCE_INLINE simd8<uint16_t> max_val(const simd8<uint16_t> other) const { return _mm_max_epu16(*this, other); }
    TURBO_FORCE_INLINE simd8<uint16_t> min_val(const simd8<uint16_t> other) const { return _mm_min_epu16(*this, other); }
    // Same as >, but only guarantees true is nonzero (< guarantees true = -1)
    TURBO_FORCE_INLINE simd8<uint16_t> gt_bits(const simd8<uint16_t> other) const { return this->saturating_sub(other); }
    // Same as <, but only guarantees true is nonzero (< guarantees true = -1)
    TURBO_FORCE_INLINE simd8<uint16_t> lt_bits(const simd8<uint16_t> other) const { return other.saturating_sub(*this); }
    TURBO_FORCE_INLINE simd8<bool> operator<=(const simd8<uint16_t> other) const { return other.max_val(*this) == other; }
    TURBO_FORCE_INLINE simd8<bool> operator>=(const simd8<uint16_t> other) const { return other.min_val(*this) == other; }
    TURBO_FORCE_INLINE simd8<bool> operator==(const simd8<uint16_t> other) const { return _mm_cmpeq_epi16(*this, other); }
    TURBO_FORCE_INLINE simd8<bool> operator&(const simd8<uint16_t> other) const { return _mm_and_si128(*this, other); }
    TURBO_FORCE_INLINE simd8<bool> operator|(const simd8<uint16_t> other) const { return _mm_or_si128(*this, other); }

    // Bit-specific operations
    TURBO_FORCE_INLINE simd8<bool> bits_not_set() const { return *this == uint16_t(0); }
    TURBO_FORCE_INLINE simd8<bool> any_bits_set() const { return ~this->bits_not_set(); }

    TURBO_FORCE_INLINE bool bits_not_set_anywhere() const { return _mm_testz_si128(*this, *this); }
    TURBO_FORCE_INLINE bool any_bits_set_anywhere() const { return !bits_not_set_anywhere(); }
    TURBO_FORCE_INLINE bool bits_not_set_anywhere(simd8<uint16_t> bits) const { return _mm_testz_si128(*this, bits); }
    TURBO_FORCE_INLINE bool any_bits_set_anywhere(simd8<uint16_t> bits) const { return !bits_not_set_anywhere(bits); }
     };
  template<typename T>
  struct simd8x64 {
