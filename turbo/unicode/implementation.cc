...
#include "turbo/unicode/utf/arm64.h"
#include "turbo/unicode/utf/icelake.h"
#include "turbo/unicode/utf/haswell.h"
#include "turbo/unicode/utf/westmere.h"
#include "turbo/unicode/utf/ppc64.h"
#include "turbo/unicode/utf/fallback.h" // have it always last.
...
public:
  ...
  TURBO_MUST_USE_RESULT size_t convert_utf16be_to_utf8(const char16_t * buf, size_t len, char* utf8_output) const noexcept final {
...
const implementation * builtin_implementation() {
  static const implementation * builtin_impl = get_available_implementations()[TURBO_STRINGIFY(SIMDUTF_BUILTIN_IMPLEMENTATION)];
  return builtin_impl;
}
