...
#ifndef TURBO_CONTAINER_CACHE_RAW_CONFIG_H_
#define TURBO_CONTAINER_CACHE_RAW_CONFIG_H_
...
namespace turbo {
    ...
    public:
        ...
        void on_cache_set(const Key &key, const Value &value) override {
            ...
            TURBO_LOG(DEBUG)<<"cache set, ram_bytes_used_: " << ram_bytes_used_;
...
#endif  // TURBO_CONTAINER_CACHE_RAW_CONFIG_H_
