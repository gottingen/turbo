...
class Storage {
 public:
  ...
  using MoveAssignmentPolicy = turbo::conditional_t<
      ...
      turbo::conjunction<turbo::is_trivially_move_assignable<ValueType<A>>,
  ...
  using SwapInlinedElementsPolicy = turbo::conditional_t<
      ...
      turbo::conjunction<turbo::is_trivially_relocatable<ValueType<A>>,
                        std::is_same<A, std::allocator<ValueType<A>>>>::value,
      MemcpyPolicy,
  ...
  ~Storage() {
    ...
    // maybe not even that).
    if (turbo::is_trivially_destructible<ValueType<A>>::value &&
        std::is_same<A, std::allocator<ValueType<A>>>::value) {
      ...
      TURBO_HARDENING_ASSERT(
          ...
          (std::is_same<A, std::allocator<V>>::value &&
           (
               ...
               // Second case above
               (turbo::is_trivially_move_assignable<V>::value &&
                turbo::is_trivially_destructible<V>::value) ||
               // Third case above
               (turbo::is_trivially_copy_constructible<V>::value ||
                turbo::is_trivially_copy_assignable<V>::value))));
    }
...
void Storage<T, N, A>::InitFrom(const Storage& other) {
  ...
  if (turbo::is_trivially_copy_constructible<ValueType<A>>::value &&
      std::is_same<A, std::allocator<ValueType<A>>>::value) {
