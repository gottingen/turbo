...
struct TURBO_INTERNAL_COMPRESSED_TUPLE_DECLSPEC CompressedTupleImpl<
  ...
  explicit constexpr CompressedTupleImpl(turbo::in_place_t, Vs&&... args)
      : Storage<Ts, I>(turbo::in_place, turbo::forward<Vs>(args))... {}
...
struct TURBO_INTERNAL_COMPRESSED_TUPLE_DECLSPEC CompressedTupleImpl<
  ...
  template <typename... Vs>
  explicit constexpr CompressedTupleImpl(turbo::in_place_t, Vs&&... args)
      : Storage<Ts, I, false>(turbo::in_place, turbo::forward<Vs>(args))... {}
  friend CompressedTuple<Ts...>;
};
 ...
 public:
  ...
  explicit constexpr CompressedTuple(First&& first, Vs&&... base)
      : CompressedTuple::CompressedTupleImpl(turbo::in_place,
                                             turbo::forward<First>(first),
                                             turbo::forward<Vs>(base)...) {}
  ...
  template <int I>
  constexpr const ElemT<I>&& get() const&& {
    return turbo::move(*this).StorageT<I>::get();
  }
};
