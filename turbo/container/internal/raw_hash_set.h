...
TURBO_ATTRIBUTE_ALWAYS_INLINE inline bool ShouldInsertBackwards(
...
template <class Mask>
TURBO_ATTRIBUTE_ALWAYS_INLINE inline auto GetInsertionOffset(
...
TURBO_ATTRIBUTE_ALWAYS_INLINE inline void IterateOverFullSlots(
...
class HashSetResizeHelper {
 public:
  ...
  // in one TURBO_ATTRIBUTE_NOINLINE function in order to minimize binary code
  ...
  TURBO_ATTRIBUTE_NOINLINE bool InitializeSlots(CommonFields& c, Alloc alloc,
                                               ctrl_t soo_slot_h2,
                                               size_t key_size,
                                               size_t value_size) {
    assert(c.capacity());
...
TURBO_ATTRIBUTE_NOINLINE void DeallocateStandard(CommonFields& common,
...
class raw_hash_set {
  ...
  raw_hash_set(const raw_hash_set& that, const allocator_type& a)
    ...
    IterateOverFullSlots(
        ...
        [&](const ctrl_t* that_ctrl,
            slot_type* that_slot) TURBO_ATTRIBUTE_ALWAYS_INLINE {
          if (shift == 0) {
 ...
 private:
  ...
  inline void destroy_slots() {
    ...
    IterateOverFullSlots(
        ...
        [&](const ctrl_t*, slot_type* slot)
            TURBO_ATTRIBUTE_ALWAYS_INLINE { this->destroy(slot); });
  }
  ...
  TURBO_ATTRIBUTE_NOINLINE static void resize_impl(
