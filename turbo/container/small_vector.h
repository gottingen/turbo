...
#ifndef TURBO_CONTAINER_SMALL_VECTOR_H_
#define TURBO_CONTAINER_SMALL_VECTOR_H_
...
*/
    ...
    public:
        void push_back(const T &Elt) {
            if (TURBO_UNLIKELY(this->EndX >= this->CapacityX))
                this->grow();
...
*/
    ...
    void SmallVectorTemplateBase<T, isPodLike>::grow(size_t MinSize) {
        ...
        size_t NewCapacity = size_t(turbo::detail::NextCapacity(CurCapacity + 2));
...
*/
    ...
    public:
        ...
        */
        ...
        //explicit SmallVector(const turbo::iterator_range<RangeTy> &R)
        //    : SmallVectorImpl<T>(N) {
...
#endif  // TURBO_CONTAINER_SMALL_VECTOR_H_
