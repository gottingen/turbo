...
#ifndef TURBO_CONTAINER_PARALLEL_NODE_HASH_MAP_H_
#define TURBO_CONTAINER_PARALLEL_NODE_HASH_MAP_H_

#include "turbo/container/internal/raw_hash_set.h"

namespace turbo {
    // -----------------------------------------------------------------------------
    // turbo::parallel_node_hash_map
    // -----------------------------------------------------------------------------
    template<class Key, class Value, class Hash, class Eq, class Alloc, size_t N, class Mtx_>
    class parallel_node_hash_map
            : public turbo::priv::parallel_hash_map<
                    N, turbo::priv::raw_hash_set, Mtx_,
                    turbo::priv::node_hash_map_policy<Key, Value>, Hash, Eq,
                    Alloc> {
...
#endif  // TURBO_CONTAINER_PARALLEL_NODE_HASH_MAP_H_
