...
#ifndef TURBO_CONTAINER_ROBIN_HASH_H_
#define TURBO_CONTAINER_ROBIN_HASH_H_
...
#include <utility>
#include <vector>
#include "turbo/container/robin_growth_policy.h"
...
namespace turbo {
    ...
    namespace detail_robin_hash {
        ...
        struct is_power_of_two_policy<turbo::rh::power_of_two_growth_policy<GrowthFactor>> : std::true_type {
        };
 ...
 */
        ...
        public:
            ...
            void set_value_of_empty_bucket(distance_type dist_from_ideal_bucket,
                ...
                TURBO_CHECK(dist_from_ideal_bucket >= 0);
                TURBO_CHECK(empty());
 ...
 */
        ...
        private:
            ...
            static constexpr bool STORE_HASH = StoreHash ||
                                               (
                                                       (sizeof(turbo::detail_robin_hash::bucket_entry<value_type, true>) ==
                                                        sizeof(turbo::detail_robin_hash::bucket_entry<value_type, false>))
                                                       &&
            ...
            using bucket_entry = turbo::detail_robin_hash::bucket_entry<value_type, STORE_HASH>;
        ...
        public:
            robin_hash(size_type bucket_count,
                ...
                if (bucket_count > max_bucket_count()) {
                    TURBO_THROW_OR_TERMINATE(std::length_error, "The map exceeds its maxmimum size.");
                }
            ...
            void insert(InputIt first, InputIt last) {
                if (std::is_base_of<std::forward_iterator_tag,
                    ...
                    TURBO_CHECK(m_load_threshold >= size());
            ...
            iterator erase(const_iterator first, const_iterator last) {
                ...
                TURBO_CHECK(ito_move_closer_value > icloser_bucket);
                ...
                while (ito_move_closer_value < m_buckets.size() &&
                    ...
                    TURBO_CHECK(m_buckets[icloser_bucket].empty());
            ...
            const typename U::value_type &at(const K &key, std::size_t hash) const {
                ...
                if (it != cend()) {
                    ...
                    TURBO_THROW_OR_TERMINATE(std::out_of_range, "Couldn't find key.");
                }
            }
        ...
        private:
            ...
            std::size_t bucket_for_hash(std::size_t hash) const {
                ...
                TURBO_CHECK(bucket < m_buckets.size() || (bucket == 0 && m_buckets.empty()));
            ...
            std::size_t next_bucket(std::size_t index) const noexcept {
                TURBO_CHECK(index < bucket_count());
            ...
            const_iterator find_impl(const K &key, std::size_t hash) const {
                ...
                while (dist_from_ideal_bucket <= (m_first_or_empty_bucket + ibucket)->dist_from_ideal_bucket()) {
                    if (TURBO_LIKELY((!USE_STORED_HASH_ON_LOOKUP ||
            ...
            void erase_from_bucket(iterator pos) {
                ...
                while (m_buckets[ibucket].dist_from_ideal_bucket() > 0) {
                    TURBO_CHECK(m_buckets[previous_ibucket].empty());
...
#endif  // TURBO_CONTAINER_ROBIN_HASH_H_
