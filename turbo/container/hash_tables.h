...
#ifndef TURBO_CONTAINER_HASH_TABLES_H_
#define TURBO_CONTAINER_HASH_TABLES_H_
...
#endif  // !defined(TURBO_PLATFORM_ANDROID)
...
inline std::size_t HashInts32(uint32_t value1, uint32_t value2) {
  ...
  return static_cast<size_t>(turbo::hash::fmix64(hash64));
}
...
inline std::size_t hash_value(const std::pair<Type1, Type2>& value) {
  return turbo::container::hash_pair(value.first, value.second);
}
...
#endif  // TURBO_CONTAINER_HASH_TABLES_H_
