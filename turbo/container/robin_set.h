...
#ifndef  TURBO_CONTAINER_ROBIN_SET_H_
#define  TURBO_CONTAINER_ROBIN_SET_H_
 ...
 * By default the set uses `turbo::rh::power_of_two_growth_policy`. This policy keeps the number of buckets
 ...
 */
    ...
    /**
     * Same as `turbo::robin_set<Key, Hash, KeyEqual, Allocator, StoreHash, turbo::rh::prime_growth_policy>`.
     */
    template<class Key,
            class Hash = std::hash<Key>,
            class KeyEqual = std::equal_to<Key>,
            class Allocator = std::allocator<Key>,
            bool StoreHash = false>
    using robin_pg_set = robin_set<Key, Hash, KeyEqual, Allocator, StoreHash, turbo::rh::prime_growth_policy>;

} // end namespace turbo

#endif  // TURBO_CONTAINER_ROBIN_SET_H_
