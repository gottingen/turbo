...
#ifndef  TURBO_CONTAINER_SPARSE_SET_H_
#define TURBO_CONTAINER_SPARSE_SET_H_
 ...
 * `turbo::sh::exception_safety::strong`, the drawback is that the set will be
 ...
 private:
  ...
  using ht =
      detail_sparse_hash::sparse_hash<Key, KeySelect, void, Hash, KeyEqual,
                                      ...
                                      Sparsity, turbo::sh::probing::quadratic>;
...
/**
 * Same as `turbo::sparse_set<Key, Hash, KeyEqual, Allocator,
...
template <class Key, class Hash = std::hash<Key>,
          ...
          class Allocator = std::allocator<Key>>
using sparse_pg_set =
    sparse_set<Key, Hash, KeyEqual, Allocator, turbo::sh::prime_growth_policy>;

}  // namespace turbo

#endif  // TURBO_CONTAINER_SPARSE_SET_H_
