...
#ifndef  TURBO_CONTAINER_SPARSE_GROWTH_POLICY_H_
#define  TURBO_CONTAINER_SPARSE_GROWTH_POLICY_H_
 ...
 * turbo::sh::power_of_two_growth_policy in general but will probably distribute
...
#endif  // TURBO_CONTAINER_SPARSE_GROWTH_POLICY_H_
