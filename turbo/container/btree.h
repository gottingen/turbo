...
#ifndef TURBO_CONTAINER_BTREE_H_
#define TURBO_CONTAINER_BTREE_H_
...
#undef TURBO_COMPARE_INLINE_INIT
    ...
    namespace compare_internal {
        ...
        template<typename BoolType,
                turbo::enable_if_t<std::is_same<bool, BoolType>::value, int> = 0>
        ...
        template<
                ...
                turbo::enable_if_t<!std::is_same<bool, turbo::invoke_result_t<
        ...
        template<
                typename Compare, typename K, typename LK,
                turbo::enable_if_t<std::is_same<bool, turbo::invoke_result_t<Compare,
...
namespace turbo {
    ...
    namespace priv {
        ...
        std::is_convertible<turbo::invoke_result_t<Compare, const T &, const T &>,
                turbo::weak_ordering>;
        ...
        struct StringBtreeDefaultLess {
            ...
            StringBtreeDefaultLess(turbo::less<std::string_view>) {}  // NOLINT
        ...
        template<>
        struct key_compare_to_adapter<turbo::less<std::string>> {
            using type = StringBtreeDefaultLess;
        };
        ...
        template<>
        struct key_compare_to_adapter<turbo::less<std::string_view>> {
            using type = StringBtreeDefaultLess;
        };
        ...
        struct common_params {
            ...
            turbo::conditional_t<(kNodeValueSpace / sizeof(value_type) >
        ...
        struct map_params : common_params<Key, Compare, Alloc, TargetNodeSize, Multi,
                turbo::priv::map_slot_policy<Key, Data>> {
        ...
        struct upper_bound_adapter {
            ...
            bool operator()(const K &a, const LK &b) const {
                ...
                return !turbo::compare_internal::compare_result_as_less_than(comp(b, a));
            }
        ...
        public:
            ...
            using use_linear_search = std::integral_constant<
                    ...
                    (std::is_same<turbo::less<key_type>, key_compare>::value ||
        ...
        private:
            using layout_type = turbo::priv::Layout<btree_node *, field_type,
        ...
        public:
            ...
            void clear_child(size_type i) {
                turbo::priv::SanitizerPoisonObject(&mutable_child(i));
            }

            void set_child(size_type i, btree_node *c) {
                turbo::priv::SanitizerUnpoisonObject(&mutable_child(i));
                mutable_child(i) = c;
            ...
            static btree_node *init_leaf(btree_node *n, btree_node *parent,
                ...
                turbo::priv::SanitizerPoisonMemoryRegion(
        ...
        private:
            ...
            void value_init(const size_type i, allocator_type *alloc, Args &&... args) {
                turbo::priv::SanitizerUnpoisonObject(slot(i));
                params_type::construct(alloc, slot(i), std::forward<Args>(args)...);
            }

            void value_destroy(const size_type i, allocator_type *alloc) {
                params_type::destroy(alloc, slot(i));
                turbo::priv::SanitizerPoisonObject(slot(i));
            }
            ...
            void uninitialized_move_n(const size_type n, const size_type i,
                                      ...
                                      allocator_type *alloc) {
                turbo::priv::SanitizerUnpoisonMemoryRegion(
        ...
        public:
            ...
            btree(btree &&x) noexcept
                    : root_(std::move(x.root_)),
                      rightmost_(turbo::exchange(x.rightmost_, EmptyNode())),
                      size_(turbo::exchange(x.size_, 0)) {
        ...
        private:
            ...
            node_type *allocate(const size_type sz) {
                return reinterpret_cast<node_type *>(
                        turbo::priv::Allocate<node_type::Alignment()>(
            ...
            void deallocate(const size_type sz, node_type *node) {
                turbo::priv::Deallocate<node_type::Alignment()>(
        ...
        private:
            ...
            turbo::priv::CompressedTuple<key_compare, allocator_type,
                    node_type *>
                    root_;
        ...
        constexpr bool btree<P>::static_assert_validation() {
            ...
            turbo::invoke_result_t<key_compare, key_type, key_type>;
            static_assert(
...
#endif  // TURBO_CONTAINER_BTREE_H_
