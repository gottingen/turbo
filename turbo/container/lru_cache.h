...
#ifndef TURBO_CONTAINER_LRU_CACHE_H_
#define TURBO_CONTAINER_LRU_CACHE_H_
...
#include "turbo/container/cache/config.h"
#include "turbo/container/cache/item.h"
#include "turbo/container/cache/policy.h"
...
namespace turbo {
    ...
    private:
        ...
        void init() {
            ...
            TURBO_LOG(INFO) << "init cache config successfully, max_item_num: "
        ...
        void gc() {
            TURBO_LOG(DEBUG) << "cache do gc, list_size: " << list_.size();
...
#endif  // TURBO_CONTAINER_LRU_CACHE_H_
