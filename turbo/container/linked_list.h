...
#ifndef TURBO_CONTAINER_LINKED_LIST_H_
#define TURBO_CONTAINER_LINKED_LIST_H_
...
//
// Q. Should I use std::list or turbo::container::linked_list?
//
// A. The main reason to use turbo::container::linked_list over std::list is
//    performance. If you don't care about the performance differences
//    then use an STL container, as it makes for better code readability.
//
//    Comparing the performance of turbo::container::linked_list<T> to std::list<T*>:
//
//    * Erasing an element of type T* from turbo::container::linked_list<T> is
//      an O(1) operation. Whereas for std::list<T*> it is O(n).
//      That is because with std::list<T*> you must obtain an
//      iterator to the T* element before you can call erase(iterator).
//
//    * Insertion operations with turbo::container::linked_list<T> never require
//      heap allocations.
//
// Q. How does turbo::container::linked_list implementation differ from std::list?
//
// A. Doubly-linked lists are made up of nodes that contain "next" and
//    "previous" pointers that reference other nodes in the list.
//
//    With turbo::container::linked_list<T>, the type being inserted already reserves
//    space for the "next" and "previous" pointers (turbo::container::link_node<T>*).
...
namespace turbo::container {
    ...
    private:
        ...
        TURBO_DISALLOW_COPY_AND_ASSIGN(link_node);
    };
    ...
    private:
        ...
        TURBO_DISALLOW_COPY_AND_ASSIGN(linked_list);
    };

}  // namespace turbo::container

#endif  // TURBO_CONTAINER_LINKED_LIST_H_
