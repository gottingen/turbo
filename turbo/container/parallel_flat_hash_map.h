...
#ifndef TURBO_CONTAINER_PARALLEL_FLAT_HASH_MAP_H_
#define TURBO_CONTAINER_PARALLEL_FLAT_HASH_MAP_H_
...
namespace turbo {
    ...
    // -----------------------------------------------------------------------------
    // turbo::parallel_flat_hash_map - default values in map_fwd_decl.h
    // -----------------------------------------------------------------------------
    template<class K, class V, class Hash, class Eq, class Alloc, size_t N, class Mtx_>
    class parallel_flat_hash_map : public turbo::priv::parallel_hash_map<
            N, turbo::priv::raw_hash_set, Mtx_,
            turbo::priv::flat_hash_map_policy<K, V>,
            Hash, Eq, Alloc> {
    ...
    template<class K, class V, class Hash, class Eq, class Alloc, size_t N, class Mtx_>
    class case_ignored_parallel_flat_hash_map : public turbo::priv::parallel_hash_map<
            N, turbo::priv::raw_hash_set, Mtx_,
            turbo::priv::flat_hash_map_policy<K, V>,
            Hash, Eq, Alloc> {
...
#endif  // TURBO_CONTAINER_PARALLEL_FLAT_HASH_MAP_H_
