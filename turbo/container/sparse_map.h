...
#ifndef  TURBO_CONTAINER_SPARSE_MAP_H_
#define  TURBO_CONTAINER_SPARSE_MAP_H_
...
#include "turbo/container/sparse_hash.h"
 ...
 * `turbo::sh::power_of_two_growth_policy`. This policy keeps the number of
 ...
 * your own growth policy, check `turbo::sh::power_of_two_growth_policy` for the
 * interface.
 *
 ...
 * `turbo::sh::exception_safety::strong`, the drawback is that the map will be
 ...
 * `turbo::sh::sparsity::medium` sparsity offers a good compromise. It doesn't
 ...
 */
    template<class Key, class T, class Hash = std::hash<Key>,
            ...
            class GrowthPolicy = turbo::sh::power_of_two_growth_policy<2>,
            turbo::sh::exception_safety ExceptionSafety =
            turbo::sh::exception_safety::basic,
            turbo::sh::sparsity Sparsity = turbo::sh::sparsity::medium>
    class sparse_map {
    private:
        template<typename U>
        using has_is_transparent = turbo::detail_sparse_hash::has_is_transparent<U>;
        ...
        using ht = detail_sparse_hash::sparse_hash<
                ...
                GrowthPolicy, ExceptionSafety, Sparsity, turbo::sh::probing::quadratic>;
    ...
    /**
     * Same as `turbo::sparse_map<Key, T, Hash, KeyEqual, Allocator,
     * turbo::sh::prime_growth_policy>`.
     */
    template<class Key, class T, class Hash = std::hash<Key>,
            class KeyEqual = std::equal_to<Key>,
            class Allocator = std::allocator<std::pair<Key, T>>>
    using sparse_pg_map =
    sparse_map<Key, T, Hash, KeyEqual, Allocator, turbo::sh::prime_growth_policy>;

}  // namespace turbo

#endif  // TURBO_CONTAINER_SPARSE_MAP_H_
