...
#ifndef TURBO_CONTAINER_PARALLEL_NODE_HASH_SET_H_
#define TURBO_CONTAINER_PARALLEL_NODE_HASH_SET_H_
...
namespace turbo {
    ...
    // -----------------------------------------------------------------------------
    // turbo::parallel_node_hash_set
    // -----------------------------------------------------------------------------
    template<class T, class Hash, class Eq, class Alloc, size_t N, class Mtx_>
    class parallel_node_hash_set
            : public turbo::priv::parallel_hash_set<
                    N, turbo::priv::raw_hash_set, Mtx_,
                    turbo::priv::node_hash_set_policy<T>, Hash, Eq, Alloc> {
...
#endif  // TURBO_CONTAINER_PARALLEL_NODE_HASH_SET_H_
