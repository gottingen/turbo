...
#ifndef  TURBO_VAR_VARIABLE_H_
#define  TURBO_VAR_VARIABLE_H_
...
namespace turbo {
    ...
    public:
        ...
        static int describe_exposed(const std::string_view &name,
                                    std::ostream &os,
    ...
    private:
        ...
        // turbo uses TLS, thus copying/assignment need to copy TLS stuff as well,
