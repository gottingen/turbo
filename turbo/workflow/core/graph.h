...
TURBO_NAMESPACE_BEGIN
    ...
    */
    ...
    class to interact with the executor through workflow composition.
    ...
    */
    ...
    @code{.cpp}
    workflow.emplace([](turbo::Runtime& rt){
      rt.run([](turbo::Subflow& sf){
    ...
    */
    ...
    public:
        ...
        the parent workflow of that runtime task.
        ...
        */
        ...
        An active task is a task in a running workflow.
        ...
        going through the normal workflow graph scheduling process.
        At this moment, task @c C is active because its parent workflow is running.
        When the workflow finishes, we will see both @c B and @c C in the output.
        */
        ...
        (2) a composable target with `turbo::Graph& T::graph()` defined
    ...
    */
    class Node {
        ...
        struct Runtime {
            ...
            std::function<void(turbo::Runtime &)> work;
        };
    ...
    @private
    */
    inline turbo::ObjectPool<Node> node_pool;
