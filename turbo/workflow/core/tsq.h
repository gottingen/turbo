...
Currently, %Workflow defines three priority levels,
...
// Function: push
    template<typename T, unsigned MAX_PRIORITY>
    TURBO_FORCE_INLINE void TaskQueue<T, MAX_PRIORITY>::push(T o, unsigned p) {
...
// Function: pop
    template<typename T, unsigned MAX_PRIORITY>
    TURBO_FORCE_INLINE T TaskQueue<T, MAX_PRIORITY>::pop(unsigned p) {
...
// Function: capacity
    ...
    template<typename T, unsigned MAX_PRIORITY>
    TURBO_NO_INLINE typename TaskQueue<T, MAX_PRIORITY>::Array *
...
#endif // TURBO_WORKFLOW_CORE_TSQ_H_
