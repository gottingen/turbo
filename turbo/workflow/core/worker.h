...
#ifndef TURBO_WORKFLOW_CORE_WORKER_H_
#define TURBO_WORKFLOW_CORE_WORKER_H_
...
The turbo::WorkerInterface class lets users interact with the executor
...
@note
Methods defined in turbo::WorkerInterface are not thread-safe and may be
...
@brief helper function to create an instance derived from turbo::WorkerInterface
...
#endif  // TURBO_WORKFLOW_CORE_WORKER_H_
