...
#ifndef TURBO_WORKFLOW_ALGORITHM_DATA_PIPELINE_H_
#define TURBO_WORKFLOW_ALGORITHM_DATA_PIPELINE_H_
...
either turbo::PipeType::SERIAL or turbo::PipeType::PARALLE,
...
using a module task in a workflow.
The only difference is that turbo::DataPipline provides a data abstraction
...
#endif  // TURBO_WORKFLOW_ALGORITHM_DATA_PIPELINE_H_
