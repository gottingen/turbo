...
#ifndef TURBO_SYSTEM_SYSINFO_H_
#define TURBO_SYSTEM_SYSINFO_H_
...
namespace turbo {
    ...
    public:
        ...
        virtual result_status get_proc_mem(turbo_pid_t pid, proc_mem_info &minfo) = 0;

        virtual result_status get_proc_state(turbo_pid_t pid, proc_state_info &minfo) = 0;

        result_status get_proc_cpu(turbo_pid_t pid, proc_cpu_info &minfo);
    ...
    protected:
        ...
        virtual int get_proc_time(turbo_pid_t pid, proc_time_info &proctime) = 0;

        flat_hash_map<turbo_pid_t, proc_cpu_info> process_cache;
