...
template <class Prof,
          turbo::enable_if_t<!PropertiesOfT<Prof>::is_swappable, int> = 0>
...
struct hash<::turbo::types_internal::Archetype<Prof>>
    : conditional<::turbo::types_internal::PropertiesOfT<Prof>::is_hashable,
                  ::turbo::types_internal::EnabledHash<Prof>,
                  ::turbo::types_internal::PoisonedHash>::type {};
