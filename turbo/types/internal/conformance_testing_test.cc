...
#include "turbo/types/internal/conformance_testing.h"
...
namespace ti = turbo::types_internal;
...
using DefaultConstructibleWithNew =
    turbo::type_traits_internal::is_detected<DefaultConstructibleWithNewImpl, T>;
...
using MoveConstructibleWithNew =
    turbo::type_traits_internal::is_detected<MoveConstructibleWithNewImpl, T>;
...
using CopyConstructibleWithNew =
    turbo::type_traits_internal::is_detected<CopyConstructibleWithNewImpl, T>;
...
using NothrowDefaultConstructibleWithNew =
    turbo::type_traits_internal::is_detected<
...
using NothrowMoveConstructibleWithNew =
    turbo::type_traits_internal::is_detected<NothrowMoveConstructibleWithNewImpl,
                                            T>;
...
using NothrowCopyConstructibleWithNew =
    turbo::type_traits_internal::is_detected<NothrowCopyConstructibleWithNewImpl,
                                            T>;
...
TYPED_TEST_P(ProfileTest, HasAppropriateConstructionProperties) {
  ...
  switch (expected_props::default_constructible_support) {
    case ti::default_constructible::maybe:
      ...
      if (std::is_destructible<arch>::value) {
        ...
        EXPECT_FALSE(turbo::is_trivially_default_constructible<arch>::value);
      }
      break;
    ...
    case ti::default_constructible::trivial:
      ...
      if (std::is_destructible<arch>::value) {
        ...
        if (turbo::is_trivially_destructible<arch>::value) {
          EXPECT_TRUE(turbo::is_trivially_default_constructible<arch>::value);
        }
      }
      break;
  }
  ...
  switch (expected_props::move_constructible_support) {
    case ti::move_constructible::maybe:
      ...
      if (std::is_destructible<arch>::value) {
        ...
        EXPECT_FALSE(turbo::is_trivially_move_constructible<arch>::value);
      }
      break;
    ...
    case ti::move_constructible::trivial:
      ...
      if (std::is_destructible<arch>::value) {
        ...
        // Constructor triviality traits require trivially destructible types.
        if (turbo::is_trivially_destructible<arch>::value) {
          EXPECT_TRUE(turbo::is_trivially_move_constructible<arch>::value);
        }
      }
      break;
  }
  ...
  switch (expected_props::copy_constructible_support) {
    case ti::copy_constructible::maybe:
      ...
      if (std::is_destructible<arch>::value) {
        ...
        EXPECT_FALSE(turbo::is_trivially_copy_constructible<arch>::value);
      }
      break;
    ...
    case ti::copy_constructible::trivial:
      ...
      if (std::is_destructible<arch>::value) {
        ...
        // Constructor triviality traits require trivially destructible types.
        if (turbo::is_trivially_destructible<arch>::value) {
          EXPECT_TRUE(turbo::is_trivially_copy_constructible<arch>::value);
        }
      }
      break;
  }
  ...
  switch (expected_props::destructible_support) {
    case ti::destructible::maybe:
      ...
      EXPECT_FALSE(turbo::is_trivially_destructible<arch>::value);
      break;
    ...
    case ti::destructible::trivial:
      EXPECT_TRUE(std::is_destructible<arch>::value);
      EXPECT_TRUE(std::is_nothrow_destructible<arch>::value);
      EXPECT_TRUE(turbo::is_trivially_destructible<arch>::value);
      break;
  }
}
...
TYPED_TEST_P(ProfileTest, HasAppropriateAssignmentProperties) {
  ...
  switch (expected_props::move_assignable_support) {
    case ti::move_assignable::maybe:
      ...
      EXPECT_FALSE(turbo::is_trivially_move_assignable<arch>::value);
      break;
    ...
    case ti::move_assignable::trivial:
      EXPECT_TRUE(std::is_move_assignable<arch>::value);
      EXPECT_TRUE(std::is_nothrow_move_assignable<arch>::value);
      EXPECT_TRUE(turbo::is_trivially_move_assignable<arch>::value);
      break;
  }
  ...
  switch (expected_props::copy_assignable_support) {
    case ti::copy_assignable::maybe:
      ...
      EXPECT_FALSE(turbo::is_trivially_copy_assignable<arch>::value);
      break;
    ...
    case ti::copy_assignable::trivial:
      EXPECT_TRUE(std::is_copy_assignable<arch>::value);
      EXPECT_TRUE(std::is_nothrow_copy_assignable<arch>::value);
      EXPECT_TRUE(turbo::is_trivially_copy_assignable<arch>::value);
      break;
  }
}
...
TYPED_TEST_P(ProfileTest, HasAppropriateAuxilliaryProperties) {
  ...
  switch (expected_props::swappable_support) {
    case ti::swappable::maybe:
      EXPECT_FALSE(turbo::type_traits_internal::IsSwappable<arch>::value);
      EXPECT_FALSE(turbo::type_traits_internal::IsNothrowSwappable<arch>::value);
      break;
    case ti::swappable::yes:
      EXPECT_TRUE(turbo::type_traits_internal::IsSwappable<arch>::value);
      EXPECT_FALSE(turbo::type_traits_internal::IsNothrowSwappable<arch>::value);
      break;
    case ti::swappable::nothrow:
      EXPECT_TRUE(turbo::type_traits_internal::IsSwappable<arch>::value);
      EXPECT_TRUE(turbo::type_traits_internal::IsNothrowSwappable<arch>::value);
      break;
  }
...
TEST(ConformanceTestingTest, Basic) {
  ...
  ABSL_INTERNAL_ASSERT_CONFORMANCE_OF(float)
      ...
      .INITIALIZER(lim::max())
      .INITIALIZER(lim::infinity())
      .WITH_STRICT_PROFILE(turbo::types_internal::RegularityDomain, profile);
}
