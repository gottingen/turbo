...
struct ReachableSwitchCase {
  static VisitIndicesResultT<Op, std::size_t> Run(Op&& op) {
    return turbo::base_internal::invoke(std::forward<Op>(op), SizeT<I>());
  }
};
  ...
  static VisitIndicesResultT<Op, std::size_t> Run(Op&& op, std::size_t i) {
    switch (i) {
      ...
      default:
        ...
        return turbo::base_internal::invoke(std::forward<Op>(op), NPos());
    }
  }
};
...
struct ContainsVariantNPos
    : turbo::negation<std::is_same<  // NOLINT
          ...
          std::integer_sequence<bool, Is != turbo::variant_npos...>>> {};
...
using turbo::internal::type_identity;
