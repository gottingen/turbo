...
void test(char (*)[sizeof(std::declval<U>().operator turbo::StatusOr<T>())]);
...
using IsConstructibleOrConvertibleFromStatusOr =
    turbo::disjunction<std::is_constructible<T, StatusOr<U>&>,
...
using IsConstructibleOrConvertibleOrAssignableFromStatusOr =
    turbo::disjunction<IsConstructibleOrConvertibleFromStatusOr<T, U>,
...
using Equality = std::conditional_t<Value, T, turbo::negation<T>>;

template <bool Explicit, typename T, typename U, bool Lifetimebound>
using IsConstructionValid = turbo::conjunction<
...
using IsAssignmentValid = turbo::conjunction<
    Equality<Lifetimebound,
             type_traits_internal::IsLifetimeBoundAssignment<T, U>>,
...
using IsConstructionFromStatusValid = turbo::conjunction<
    turbo::negation<std::is_same<turbo::StatusOr<T>, turbo::remove_cvref_t<U>>>,
...
template <bool Explicit, typename T, typename U, bool Lifetimebound,
          typename UQ>
using IsConstructionFromStatusOrValid = turbo::conjunction<
    turbo::negation<std::is_same<T, U>>,
    Equality<Lifetimebound,
             type_traits_internal::IsLifetimeBoundAssignment<T, U>>,
    std::is_constructible<T, UQ>,
    Equality<!Explicit, std::is_convertible<UQ, T>>,
    turbo::negation<IsConstructibleOrConvertibleFromStatusOr<T, U>>>;

template <typename T, typename U, bool Lifetimebound>
using IsStatusOrAssignmentValid = turbo::conjunction<
    turbo::negation<std::is_same<T, turbo::remove_cvref_t<U>>>,
    Equality<Lifetimebound,
             type_traits_internal::IsLifetimeBoundAssignment<T, U>>,
    std::is_constructible<T, U>, std::is_assignable<T, U>,
    turbo::negation<IsConstructibleOrConvertibleOrAssignableFromStatusOr<
...
class StatusOrData {
 ...
 public:
  ...
  explicit StatusOrData(turbo::in_place_t, Args&&... args)
...
TURBO_ATTRIBUTE_NORETURN void ThrowBadStatusOrAccess(turbo::Status status);
