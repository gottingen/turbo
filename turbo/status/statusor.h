...
class StatusOr : private internal_statusor::StatusOrData<T>,
 ...
 public:
  ...
  template <typename U, turbo::enable_if_t<
                            ...
                            int> = 0>
  StatusOr(const StatusOr<U>& other TURBO_ATTRIBUTE_LIFETIME_BOUND)  // NOLINT
      : Base(static_cast<const typename StatusOr<U>::Base&>(other)) {}
  template <typename U, turbo::enable_if_t<
                            internal_statusor::IsConstructionFromStatusOrValid<
  ...
  template <typename U, turbo::enable_if_t<
                            ...
                            int> = 0>
  explicit StatusOr(const StatusOr<U>& other TURBO_ATTRIBUTE_LIFETIME_BOUND)
      : Base(static_cast<const typename StatusOr<U>::Base&>(other)) {}
  ...
  template <typename U, turbo::enable_if_t<
                            ...
                            int> = 0>
  StatusOr(StatusOr<U>&& other TURBO_ATTRIBUTE_LIFETIME_BOUND)  // NOLINT
      : Base(static_cast<typename StatusOr<U>::Base&&>(other)) {}
  template <typename U, turbo::enable_if_t<
                            internal_statusor::IsConstructionFromStatusOrValid<
  ...
  template <typename U, turbo::enable_if_t<
                            ...
                            int> = 0>
  explicit StatusOr(StatusOr<U>&& other TURBO_ATTRIBUTE_LIFETIME_BOUND)
      : Base(static_cast<typename StatusOr<U>::Base&&>(other)) {}
  ...
  template <typename U,
            turbo::enable_if_t<internal_statusor::IsStatusOrAssignmentValid<
                              ...
                              int> = 0>
  StatusOr& operator=(const StatusOr<U>& other TURBO_ATTRIBUTE_LIFETIME_BOUND) {
    this->Assign(other);
    return *this;
  }
  template <typename U,
  ...
  template <typename U,
            turbo::enable_if_t<internal_statusor::IsStatusOrAssignmentValid<
                                  T, U&&, true>::value,
                              int> = 0>
  StatusOr& operator=(StatusOr<U>&& other TURBO_ATTRIBUTE_LIFETIME_BOUND) {
    this->Assign(std::move(other));
    return *this;
  }
  ...
  template <typename U = T,
            typename std::enable_if<
                ...
                int>::type = 0>
  StatusOr& operator=(U&& v TURBO_ATTRIBUTE_LIFETIME_BOUND) {
    this->Assign(std::forward<U>(v));
    return *this;
  }
  ...
  template <typename U = T,
            turbo::enable_if_t<internal_statusor::IsConstructionValid<
                              ...
                              int> = 0>
  StatusOr(U&& u TURBO_ATTRIBUTE_LIFETIME_BOUND)  // NOLINT
      : StatusOr(turbo::in_place, std::forward<U>(u)) {}
  ...
  template <typename U = T,
            turbo::enable_if_t<
                ...
                int> = 0>
  explicit StatusOr(U&& u TURBO_ATTRIBUTE_LIFETIME_BOUND)  // NOLINT
      : StatusOr(turbo::in_place, std::forward<U>(u)) {}
...
template <typename T>
turbo::Nonnull<const T*> StatusOr<T>::operator->() const {
  this->EnsureOk();
  return &this->data_;
}

template <typename T>
turbo::Nonnull<T*> StatusOr<T>::operator->() {
  this->EnsureOk();
  return &this->data_;
}
