...
#ifndef TURBO_SIMD_CONFIG_SIMD_CONFIG_H_
#define TURBO_SIMD_CONFIG_SIMD_CONFIG_H_

#define TURBO_SIMD_VERSION_MAJOR 11
#define TURBO_SIMD_VERSION_MINOR 0
#define TURBO_SIMD_VERSION_PATCH 1

/**
 * high level free functions
 *
 * @defgroup turbo_simd_config_macro Instruction Set Detection
 */

/**
 * @ingroup turbo_simd_config_macro
 *
...
#define TURBO_WITH_AVX512F 1
#if __GNUC__ == 6
#define TURBO_SIMD_AVX512_SHIFT_INTRINSICS_IMM_ONLY 1
#endif
#endif
#else
#define TURBO_WITH_AVX512F 0
...
#define TURBO_SIMD_SVE_BITS __ARM_FEATURE_SVE_BITS
#else
#define TURBO_WITH_SVE 0
#define TURBO_SIMD_SVE_BITS 0
#endif
...
#endif  // TURBO_SIMD_CONFIG_SIMD_CONFIG_H_
