...
#ifndef TURBO_SIMD_TYPES_FMA3_SSE_REGISTER_H_
#define TURBO_SIMD_TYPES_FMA3_SSE_REGISTER_H_
...
namespace turbo::simd
{
    ...
    {
        static constexpr bool supported() noexcept { return TURBO_WITH_FMA3_SSE; }
    ...
    namespace types
    {
        ...
        TURBO_SIMD_DECLARE_SIMD_REGISTER_ALIAS(fma3<sse4_2>, sse4_2);

    }
#endif

}
#endif  // TURBO_SIMD_TYPES_FMA3_SSE_REGISTER_H_
