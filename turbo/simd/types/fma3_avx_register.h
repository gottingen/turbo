...
namespace turbo::simd {
    ...
    template<>
    struct fma3<avx> : avx {
        static constexpr bool supported() noexcept { return TURBO_WITH_FMA3_AVX; }
    ...
    namespace types {
        ...
        TURBO_SIMD_DECLARE_SIMD_REGISTER_ALIAS(fma3<avx>, avx);

    }
#endif

}
#endif  // TURBO_SIMD_TYPES_FMA3_AVX_REGISTER_H_
