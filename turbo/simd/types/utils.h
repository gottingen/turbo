...
#ifndef TURBO_SIMD_TYPES_UTILS_H_
#define TURBO_SIMD_TYPES_UTILS_H_
...
namespace turbo::simd {
    ...
    // This is used in both complex_base.hpp and traits.h
    // However traits.h indirectly includes complex_base.h
    // so we cannot define is_complex in traits.h. Besides, if
    // no file defining batches is included, we still need this definition
    // in traits.h, so let's define it here.
...
#endif  // TURBO_SIMD_TYPES_UTILS_H_
