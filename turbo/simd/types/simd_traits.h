...
#ifndef TURBO_SIMD_TYPES_SIMD_TRAITS_H_
#define TURBO_SIMD_TYPES_SIMD_TRAITS_H_
...
namespace turbo::simd {
    ...
    namespace detail {
        ...
        struct static_check_supported_config_emitter {
            ...
            static_assert(!A::supported() || turbo::simd::has_simd_register<T, A>::value,
    ...
    template<class T>
    struct simd_traits : detail::simd_traits_impl<T, turbo::simd::has_simd_register<T>::value> {
    };

    template<class T>
    struct simd_traits<std::complex<T>>
            : detail::simd_traits_impl<std::complex<T>, turbo::simd::has_simd_register<T>::value> {
    };
...
#endif  // TURBO_SIMD_TYPES_SIMD_TRAITS_H_
