...
namespace turbo::simd {
    ...
    namespace types
    {
        ...
        TURBO_DECLARE_SIMD_REGISTER(signed char, neon, detail::neon_vector_type<signed char>);
        TURBO_DECLARE_SIMD_REGISTER(unsigned char, neon, detail::neon_vector_type<unsigned char>);
        TURBO_DECLARE_SIMD_REGISTER(char, neon, detail::char_neon_vector_type);
        TURBO_DECLARE_SIMD_REGISTER(short, neon, detail::neon_vector_type<short>);
        TURBO_DECLARE_SIMD_REGISTER(unsigned short, neon, detail::neon_vector_type<unsigned short>);
        TURBO_DECLARE_SIMD_REGISTER(int, neon, detail::neon_vector_type<int>);
        TURBO_DECLARE_SIMD_REGISTER(unsigned int, neon, detail::neon_vector_type<unsigned int>);
        TURBO_DECLARE_SIMD_REGISTER(long int, neon, detail::neon_vector_type<long int>);
        TURBO_DECLARE_SIMD_REGISTER(unsigned long int, neon, detail::neon_vector_type<unsigned long int>);
        TURBO_DECLARE_SIMD_REGISTER(long long int, neon, detail::neon_vector_type<long long int>);
        TURBO_DECLARE_SIMD_REGISTER(unsigned long long int, neon, detail::neon_vector_type<unsigned long long int>);
        TURBO_DECLARE_SIMD_REGISTER(float, neon, float32x4_t);
