...
#ifndef TURBO_SIMD_TYPES_REGISTER_H_
#define TURBO_SIMD_TYPES_REGISTER_H_
...
#define TURBO_SIMD_DECLARE_SIMD_REGISTER(SCALAR_TYPE, ISA, VECTOR_TYPE) \
    template <>                                                    \
...
#define TURBO_SIMD_DECLARE_INVALID_SIMD_REGISTER(SCALAR_TYPE, ISA)    \
    template <>                                                  \
    struct has_simd_register<SCALAR_TYPE, ISA> : std::false_type \
    {                                                            \
    }

#define TURBO_SIMD_DECLARE_SIMD_REGISTER_ALIAS(ISA, ISA_BASE)                          \
    template <class T>                                                            \
...
#endif  // TURBO_SIMD_TYPES_REGISTER_H_
