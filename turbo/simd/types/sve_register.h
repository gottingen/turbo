...
#undef SVE_TO_FIXED_SIZE
        ...
        TURBO_DECLARE_SIMD_REGISTER(signed char, sve, detail::sve_vector_type<signed char>);
        TURBO_DECLARE_SIMD_REGISTER(unsigned char, sve, detail::sve_vector_type<unsigned char>);
        TURBO_DECLARE_SIMD_REGISTER(char, sve, detail::sve_vector_type<char>);
        TURBO_DECLARE_SIMD_REGISTER(short, sve, detail::sve_vector_type<short>);
        TURBO_DECLARE_SIMD_REGISTER(unsigned short, sve, detail::sve_vector_type<unsigned short>);
        TURBO_DECLARE_SIMD_REGISTER(int, sve, detail::sve_vector_type<int>);
        TURBO_DECLARE_SIMD_REGISTER(unsigned int, sve, detail::sve_vector_type<unsigned int>);
        TURBO_DECLARE_SIMD_REGISTER(long int, sve, detail::sve_vector_type<long int>);
        TURBO_DECLARE_SIMD_REGISTER(unsigned long int, sve, detail::sve_vector_type<unsigned long int>);
        TURBO_DECLARE_SIMD_REGISTER(long long int, sve, detail::sve_vector_type<long long int>);
        TURBO_DECLARE_SIMD_REGISTER(unsigned long long int, sve, detail::sve_vector_type<unsigned long long int>);
        TURBO_DECLARE_SIMD_REGISTER(float, sve, detail::sve_vector_type<float>);
        TURBO_DECLARE_SIMD_REGISTER(double, sve, detail::sve_vector_type<double>);
