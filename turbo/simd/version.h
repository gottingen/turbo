...
#ifndef TURBO_SIMD_VERSION_H_
#define TURBO_SIMD_VERSION_H_
...
namespace turbo {
    ...
    static constexpr turbo::ModuleVersion simd_version = turbo::ModuleVersion{0, 9, 36};

}  // namespace turbo
#endif  // TURBO_SIMD_VERSION_H_
