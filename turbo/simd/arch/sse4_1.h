...
#ifndef TURBO_SIMD_ARCH_SSE4_1_H_
#define TURBO_SIMD_ARCH_SSE4_1_H_
...
namespace turbo::simd {
    ...
    namespace kernel {
        ...
        namespace detail {
            ...
            fast_cast(batch<float, A> const &self, batch<uint32_t, A> const &, requires_arch<sse4_1>) noexcept {
...
#endif  // TURBO_SIMD_ARCH_SSE4_1_H_
