...
namespace turbo::simd
{
    ...
    namespace kernel
    {
        ...
        {
#if defined(TURBO_SIMD_AVX512_SHIFT_INTRINSICS_IMM_ONLY)
        ...
        inline batch<T, A> slide_left(batch<T, A> const& x, requires_arch<avx512bw>) noexcept
        {
            ...
            alignas(A::alignment()) auto slide_pattern = detail::make_slide_left_pattern<N / 2>(::turbo::simd::detail::make_index_sequence<512 / 16>());
            alignas(A::alignment()) auto slide_mask = detail::make_slide_left_mask<N / 2>(::turbo::simd::detail::make_index_sequence<512 / 16>());
        ...
        inline batch<T, A> slide_right(batch<T, A> const& x, requires_arch<avx512bw>) noexcept
        {
            ...
            alignas(A::alignment()) auto slide_pattern = detail::make_slide_right_pattern<N / 2>(::turbo::simd::detail::make_index_sequence<512 / 16>());
            alignas(A::alignment()) auto slide_mask = detail::make_slide_right_mask<N / 2>(::turbo::simd::detail::make_index_sequence<512 / 16>());
            return _mm512_and_si512(_mm512_permutexvar_epi16(_mm512_load_epi32(slide_pattern.data()), xx), _mm512_load_epi32(slide_mask.data()));
        }
