...
#ifndef TURBO_SIMD_ARCH_NEON64_H_
#define TURBO_SIMD_ARCH_NEON64_H_
...
#define turbo_simd_aligned_load(inst, type, expr) inst((type)expr)
        ...
        {
            return turbo_simd_aligned_load(vld1q_f64, double*, src);
        }
...
#undef WRAP_REDUCER_FLOAT
        ...
        inline batch<double, A> extract_pair(batch<double, A> const& lhs, batch<double, A> const& rhs, std::size_t n, requires_arch<neon64>) noexcept
        {
            ...
            return detail::extract_pair(lhs, rhs, n, ::turbo::simd::detail::make_index_sequence<size>());
        }
...
#undef WRAP_CAST
    ...
    namespace kernel
    {
        ...
        namespace detail
        {
            using ::turbo::simd::batch_constant;
            using ::turbo::simd::detail::integer_sequence;
            using ::turbo::simd::detail::make_integer_sequence;
...
#endif  // TURBO_SIMD_ARCH_NEON64_H_
