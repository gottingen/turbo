...
#ifndef TURBO_SIMD_ARCH_GENERIC_COMPLEX_H_
#define TURBO_SIMD_ARCH_GENERIC_COMPLEX_H_
...
namespace turbo::simd {
    ...
    namespace kernel {
        ...
        inline complex_batch_type_t<batch<T, A>> proj(batch<T, A> const &self, requires_arch<generic>) noexcept {
            ...
            auto cond = turbo::simd::isinf(real(self)) || turbo::simd::isinf(imag(self));
            return select(cond,
...
#endif  // TURBO_SIMD_ARCH_GENERIC_COMPLEX_H_
