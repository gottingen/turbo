...
#ifndef TURBO_SIMD_ARCH_GENERIC_TRIGO_H_
#define TURBO_SIMD_ARCH_GENERIC_TRIGO_H_
                ...
                if (all(x <= constants::pio4<B>())) {
                    ...
                    for (std::size_t i = 0; i < size; ++i) {
                        ...
                        if (arg == std::numeric_limits<value_type>::infinity()) {
                            ...
                            double y[2];
                            std::int32_t n = ::turbo::simd::detail::__ieee754_rem_pio2(arg, y);
...
#endif  // TURBO_SIMD_ARCH_GENERIC_TRIGO_H_
