...
#ifndef TURBO_SIMD_ARCH_GENERIC_MEMORY_H_
#define TURBO_SIMD_ARCH_GENERIC_MEMORY_H_

#include <algorithm>
#include <complex>
#include <stdexcept>

#include "../../types/batch_constant.h"
    ...
    namespace kernel {
        ...
        namespace detail {
            ...
            template<size_t N, typename T, typename A, typename U, typename V, typename std::enable_if<
                    N != 0, int>::type = 0>
            inline batch<T, A>
            gather(U const *src, batch<V, A> const &index, ::turbo::simd::index<N> I) noexcept {
        ...
        inline T get(batch<T, A> const &self, ::turbo::simd::index<I>, requires_arch<generic>) noexcept {
        ...
        template<class A, size_t I, class T>
        inline T get(batch_bool<T, A> const &self, ::turbo::simd::index<I>, requires_arch<generic>) noexcept {
        ...
        template<class A, size_t I, class T>
        inline auto get(batch<std::complex<T>, A> const &self, ::turbo::simd::index<I>,
...
#endif  // TURBO_SIMD_ARCH_GENERIC_MEMORY_H_
