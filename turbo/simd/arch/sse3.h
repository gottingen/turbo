...
#ifndef TURBO_SIMD_ARCH_SSE3_H_
#define TURBO_SIMD_ARCH_SSE3_H_
...
namespace turbo::simd {
    ...
    namespace kernel {
        ...
        const* row, requires_arch<sse3>) noexcept {
        return

        _mm_hadd_ps(_mm_hadd_ps(row[0], row[1]),
...
const& self, requires_arch <sse3>) noexcept
{
