...
// TURBO_PREFIX_DEPRECATED     // You should need this only for unusual
// compilers. TURBO_POSTFIX_DEPRECATED    // You should need this only for
// unusual compilers. TURBO_DEPRECATED_MESSAGE    // Used as a prefix and
// provides a deprecation message.
//
// Example usage:
...
#elif defined(TURBO_COMPILER_MSVC) &&                                          \
    (TURBO_COMPILER_VERSION > 1300) // If VC7 (VS2003) or later...
...
#else
// Compiler does not support depreaction messages, explicitly drop the msg but
// still mark the function as deprecated
