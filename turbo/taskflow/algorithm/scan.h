...
//
#ifndef TURBO_TASKFLOW_ALGORITHM_SCAN_H_
#define TURBO_TASKFLOW_ALGORITHM_SCAN_H_

#include <turbo/taskflow/algorithm/launch.h>
...
namespace turbo {
    ...
    namespace detail {
        ...
        TURBO_FORCE_INLINE void scan_loop(
                turbo::Runtime &rt,
    ...
    TURBO_FORCE_INLINE auto make_inclusive_scan_task(B first, E last, D d_first, BOP bop) {
        ...
        return [=](Runtime &rt) mutable {
            ...
            std::vector<turbo::CachelineAligned<value_type>> buf(W);
    ...
    TURBO_FORCE_INLINE auto make_inclusive_scan_task(B first, E last, D d_first, BOP bop, T init) {
    ...
    TURBO_FORCE_INLINE auto make_transform_inclusive_scan_task(B first, E last, D d_first, BOP bop, UOP uop) {
    ...
    TURBO_FORCE_INLINE auto make_transform_inclusive_scan_task(B first, E last, D d_first, BOP bop, UOP uop, T init) {
    ...
    TURBO_FORCE_INLINE auto make_exclusive_scan_task(B first, E last, D d_first, T init, BOP bop) {
    ...
    TURBO_FORCE_INLINE auto make_transform_exclusive_scan_task(B first, E last, D d_first, T init, BOP bop, UOP uop) {
...
// Function: inclusive_scan
    ...
    Task FlowBuilder::transform_inclusive_scan(B first, E last, D d_first, BOP bop, UOP uop) {
        return emplace(make_transform_inclusive_scan_task(first, last, d_first, bop, uop));
    }
    ...
    Task FlowBuilder::transform_inclusive_scan(
        ...
        return emplace(make_transform_inclusive_scan_task(first, last, d_first, bop, uop, init));
    }
...
#endif  // TURBO_TASKFLOW_ALGORITHM_SCAN_H_
