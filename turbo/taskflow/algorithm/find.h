...
//
#ifndef TURBO_TASKFLOW_ALGORITHM_FIND_H_
#define TURBO_TASKFLOW_ALGORITHM_FIND_H_
...
namespace turbo::detail {
    ...
    TURBO_FORCE_INLINE bool find_if_loop(
    ...
    template<typename Iterator, typename Predicate>
    TURBO_FORCE_INLINE bool find_if_not_loop(
            std::atomic<size_t> &offset,
            Iterator &beg,
            size_t &prev_e,
            size_t curr_b,
...
namespace turbo {
    ...
    TURBO_FORCE_INLINE auto make_find_if_task(B first, E last, T &result, UOP predicate, P &&part = P()) {
                            ...
                            launch_loop(W, w, rt,
                                        [N, W, curr_b, chunk_size, beg, &predicate, &offset, &part]
                                            ...
                                            part.loop_until(N, W, curr_b, chunk_size,
                                                            [&, prev_e = size_t{0}](size_t curr_b,
                                                                                    size_t curr_e) mutable {
    ...
    template<typename B, typename E, typename T, typename UOP, typename P = GuidedPartitioner>
    TURBO_FORCE_INLINE auto make_find_if_not_task(
    ...
    TURBO_FORCE_INLINE auto make_min_element_task(
    ...
    template<typename B, typename E, typename T, typename C, typename P = GuidedPartitioner>
    TURBO_FORCE_INLINE auto make_max_element_task(
            B first, E last, T &result, C comp, P &&part = P()
    ) {
    ...
    Task turbo::FlowBuilder::find_if(B first, E last, T &result, UOP predicate, P &&part) {
    ...
    template<typename B, typename E, typename T, typename UOP, typename P>
    Task turbo::FlowBuilder::find_if_not(B first, E last, T &result, UOP predicate, P &&part) {
...
#endif  // TURBO_TASKFLOW_ALGORITHM_FIND_H_
