...
//
#ifndef TURBO_TASKFLOW_ALGORITHM_SORT_H_
#define TURBO_TASKFLOW_ALGORITHM_SORT_H_
...
namespace turbo::detail {
    ...
    void parallel_pdqsort(turbo::Runtime &rt,
    ...
    void parallel_3wqsort(turbo::Runtime &rt, RandItr first, RandItr last, C compare) {
        ...
        if (l - first > 1 && is_swapped_l) {
            //rt.emplace([&](turbo::Runtime& rtl) mutable {
        ...
        if (last - r > 1 && is_swapped_r) {
            //rt.emplace([&](turbo::Runtime& rtr) mutable {
...
namespace turbo {
    ...
    TURBO_FORCE_INLINE auto make_sort_task(B beg, E end, C cmp) {
    ...
    TURBO_FORCE_INLINE auto make_sort_task(B beg, E end) {
...
#endif  // TURBO_TASKFLOW_ALGORITHM_SORT_H_
