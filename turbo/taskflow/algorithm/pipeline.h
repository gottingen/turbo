...
//
#ifndef TURBO_TASKFLOW_ALGORITHM_PIPELINE_H_
#define TURBO_TASKFLOW_ALGORITHM_PIPELINE_H_
...
namespace turbo {
    ...
    */
    ...
    turbo::Task task = taskflow.composed_of(pipeline)
                            .name("pipeline");
    ...
    */
    ...
    Each pipe has the same type of `%turbo::Pipe<%std::function<void(%turbo::Pipeflow&)>>`
...
#endif  // TURBO_TASKFLOW_ALGORITHM_PIPELINE_H_
