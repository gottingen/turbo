...
//
#ifndef TURBO_TASKFLOW_ALGORITHM_FOR_EACH_H_
#define TURBO_TASKFLOW_ALGORITHM_FOR_EACH_H_
...
namespace turbo {
    ...
    TURBO_FORCE_INLINE auto make_for_each_task(B beg, E end, C c, P &&part = P()) {
    ...
    TURBO_FORCE_INLINE auto make_for_each_index_task(B beg, E end, S inc, C c, P &&part = P()) {
...
#endif  // TURBO_TASKFLOW_ALGORITHM_FOR_EACH_H_
