...
//
#ifndef TURBO_TASKFLOW_ALGORITHM_REDUCE_H_
#define TURBO_TASKFLOW_ALGORITHM_REDUCE_H_
...
namespace turbo {
    ...
    TURBO_FORCE_INLINE auto make_reduce_task(B beg, E end, T &init, O bop, P &&part = P()) {
    ...
    >
    TURBO_FORCE_INLINE auto make_transform_reduce_task(
...
#endif  // TURBO_TASKFLOW_ALGORITHM_REDUCE_H_
