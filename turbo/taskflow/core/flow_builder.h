...
//
#ifndef TURBO_TASKFLOW_CORE_FLOW_BUILDER_H_
#define TURBO_TASKFLOW_CORE_FLOW_BUILDER_H_

#include <turbo/taskflow/core/task.h>
#include <turbo/taskflow/algorithm/partitioner.h>
...
namespace turbo {
    ...
    from which turbo::Taskflow and turbo::Subflow are derived.
    ...
    */
    ...
    public:
        ...
        */
        ...
        @code{.cpp}
        turbo::Task static_task = taskflow.emplace([](){});
        @endcode
        ...
        */
        ...
        @code{.cpp}
        turbo::Task dynamic_task = taskflow.emplace([](turbo::Subflow& sf){
        ...
        */
        ...
        @code{.cpp}
        turbo::Task A = taskflow.emplace([](){ std::cout << "A"; });
        turbo::Task B = taskflow.emplace([](){ std::cout << "B"; });
        turbo::Task C = taskflow.emplace([](){ std::cout << "C"; });
        turbo::Task D = taskflow.emplace([](){ std::cout << "D"; });
        A.precede(B, C, D);
        ...
        */
        ...
        MyObj obj;
        turbo::Task comp = taskflow.composed_of(obj);
        @endcode
        ...
        */
        ...
        turbo::Task placeholder = taskflow.placeholder();
        ...
        */
        ...
        @tparam P partitioner type (default turbo::GuidedPartitioner)
        ...
        */
        ...
        @param part partitioning algorithm (default turbo::GuidedPartitioner)
...
// Function: emplace
    ...
    Task FlowBuilder::emplace(C &&c) {
        return Task(_graph.emplace_back("", 0, nullptr, nullptr, 0,
...
// Function: composed_of
    ...
    Task FlowBuilder::composed_of(T &object) {
        auto node = _graph.emplace_back("", 0, nullptr, nullptr, 0,
...
// Procedure: _linearize
    ...
    turbo::Subflow is a derived class from turbo::Runtime with a specialized mechanism
    ...
    turbo::Task A = taskflow.emplace([](){}).name("A");
    turbo::Task C = taskflow.emplace([](){}).name("C");
    turbo::Task D = taskflow.emplace([](){}).name("D");

    // create a subflow graph (dynamic tasking)
    turbo::Task B = taskflow.emplace([] (turbo::Subflow& subflow) {
...
#endif  // TURBO_TASKFLOW_CORE_FLOW_BUILDER_H_
