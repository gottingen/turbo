...
//
#ifndef TURBO_TASKFLOW_CORE_ASYNC_H_
#define TURBO_TASKFLOW_CORE_ASYNC_H_

#include <turbo/taskflow/core/executor.h>
...
namespace turbo {
    ...
    >
    turbo::AsyncTask Executor::silent_dependent_async(F &&func, Tasks &&... tasks) {
    ...
    template<typename F, typename... Tasks,
            std::enable_if_t<all_same_v<AsyncTask, std::decay_t<Tasks>...>, void> *
    >
    turbo::AsyncTask Executor::silent_dependent_async(
    ...
    >
    turbo::AsyncTask Executor::silent_dependent_async(F &&func, I first, I last) {
    ...
    inline void Executor::_process_async_dependent(
            Node *node, turbo::AsyncTask &task, size_t &num_dependents
    ) {
...
#endif  // TURBO_TASKFLOW_CORE_ASYNC_H_
