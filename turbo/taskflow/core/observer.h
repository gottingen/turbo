...
//
#ifndef TURBO_TASKFLOW_CORE_OBSERVER_H_
#define TURBO_TASKFLOW_CORE_OBSERVER_H_
...
namespace turbo {
    ...
    */
    ...
    A turbo::TFProfObserver inherits turbo::ObserverInterface and defines methods to dump
    the observed thread activities into a format that can be visualized through
    @TFProf.
    ...
    // create a custom observer
    std::shared_ptr<turbo::TFProfObserver> observer = executor.make_observer<turbo::TFProfObserver>();
...
// Procedure: set_up
    ...
    */
    ...
    inline TFProfManager::TFProfManager() :
            _fpath{turbo::get_env(TF_ENABLE_PROFILER)} {
...
#endif  // TURBO_TASKFLOW_CORE_OBSERVER_H_
