...
//
#ifndef TURBO_TASKFLOW_CORE_TSQ_H_
#define TURBO_TASKFLOW_CORE_TSQ_H_
...
namespace turbo {
    ...
    */
    ...
    class TaskQueue {
        ...
        // decent performance.
        turbo::CachelineAligned <std::atomic<int64_t>> _top[TF_MAX_PRIORITY];
        turbo::CachelineAligned <std::atomic<int64_t>> _bottom[TF_MAX_PRIORITY];
    ...
    public:
        ...
        */
        TURBO_FORCE_INLINE void push(T item, unsigned priority);
        ...
        */
        ...
        The return can be a @c nullptr if this operation failed (empty queue).
        */
        TURBO_FORCE_INLINE T pop(unsigned priority);
    ...
    private:
        TURBO_NO_INLINE Array *resize_array(Array *a, unsigned p, std::int64_t b, std::int64_t t);
    };
...
// Function: push
    template<typename T, unsigned TF_MAX_PRIORITY>
    TURBO_FORCE_INLINE void TaskQueue<T, TF_MAX_PRIORITY>::push(T o, unsigned p) {
...
// Function: pop
    template<typename T, unsigned TF_MAX_PRIORITY>
    TURBO_FORCE_INLINE T TaskQueue<T, TF_MAX_PRIORITY>::pop(unsigned p) {
...
// Function: capacity
    ...
    template<typename T, unsigned TF_MAX_PRIORITY>
    TURBO_NO_INLINE typename TaskQueue<T, TF_MAX_PRIORITY>::Array *
...
#endif  // TURBO_TASKFLOW_CORE_TSQ_H_
