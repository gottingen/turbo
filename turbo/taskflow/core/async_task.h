...
//
#ifndef TURBO_TASKFLOW_CORE_ASYNC_TASK_H_
#define TURBO_TASKFLOW_CORE_ASYNC_TASK_H_
...
namespace turbo {
    ...
    A turbo::AsyncTask is a lightweight handle that retains @em shared ownership
    ...
    turbo::AsyncTask A = executor.silent_dependent_async([](){});
    ...
    turbo::AsyncTask B = executor.silent_dependent_async([](){}, A);
    @endcode

    Currently, turbo::AsyncTask is implemented based on the logic of
...
#endif  // TURBO_TASKFLOW_CORE_ASYNC_TASK_H_
