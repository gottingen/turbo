...
//
#ifndef TURBO_TASKFLOW_CORE_TASK_H_
#define TURBO_TASKFLOW_CORE_TASK_H_

#include <turbo/taskflow/core/graph.h>
...
namespace turbo {
    ...
    */
    ...
    or std::function<int(turbo::Runtime&)>.
    */
    template<typename C>
    ...
    std::function<turbo::turbo::SmallVector<int>()> or
    std::function<turbo::turbo::SmallVector<int>(turbo::Runtime&)>.
    */
    template<typename C>
    constexpr bool is_multi_condition_task_v =
            (std::is_invocable_r_v<turbo::SmallVector < int>, C > ||
                                                       std::is_invocable_r_v<turbo::SmallVector < int>, C, Runtime & >
    ) &&
    !
    is_dynamic_task_v<C>;
    ...
    or std::function<void(turbo::Runtime&)>.
    */
    template<typename C>
...
#endif  // TURBO_TASKFLOW_CORE_TASK_H_
