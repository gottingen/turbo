...
//
#ifndef TURBO_TASKFLOW_CORE_TASKFLOW_H_
#define TURBO_TASKFLOW_CORE_TASKFLOW_H_

#include <turbo/taskflow/core/flow_builder.h>
...
namespace turbo {
    ...
    dependency between two tasks. A task is one of the following types:
      ...
      5. module task         : the task constructed from turbo::Taskflow::composed_of
    ...
    turbo::Task A = taskflow.emplace([](){ std::cout << "TaskA\n"; });
    turbo::Task B = taskflow.emplace([](){ std::cout << "TaskB\n"; });
    turbo::Task C = taskflow.emplace([](){ std::cout << "TaskC\n"; });
    turbo::Task D = taskflow.emplace([](){ std::cout << "TaskD\n"; });
    ...
    */
    ...
    public:
        ...
        @code{.cpp}
        turbo::Taskflow taskflow("My Taskflow");
        ...
        */
        ...
        @code{.cpp}
        turbo::Taskflow taskflow1(std::move(taskflow2));
        ...
        */
        ...
        @code{.cpp}
        turbo::Task parent = taskflow.emplace([](turbo::Subflow sf){
        ...
        */
        ...
        This method is similar to turbo::Taskflow::dump(std::ostream& ostream),
        ...
        */
        ...
        turbo::Taskflow::num_tasks is zero.
        */
        bool empty() const;
        ...
        */
        ...
        @code{.cpp}
        taskflow.for_each_task([](turbo::Task task){
          std::cout << task.name() << '\n';
        });
        @endcode
        */
    ...
    execution result of a submitted taskflow (turbo::Executor::run)
    In addition to the base methods inherited from std::future,
    you can call turbo::Future::cancel to cancel the execution of the running taskflow
...
#endif  // TURBO_TASKFLOW_CORE_TASKFLOW_H_
