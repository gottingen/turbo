![RapidJSON logo](json/logo/rapidjson.png)
...
More features can be read [here](json/features.md).
...
* Added [JSON Pointer](json/pointer.md)
* Added [JSON Schema](json/schema.md)
* Added [relaxed JSON syntax](json/dom.md) (comment, trailing comma, NaN/Infinity)
* Iterating array/object with [C++11 Range-based for loop](tutorial.md)
...
![simpledom](json/diagram/simpledom.png)
