...
namespace {
        ...
        std::string input = R"(
    {
      ...
      "items": [
        ...
        ns::Basket basket = turbo::decode_json<ns::Basket>(input);
        ...
        std::string output;
        turbo::encode_json_pretty(basket, output);
        std::cout << "(2)\n" << output << "\n\n";
    }
    ...
    void variant_example2()
    {
        ...
        std::string buffer;
        turbo::encode_json_pretty(vars, buffer);

        std::cout << "(1)\n" << buffer << "\n\n";

        auto vars2 = turbo::decode_json<std::vector<variant_type>>(buffer);
    ...
    void variant_example4()
    {
        ...
        std::string buffer;
        turbo::encode_json_pretty(v, buffer);
        std::cout << "(1)\n" << buffer << "\n\n";

        auto v2 = turbo::decode_json<std::vector<variant_type>>(buffer);
    ...
    [
        ...
        auto shapes = turbo::decode_json<std::vector<shapes_t>>(input);
        ...
        std::string output;
        turbo::encode_json_pretty(shapes, output);
        std::cout << "\n(2)\n" << output << "\n";
    }
