...
// for brevity
using turbo::json;
namespace jsonpath = turbo::jsonpath;
...
[
    ...
    void make_expression_with_stateful_allocator()
    {
        ...
        using my_json = turbo::basic_json<char,turbo::sorted_policy,my_alloc>;
        ...
        std::string json_string = R"(
{
    ...
    [
        ...
        turbo::json_decoder<my_json,my_alloc> decoder(turbo::result_allocator_arg, alloc, alloc);

        turbo::basic_json_reader<char,turbo::string_source<char>,my_alloc> reader(json_string, decoder, alloc);
        reader.read();
        ...
        auto expr = turbo::jsonpath::make_expression<my_json>(std::allocator_arg, alloc, p);
