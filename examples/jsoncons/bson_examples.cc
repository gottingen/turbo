...
using turbo::json;
using turbo::ojson;
namespace bson = turbo::bson; // for brevity
...
namespace
{
    void encode_to_bson()
    {
        ...
        encoder.int64_value(1431027667, turbo::semantic_tag::epoch_second);
        encoder.end_array();
        encoder.flush();

        std::cout << turbo::byte_string_view(buffer) << "\n\n";
    ...
    */ 
    ...
    void array_example()
    {
        json a(turbo::json_array_arg);
        a.push_back("hello");
        a.push_back("world");

        json j(turbo::json_object_arg);
        j["array"] = std::move(a);
    ...
    */
    ...
    void binary_example1()
    {
        ...
        j.try_emplace("binary", turbo::byte_string_arg, bstr); // default subtype is user defined
    ...
    void binary_example2()
    {
        ...
        std::cout << "binary data: " << turbo::byte_string_view{ bytes } << "\n";
    }
    ...
    void encode_decimal128()
    {
        ...
        j.try_emplace("a", "1E-6176", turbo::semantic_tag::float128);
        // or j["a"] = json("1E-6176", turbo::semantic_tag::float128);
        ...
        bson::encode_bson(j, output);
        std::cout << "(3) " << turbo::byte_string_view(output) << "\n\n";
        /*
