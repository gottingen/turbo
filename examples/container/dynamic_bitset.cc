...
int main()
{
	...
	turbo::dynamic_bitset<uint32_t> a(12, 0b0100010110111);
	...
	// get allocator
	[[maybe_unused]] const turbo::dynamic_bitset<uint32_t>::allocator_type allocator =
	  a.get_allocator();
	...
	turbo::dynamic_bitset<uint32_t> b("011001010101");
