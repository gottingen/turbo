...
void make_taskflow1(turbo::Taskflow& tf) {
...
void make_taskflow2(turbo::Taskflow& tf) {
...
void make_taskflow3(turbo::Taskflow& tf) {
...
int main() {
  ...
  turbo::Taskflow taskflow("taskflow processing pipeline");
  ...
  std::array<turbo::Taskflow, num_pipes> taskflows;
