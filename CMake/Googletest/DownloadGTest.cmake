...
set(TURBO_SAVE_CMAKE_CXX_FLAGS ${CMAKE_CXX_FLAGS})
set(TURBO_SAVE_CMAKE_RUNTIME_OUTPUT_DIRECTORY ${CMAKE_RUNTIME_OUTPUT_DIRECTORY})
...
set(CMAKE_CXX_FLAGS ${TURBO_SAVE_CMAKE_CXX_FLAGS})
set(CMAKE_RUNTIME_OUTPUT_DIRECTORY ${TURBO_SAVE_CMAKE_RUNTIME_OUTPUT_DIRECTORY})
...
# targets.
add_subdirectory(${turbo_gtest_src_dir} ${turbo_gtest_build_dir} EXCLUDE_FROM_ALL)
