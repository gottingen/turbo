...
if(CXX_AVX512_FOUND)
    ...
    list(APPEND CARBIN_SIMD_FLAGS ${TURBO_AVX512_SIMD_FLAGS}) # note that this is a bit platform specific
endif()
MESSAGE(STATUS "TURBO SIMD FLAGS ${CARBIN_SIMD_FLAGS}")