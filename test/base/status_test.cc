...
namespace {
    ...
    TEST_F(StatusTest, success_status) {
        ...
        turbo::result_status st2(0, "blahblah");
        ...
        turbo::result_status st3 = turbo::result_status::success();
...
#define NO_CPU_STR "No CPU"
    ...
    TEST_F(StatusTest, failed_status) {
        ...
        turbo::result_status st1(ENOMEM, NO_MEMORY_STR);
        ...
        turbo::result_status st2(EINVAL, "{}{}", NO_MEMORY_STR, NO_CPU_STR);
        ...
        turbo::result_status st3(ENOMEM, NO_MEMORY_STR);
        ...
        turbo::result_status st4(EINVAL, "{}{}", NO_MEMORY_STR, NO_CPU_STR);
        ...
        turbo::result_status st5(EINVAL, "Blah");
...
#define VERYLONGERROR                           \
    ...
    TEST_F(StatusTest, message_has_zero) {
        ...
        ASSERT_EQ(11UL, turbo::as_string(slice).size());
        str[5] = '\0';
        ASSERT_EQ(11UL, turbo::as_string(slice).size());
        turbo::result_status st1(ENOMEM, slice);
        ASSERT_FALSE(st1.is_ok());
        ASSERT_EQ(ENOMEM, st1.error_code());
