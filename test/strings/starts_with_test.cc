...
namespace {
    ...
    TEST(MatchTest, starts_with_case) {
        EXPECT_TRUE(turbo::starts_with_case("foo", "foo"));
        EXPECT_TRUE(turbo::starts_with_case("foo", "Fo"));
        EXPECT_TRUE(turbo::starts_with_case("foo", ""));
        EXPECT_FALSE(turbo::starts_with_case("foo", "fooo"));
        EXPECT_FALSE(turbo::starts_with_case("", "fo"));
    }
