...
namespace turbo {
    ...
    TEST(scoped_temp_dir, TempDir) {
        ...
        turbo::file_path test_path;
        {
            ...
            test_path = dir.path();
            EXPECT_TRUE(turbo::exists(test_path));
            turbo::file_path tmp_dir = turbo::temp_directory_path();
