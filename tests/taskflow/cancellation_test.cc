...
TEST_CASE("MultipleCancellations" * doctest::timeout(300)) {
  ...
  turbo::Taskflow taskflow1, taskflow2, taskflow3, taskflow4;
  turbo::Executor executor(4);
...
TEST_CASE("CancelFromAnother" * doctest::timeout(300)) {
  ...
  turbo::Taskflow taskflow, another;
  turbo::Executor executor(4);
