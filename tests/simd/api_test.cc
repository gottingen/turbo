...
struct xsimd_api_test
{
    ...
    using int8_vector_type = std::vector<int8_t, turbo::simd::default_allocator<int8_t>>;
    using uint8_vector_type = std::vector<uint8_t, turbo::simd::default_allocator<uint8_t>>;
    using int16_vector_type = std::vector<int16_t, turbo::simd::default_allocator<int16_t>>;
    using uint16_vector_type = std::vector<uint16_t, turbo::simd::default_allocator<uint16_t>>;
    using int32_vector_type = std::vector<int32_t, turbo::simd::default_allocator<int32_t>>;
    using uint32_vector_type = std::vector<uint32_t, turbo::simd::default_allocator<uint32_t>>;
    using int64_vector_type = std::vector<int64_t, turbo::simd::default_allocator<int64_t>>;
    using uint64_vector_type = std::vector<uint64_t, turbo::simd::default_allocator<uint64_t>>;
    using float_vector_type = std::vector<float, turbo::simd::default_allocator<float>>;
    using double_vector_type = std::vector<double, turbo::simd::default_allocator<double>>;
