...
//
    ...
    TEST(FormatTime, LocaleSpecific) {
        ...
        const std::string s =
                turbo::FormatTime("%c", turbo::Time::from_time_t(0), turbo::UTCTimeZone());
    ...
    TEST(FormatTime, InfiniteTime) {
        ...
        EXPECT_EQ("infinite-future",
                  turbo::FormatTime("%H:%M blah", turbo::Time::future_infinite(), tz));
        EXPECT_EQ("infinite-past",
                  turbo::FormatTime("%H:%M blah", turbo::Time::past_infinite(), tz));
    }
